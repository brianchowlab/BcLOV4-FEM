function [Soln] = SolveNonLinear(param,solver_params)
    ...
    solver_params.FEM_nl = mex_ReactionDiffusion_Cell_nl_assemble(solver_params.FEM,solver_params.p,solver_params.c,[],...
