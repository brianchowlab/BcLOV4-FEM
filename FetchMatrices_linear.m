function [K_phi,K_psi,K_phi_phi,K_phi_psi,K_psi_phi,A_phi,A_psi]=FetchMatrices(params)
    FEM = mex_ReactionDiffusion_Cell_l_assemble(params.FEM_l,params.p,params.c,[],params.embed,params.C_DoF,params.M_DoF);
