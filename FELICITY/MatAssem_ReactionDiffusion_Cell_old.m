function MATS = MatAssem_ReactionDiffusion_Cell()
    ...
    B_phi = B_phi + Integral(dOmega,(u_M_h_coef.val+v_M_h_coef.val)* u_C_h.val * phi_h.val);
        
    B_psi = Bilinear(M_h,C_h);
    B_psi = B_psi  + Integral(dOmega,(u_M_h_coef.val+v_M_h_coef.val)* u_C_h.val * psi_h.val);
