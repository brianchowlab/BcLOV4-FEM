...
// FE matrix is:
//
// \int_{Omega}  (u_soln_v1_t1 - sin(geomOmega_X1*pi))^2 + (u_soln_v2_t1 - sin(geomOmega_X2*pi))^2,  ... etc... (see individual submatrices, i.e. Tab_Tensor routines.)
//
/*------------   END: Auto Generate ------------*/
