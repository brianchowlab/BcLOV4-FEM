...
#define SpecificFUNC        Data_Type_P1_phi_restricted_to_Omega
#define SpecificFUNC_str   "Data_Type_P1_phi_restricted_to_Omega"

// set the type of function space
#define SPACE_type  "CG - lagrange_deg1_dim2"
// set the name of function space
#define SPACE_name  "P1"
...
// Number of Quadrature Points = 7
    ...
    phi_Val[1][0].Set_Equal_To(5.97158717897698921E-02);
    phi_Val[1][1].Set_Equal_To(4.70142064105115054E-01);
    phi_Val[1][2].Set_Equal_To(4.70142064105115054E-01);
    phi_Val[2][0].Set_Equal_To(4.70142064105115165E-01);
    phi_Val[2][1].Set_Equal_To(5.97158717897698088E-02);
    phi_Val[2][2].Set_Equal_To(4.70142064105115054E-01);
    phi_Val[3][0].Set_Equal_To(4.70142064105115165E-01);
    phi_Val[3][1].Set_Equal_To(4.70142064105115054E-01);
    phi_Val[3][2].Set_Equal_To(5.97158717897698088E-02);
    phi_Val[4][0].Set_Equal_To(7.97426985353087314E-01);
    phi_Val[4][1].Set_Equal_To(1.01286507323456329E-01);
    phi_Val[4][2].Set_Equal_To(1.01286507323456329E-01);
    phi_Val[5][0].Set_Equal_To(1.01286507323456468E-01);
    phi_Val[5][1].Set_Equal_To(7.97426985353087203E-01);
    phi_Val[5][2].Set_Equal_To(1.01286507323456329E-01);
    phi_Val[6][0].Set_Equal_To(1.01286507323456468E-01);
    phi_Val[6][1].Set_Equal_To(1.01286507323456329E-01);
    phi_Val[6][2].Set_Equal_To(7.97426985353087203E-01);
