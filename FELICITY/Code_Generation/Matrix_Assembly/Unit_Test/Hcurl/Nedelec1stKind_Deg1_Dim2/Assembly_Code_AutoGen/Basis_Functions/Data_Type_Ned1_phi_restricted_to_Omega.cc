...
public:
    ...
    // curl of vector valued H(curl) basis functions (curl is a scalar in 2-D)
    SCALAR Func_vv_Curl[NB][NQ];
...
// Number of Quadrature Points = 7
    ...
    SCALAR phi_Curl[NQ][NB];

    phi_Val[0][0].Set_Equal_To(-3.33333333333333315E-01, 3.33333333333333315E-01);
    phi_Val[0][1].Set_Equal_To(3.33333333333333315E-01, 6.66666666666666630E-01);
    phi_Val[0][2].Set_Equal_To(6.66666666666666630E-01, 3.33333333333333315E-01);
    phi_Val[1][0].Set_Equal_To(-4.70142064105115054E-01, 4.70142064105115054E-01);
    phi_Val[1][1].Set_Equal_To(4.70142064105115054E-01, 5.29857935894884946E-01);
    phi_Val[1][2].Set_Equal_To(5.29857935894884946E-01, 4.70142064105115054E-01);
    phi_Val[2][0].Set_Equal_To(-4.70142064105115054E-01, 5.97158717897698088E-02);
    phi_Val[2][1].Set_Equal_To(4.70142064105115054E-01, 9.40284128210230219E-01);
    phi_Val[2][2].Set_Equal_To(5.29857935894884946E-01, 5.97158717897698088E-02);
    phi_Val[3][0].Set_Equal_To(-5.97158717897698088E-02, 4.70142064105115054E-01);
    phi_Val[3][1].Set_Equal_To(5.97158717897698088E-02, 5.29857935894884946E-01);
    phi_Val[3][2].Set_Equal_To(9.40284128210230219E-01, 4.70142064105115054E-01);
    phi_Val[4][0].Set_Equal_To(-1.01286507323456329E-01, 1.01286507323456329E-01);
    phi_Val[4][1].Set_Equal_To(1.01286507323456329E-01, 8.98713492676543657E-01);
    phi_Val[4][2].Set_Equal_To(8.98713492676543657E-01, 1.01286507323456329E-01);
    phi_Val[5][0].Set_Equal_To(-1.01286507323456329E-01, 7.97426985353087203E-01);
    phi_Val[5][1].Set_Equal_To(1.01286507323456329E-01, 2.02573014646912797E-01);
    phi_Val[5][2].Set_Equal_To(8.98713492676543657E-01, 7.97426985353087203E-01);
    phi_Val[6][0].Set_Equal_To(-7.97426985353087203E-01, 1.01286507323456329E-01);
    phi_Val[6][1].Set_Equal_To(7.97426985353087203E-01, 8.98713492676543657E-01);
    phi_Val[6][2].Set_Equal_To(2.02573014646912797E-01, 1.01286507323456329E-01);

    phi_Curl[0][0].Set_Equal_To(2.00000000000000000E+00);
    phi_Curl[0][1].Set_Equal_To(-2.00000000000000000E+00);
    phi_Curl[0][2].Set_Equal_To(2.00000000000000000E+00);
    phi_Curl[1][0].Set_Equal_To(2.00000000000000000E+00);
    phi_Curl[1][1].Set_Equal_To(-2.00000000000000000E+00);
    phi_Curl[1][2].Set_Equal_To(2.00000000000000000E+00);
    phi_Curl[2][0].Set_Equal_To(2.00000000000000000E+00);
    phi_Curl[2][1].Set_Equal_To(-2.00000000000000000E+00);
    phi_Curl[2][2].Set_Equal_To(2.00000000000000000E+00);
    phi_Curl[3][0].Set_Equal_To(2.00000000000000000E+00);
    phi_Curl[3][1].Set_Equal_To(-2.00000000000000000E+00);
    phi_Curl[3][2].Set_Equal_To(2.00000000000000000E+00);
    phi_Curl[4][0].Set_Equal_To(2.00000000000000000E+00);
    phi_Curl[4][1].Set_Equal_To(-2.00000000000000000E+00);
    phi_Curl[4][2].Set_Equal_To(2.00000000000000000E+00);
    phi_Curl[5][0].Set_Equal_To(2.00000000000000000E+00);
    phi_Curl[5][1].Set_Equal_To(-2.00000000000000000E+00);
    phi_Curl[5][2].Set_Equal_To(2.00000000000000000E+00);
    phi_Curl[6][0].Set_Equal_To(2.00000000000000000E+00);
    phi_Curl[6][1].Set_Equal_To(-2.00000000000000000E+00);
    phi_Curl[6][2].Set_Equal_To(2.00000000000000000E+00);


// // set of quadrature points
// static const double Quad_Points[NQ][SUB_TD] = { \
//     {3.33333333333333315E-01, 3.33333333333333315E-01}, \
//     {4.70142064105115054E-01, 4.70142064105115054E-01}, \
//     {5.97158717897698088E-02, 4.70142064105115054E-01}, \
//     {4.70142064105115054E-01, 5.97158717897698088E-02}, \
//     {1.01286507323456329E-01, 1.01286507323456329E-01}, \
//     {7.97426985353087203E-01, 1.01286507323456329E-01}, \
//     {1.01286507323456329E-01, 7.97426985353087203E-01}  \
//     };

// // set of quadrature weights
// static const double Quad_Weights[NQ] = { \
//     1.12500000000000003E-01, \
//     6.61970763942530821E-02, \
//     6.61970763942530821E-02, \
//     6.61970763942530821E-02, \
//     6.29695902724135836E-02, \
//     6.29695902724135836E-02, \
//     6.29695902724135836E-02  \
//     };
/*------------   END: Auto Generate ------------*/
...
/*------------ BEGIN: Auto Generate ------------*/
    ...
    for (int qp_i = 0; (qp_i < Num_QP); qp_i++)
        ...
        for (int basis_i = 0; (basis_i < Num_Basis); basis_i++)
            ...
            Scalar_Mult_Vector(phi_Val[qp_i][basis_i], Basis_Sign[basis_i], vv_temp);
    ...
    for (int qp_i = 0; (qp_i < Num_QP); qp_i++)
        ...
        for (int basis_i = 0; (basis_i < Num_Basis); basis_i++)
            ...
            const double curl_temp = Basis_Sign[basis_i] * phi_Curl[qp_i][basis_i].a; // apply sign change
            // multiply by 1/det(Jac)
            Func_vv_Curl[basis_i][qp_i].a = curl_temp * Mesh->Map_Inv_Det_Jac[0].a;
            }
        }
/*------------   END: Auto Generate ------------*/
}
