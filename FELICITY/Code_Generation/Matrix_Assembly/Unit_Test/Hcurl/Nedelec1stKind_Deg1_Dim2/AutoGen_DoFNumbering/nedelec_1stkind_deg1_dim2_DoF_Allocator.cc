...
#define ELEM_Name        "nedelec_1stkind_deg1_dim2"
// set allocator class name
#define EDA               nedelec_1stkind_deg1_dim2_DoF_Allocator
// set nodal topology data type name
#define NODAL_TOPOLOGY    nedelec_1stkind_deg1_dim2_nodal_top
// set permutation map data type names
#define SINGLE_EDGE_PERM_MAP    nedelec_1stkind_deg1_dim2_single_edge_perm_map
#define EDGE_DOF_PERMUTATION    nedelec_1stkind_deg1_dim2_edge_dof_perm
#define SINGLE_FACE_PERM_MAP    nedelec_1stkind_deg1_dim2_single_face_perm_map
#define FACE_DOF_PERMUTATION    nedelec_1stkind_deg1_dim2_face_dof_perm
...
/*------------ BEGIN: Auto Generate ------------*/
    ...
    Node.E[1][2][1] = 2; // Set1, E2
    Node.E[1][3][1] = 3; // Set1, E3
