...
#define PLHS_nedelec_1stkind_deg2_dim3_DoF_Map                                0
/*------------   END: Auto Generate ------------*/

/* include classes and other sub-routines */
#include "Misc_Files.h"
#include "Tetrahedron_Data.cc"
#include "nedelec_1stkind_deg2_dim3_DoF_Allocator.cc"
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (nrhs!=1)
        ...
        printf("      -------------------                                            ----- \n");
        printf("      nedelec_1stkind_deg2_dim3_DoF_Map                                0 \n");
        printf("\n");
    ...
    nedelec_1stkind_deg2_dim3_DoF_Allocator      nedelec_1stkind_deg2_dim3_DoF_Obj;
    // do some initial allocation
    plhs[PLHS_nedelec_1stkind_deg2_dim3_DoF_Map] = nedelec_1stkind_deg2_dim3_DoF_Obj.Init_DoF_Map(Tet_Data.Num_Tet);
    // create the DoFmap
    nedelec_1stkind_deg2_dim3_DoF_Obj.Fill_DoF_Map(&Tet_Data);
