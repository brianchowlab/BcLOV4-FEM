...
#define SpecificFEM        Block_Assemble_Curl_Matrix_Data_Type
...
public:
    ...
    /*------------ BEGIN: Auto Generate ------------*/
    // constructor
    SpecificFEM (const PTR_TO_SPARSE*, const Base_Curl_Matrix_Data_Type*);
    ~SpecificFEM (); // destructor
    void Init_Matrix_Assembler_Object(bool);
    void Add_Entries_To_Global_Matrix_Omega (const Base_Curl_Matrix_Data_Type*);
    /*------------   END: Auto Generate ------------*/
private:
};
...
SpecificFEM::SpecificFEM (const PTR_TO_SPARSE* Prev_Sparse_Data,
                          const Base_Curl_Matrix_Data_Type* Block_00
                          ) :
/*------------   END: Auto Generate ------------*/
...
void SpecificFEM::Add_Entries_To_Global_Matrix_Omega(const Base_Curl_Matrix_Data_Type* Block_00)
{
    ...
    const int col_elem_index = Block_00->P1_phi_restricted_to_Omega->Mesh->Domain->Sub_Cell_Index;
    Block_00->P1_phi_restricted_to_Omega->Get_Local_to_Global_DoFmap(col_elem_index, Col_Indices_0);
    ...
    int  Local_Col_Ind[COL_NB] = {0, 1, 2, 3};
    ...
    COO_J_IV_Range[4] = 80; // end of range
