...
GFA::~GFA ()
{
    ...
    mxFree(Sparse_Data_Ned2_Proj_Mat_1.name);
    mxFree(Sparse_Data_Ned2_Proj_Mat_2.name);
    mxFree(Sparse_Data_Ned2_Proj_Mat_3.name);
...
void GFA::Setup_Data(const mxArray *prhs[]) // input from MATLAB
{
    ...
    Access_Previous_FEM_Matrix(prhs[PRHS_OLD_FEM], "Ned2_Proj_Mat_1", 4, Sparse_Data_Ned2_Proj_Mat_1);
    Access_Previous_FEM_Matrix(prhs[PRHS_OLD_FEM], "Ned2_Proj_Mat_2", 5, Sparse_Data_Ned2_Proj_Mat_2);
    Access_Previous_FEM_Matrix(prhs[PRHS_OLD_FEM], "Ned2_Proj_Mat_3", 6, Sparse_Data_Ned2_Proj_Mat_3);
    Access_Previous_FEM_Matrix(prhs[PRHS_OLD_FEM], "RHS_CC", 7, Sparse_Data_RHS_CC);
    Access_Previous_FEM_Matrix(prhs[PRHS_OLD_FEM], "Small_Matrix", 8, Sparse_Data_Small_Matrix);
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // setup access to FE basis functions
    Ned2_phi_restricted_to_Omega.Setup_Function_Space(prhs[PRHS_Ned2_DoFmap]);
    Ned2_phi_restricted_to_Omega.Mesh = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    ...
    Ned2_Proj_Mat_1_Omega_col_constant_phi.Num_Comp = 1;
    Ned2_Proj_Mat_2_Omega_col_constant_phi.Num_Comp = 1;
    Ned2_Proj_Mat_3_Omega_col_constant_phi.Num_Comp = 1;
    ...
    u_old_restricted_to_Omega.Setup_Function_Space(prhs[PRHS_u_old_Values], &Ned2_phi_restricted_to_Omega);
    u_soln_restricted_to_Omega.Setup_Function_Space(prhs[PRHS_u_soln_Values], &Ned2_phi_restricted_to_Omega);
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // setup the base matrices to compute
    Base_Matrix_CurlCurl_Matrix = new Base_CurlCurl_Matrix_Data_Type(&Ned2_phi_restricted_to_Omega, &Ned2_phi_restricted_to_Omega);
    Base_Matrix_Curl_Matrix = new Base_Curl_Matrix_Data_Type(&Ned2_phi_restricted_to_Omega, &P1_phi_restricted_to_Omega);
    ...
    Base_Matrix_Mass_Matrix = new Base_Mass_Matrix_Data_Type(&Ned2_phi_restricted_to_Omega, &Ned2_phi_restricted_to_Omega);
    Base_Matrix_Ned2_Proj_Mat_1 = new Base_Ned2_Proj_Mat_1_Data_Type(&Ned2_phi_restricted_to_Omega, &Ned2_Proj_Mat_1_Omega_col_constant_phi);
    Base_Matrix_Ned2_Proj_Mat_2 = new Base_Ned2_Proj_Mat_2_Data_Type(&Ned2_phi_restricted_to_Omega, &Ned2_Proj_Mat_2_Omega_col_constant_phi);
    Base_Matrix_Ned2_Proj_Mat_3 = new Base_Ned2_Proj_Mat_3_Data_Type(&Ned2_phi_restricted_to_Omega, &Ned2_Proj_Mat_3_Omega_col_constant_phi);
    Base_Matrix_RHS_CC = new Base_RHS_CC_Data_Type(&Ned2_phi_restricted_to_Omega, &RHS_CC_Omega_col_constant_phi);
    ...
    Base_Matrix_CurlCurl_Matrix->Ned2_phi_restricted_to_Omega = &Ned2_phi_restricted_to_Omega;
    ...
    Base_Matrix_Curl_Matrix->Ned2_phi_restricted_to_Omega = &Ned2_phi_restricted_to_Omega;
    ...
    Base_Matrix_L2_Error_Sq->Ned2_phi_restricted_to_Omega = &Ned2_phi_restricted_to_Omega;
    ...
    Base_Matrix_Mass_Matrix->Ned2_phi_restricted_to_Omega = &Ned2_phi_restricted_to_Omega;
    ...
    Base_Matrix_Ned2_Proj_Mat_1->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Base_Matrix_Ned2_Proj_Mat_1->Ned2_phi_restricted_to_Omega = &Ned2_phi_restricted_to_Omega;
    Base_Matrix_Ned2_Proj_Mat_1->P1_phi_restricted_to_Omega = &P1_phi_restricted_to_Omega;
    Base_Matrix_Ned2_Proj_Mat_1->u_old_restricted_to_Omega = &u_old_restricted_to_Omega;
    Base_Matrix_Ned2_Proj_Mat_1->u_soln_restricted_to_Omega = &u_soln_restricted_to_Omega;
    Base_Matrix_Ned2_Proj_Mat_2->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Base_Matrix_Ned2_Proj_Mat_2->Ned2_phi_restricted_to_Omega = &Ned2_phi_restricted_to_Omega;
    Base_Matrix_Ned2_Proj_Mat_2->P1_phi_restricted_to_Omega = &P1_phi_restricted_to_Omega;
    Base_Matrix_Ned2_Proj_Mat_2->u_old_restricted_to_Omega = &u_old_restricted_to_Omega;
    Base_Matrix_Ned2_Proj_Mat_2->u_soln_restricted_to_Omega = &u_soln_restricted_to_Omega;
    Base_Matrix_Ned2_Proj_Mat_3->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Base_Matrix_Ned2_Proj_Mat_3->Ned2_phi_restricted_to_Omega = &Ned2_phi_restricted_to_Omega;
    Base_Matrix_Ned2_Proj_Mat_3->P1_phi_restricted_to_Omega = &P1_phi_restricted_to_Omega;
    Base_Matrix_Ned2_Proj_Mat_3->u_old_restricted_to_Omega = &u_old_restricted_to_Omega;
    Base_Matrix_Ned2_Proj_Mat_3->u_soln_restricted_to_Omega = &u_soln_restricted_to_Omega;
    Base_Matrix_RHS_CC->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Base_Matrix_RHS_CC->Ned2_phi_restricted_to_Omega = &Ned2_phi_restricted_to_Omega;
    ...
    Base_Matrix_Small_Matrix->Ned2_phi_restricted_to_Omega = &Ned2_phi_restricted_to_Omega;
    ...
    Block_Assemble_Matrix_Ned2_Proj_Mat_1 = new Block_Assemble_Ned2_Proj_Mat_1_Data_Type(&Sparse_Data_Ned2_Proj_Mat_1, Base_Matrix_Ned2_Proj_Mat_1);
    Block_Assemble_Matrix_Ned2_Proj_Mat_2 = new Block_Assemble_Ned2_Proj_Mat_2_Data_Type(&Sparse_Data_Ned2_Proj_Mat_2, Base_Matrix_Ned2_Proj_Mat_2);
    Block_Assemble_Matrix_Ned2_Proj_Mat_3 = new Block_Assemble_Ned2_Proj_Mat_3_Data_Type(&Sparse_Data_Ned2_Proj_Mat_3, Base_Matrix_Ned2_Proj_Mat_3);
...
void GFA::Assemble_Matrices ()
{
    ...
    for (std::vector<unsigned int>::iterator DoI_Ind = Domain_Omega_embedded_in_Omega_restricted_to_Omega.Sub_Assem_List.begin();
        ...
        Ned2_phi_restricted_to_Omega.Transform_Basis_Functions();
        ...
        Base_Matrix_Ned2_Proj_Mat_1->Tabulate_Tensor(geom_Omega_embedded_in_Omega_restricted_to_Omega);
        Base_Matrix_Ned2_Proj_Mat_2->Tabulate_Tensor(geom_Omega_embedded_in_Omega_restricted_to_Omega);
        Base_Matrix_Ned2_Proj_Mat_3->Tabulate_Tensor(geom_Omega_embedded_in_Omega_restricted_to_Omega);
        ...
        Block_Assemble_Matrix_Ned2_Proj_Mat_1->Add_Entries_To_Global_Matrix_Omega(Base_Matrix_Ned2_Proj_Mat_1);
        Block_Assemble_Matrix_Ned2_Proj_Mat_2->Add_Entries_To_Global_Matrix_Omega(Base_Matrix_Ned2_Proj_Mat_2);
        Block_Assemble_Matrix_Ned2_Proj_Mat_3->Add_Entries_To_Global_Matrix_Omega(Base_Matrix_Ned2_Proj_Mat_3);
...
void GFA::Output_Matrices (mxArray* plhs[])
{
    ...
    Sparse_ptr = Block_Assemble_Matrix_Ned2_Proj_Mat_1->MAT->export_matrix();
    Output_Matrix(4, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_Ned2_Proj_Mat_1->Name), plhs[0]);
    delete(Block_Assemble_Matrix_Ned2_Proj_Mat_1);

    Sparse_ptr = Block_Assemble_Matrix_Ned2_Proj_Mat_2->MAT->export_matrix();
    Output_Matrix(5, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_Ned2_Proj_Mat_2->Name), plhs[0]);
    delete(Block_Assemble_Matrix_Ned2_Proj_Mat_2);

    Sparse_ptr = Block_Assemble_Matrix_Ned2_Proj_Mat_3->MAT->export_matrix();
    Output_Matrix(6, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_Ned2_Proj_Mat_3->Name), plhs[0]);
    delete(Block_Assemble_Matrix_Ned2_Proj_Mat_3);

    Sparse_ptr = Block_Assemble_Matrix_RHS_CC->MAT->export_matrix();
    Output_Matrix(7, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_RHS_CC->Name), plhs[0]);
    delete(Block_Assemble_Matrix_RHS_CC);

    Sparse_ptr = Block_Assemble_Matrix_Small_Matrix->MAT->export_matrix();
    Output_Matrix(8, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_Small_Matrix->Name), plhs[0]);
