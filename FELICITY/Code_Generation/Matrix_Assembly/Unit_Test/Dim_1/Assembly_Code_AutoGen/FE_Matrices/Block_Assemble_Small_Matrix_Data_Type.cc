...
public:
    ...
    void Add_Entries_To_Global_Matrix_Sigma (const Base_Small_Matrix_Data_Type*);
    /*------------   END: Auto Generate ------------*/
private:
};
...
void SpecificFEM::Add_Entries_To_Global_Matrix_Sigma(const Base_Small_Matrix_Data_Type* Block_00)
{
    ...
    COO_J_IV_Range[2] = 3; // end of range
