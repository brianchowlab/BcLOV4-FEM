...
public:
    ...
    void Add_Entries_To_Global_Matrix_Sigma (const Base_Body_Force_Matrix_Data_Type*);
    /*------------   END: Auto Generate ------------*/
private:
};
...
void SpecificFEM::Add_Entries_To_Global_Matrix_Sigma(const Base_Body_Force_Matrix_Data_Type* Block_00)
{
