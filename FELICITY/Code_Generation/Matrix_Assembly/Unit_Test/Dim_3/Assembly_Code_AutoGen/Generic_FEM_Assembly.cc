...
void GFA::Setup_Data(const mxArray *prhs[]) // input from MATLAB
{
    ...
    Base_Matrix_Body_Force_Matrix = new Base_Body_Force_Matrix_Data_Type(&Scalar_P1_phi_restricted_to_Omega, &Body_Force_Matrix_Omega_col_constant_phi);
    Base_Matrix_L2_Norm_Sq_Error = new Base_L2_Norm_Sq_Error_Data_Type(&L2_Norm_Sq_Error_Omega_row_constant_phi, &L2_Norm_Sq_Error_Omega_col_constant_phi);
    Base_Matrix_Mass_Matrix = new Base_Mass_Matrix_Data_Type(&Scalar_P1_phi_restricted_to_Omega, &Scalar_P1_phi_restricted_to_Omega);
    Base_Matrix_Stiff_Matrix = new Base_Stiff_Matrix_Data_Type(&Scalar_P1_phi_restricted_to_Omega, &Scalar_P1_phi_restricted_to_Omega);
    Base_Matrix_Vector_Mass_Matrix = new Base_Vector_Mass_Matrix_Data_Type(&Vector_P1_phi_restricted_to_Omega, &Vector_P1_phi_restricted_to_Omega);
    Base_Matrix_Weighted_Mass_Matrix = new Base_Weighted_Mass_Matrix_Data_Type(&Scalar_P1_phi_restricted_to_Omega, &Scalar_P1_phi_restricted_to_Omega);
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // pass pointers around
    Base_Matrix_Body_Force_Matrix->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Base_Matrix_Body_Force_Matrix->Scalar_P1_phi_restricted_to_Omega = &Scalar_P1_phi_restricted_to_Omega;
    Base_Matrix_Body_Force_Matrix->Vector_P1_phi_restricted_to_Omega = &Vector_P1_phi_restricted_to_Omega;
    Base_Matrix_Body_Force_Matrix->my_f_restricted_to_Omega = &my_f_restricted_to_Omega;
    Base_Matrix_Body_Force_Matrix->old_soln_restricted_to_Omega = &old_soln_restricted_to_Omega;
    Base_Matrix_L2_Norm_Sq_Error->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Base_Matrix_L2_Norm_Sq_Error->Scalar_P1_phi_restricted_to_Omega = &Scalar_P1_phi_restricted_to_Omega;
    Base_Matrix_L2_Norm_Sq_Error->Vector_P1_phi_restricted_to_Omega = &Vector_P1_phi_restricted_to_Omega;
    Base_Matrix_L2_Norm_Sq_Error->my_f_restricted_to_Omega = &my_f_restricted_to_Omega;
    Base_Matrix_L2_Norm_Sq_Error->old_soln_restricted_to_Omega = &old_soln_restricted_to_Omega;
    ...
    Base_Matrix_Mass_Matrix->Scalar_P1_phi_restricted_to_Omega = &Scalar_P1_phi_restricted_to_Omega;
    Base_Matrix_Mass_Matrix->Vector_P1_phi_restricted_to_Omega = &Vector_P1_phi_restricted_to_Omega;
    Base_Matrix_Mass_Matrix->my_f_restricted_to_Omega = &my_f_restricted_to_Omega;
    Base_Matrix_Mass_Matrix->old_soln_restricted_to_Omega = &old_soln_restricted_to_Omega;
    ...
    Base_Matrix_Stiff_Matrix->Scalar_P1_phi_restricted_to_Omega = &Scalar_P1_phi_restricted_to_Omega;
    Base_Matrix_Stiff_Matrix->Vector_P1_phi_restricted_to_Omega = &Vector_P1_phi_restricted_to_Omega;
    Base_Matrix_Stiff_Matrix->my_f_restricted_to_Omega = &my_f_restricted_to_Omega;
    Base_Matrix_Stiff_Matrix->old_soln_restricted_to_Omega = &old_soln_restricted_to_Omega;
    Base_Matrix_Vector_Mass_Matrix->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Base_Matrix_Vector_Mass_Matrix->Scalar_P1_phi_restricted_to_Omega = &Scalar_P1_phi_restricted_to_Omega;
    Base_Matrix_Vector_Mass_Matrix->Vector_P1_phi_restricted_to_Omega = &Vector_P1_phi_restricted_to_Omega;
    Base_Matrix_Vector_Mass_Matrix->my_f_restricted_to_Omega = &my_f_restricted_to_Omega;
    Base_Matrix_Vector_Mass_Matrix->old_soln_restricted_to_Omega = &old_soln_restricted_to_Omega;
    Base_Matrix_Weighted_Mass_Matrix->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Base_Matrix_Weighted_Mass_Matrix->Scalar_P1_phi_restricted_to_Omega = &Scalar_P1_phi_restricted_to_Omega;
    Base_Matrix_Weighted_Mass_Matrix->Vector_P1_phi_restricted_to_Omega = &Vector_P1_phi_restricted_to_Omega;
    Base_Matrix_Weighted_Mass_Matrix->my_f_restricted_to_Omega = &my_f_restricted_to_Omega;
    Base_Matrix_Weighted_Mass_Matrix->old_soln_restricted_to_Omega = &old_soln_restricted_to_Omega;
    /*------------   END: Auto Generate ------------*/
    ...
    Block_Assemble_Matrix_L2_Norm_Sq_Error = new Block_Assemble_L2_Norm_Sq_Error_Data_Type(&Sparse_Data_L2_Norm_Sq_Error, Base_Matrix_L2_Norm_Sq_Error);
...
void GFA::Assemble_Matrices ()
{
    ...
    for (std::vector<unsigned int>::iterator DoI_Ind = Domain_Omega_embedded_in_Omega_restricted_to_Omega.Sub_Assem_List.begin();
        ...
        Base_Matrix_Body_Force_Matrix->Tabulate_Tensor(geom_Omega_embedded_in_Omega_restricted_to_Omega);
        Base_Matrix_L2_Norm_Sq_Error->Tabulate_Tensor(geom_Omega_embedded_in_Omega_restricted_to_Omega);
        ...
        Base_Matrix_Vector_Mass_Matrix->Tabulate_Tensor(geom_Omega_embedded_in_Omega_restricted_to_Omega);
        Base_Matrix_Weighted_Mass_Matrix->Tabulate_Tensor(geom_Omega_embedded_in_Omega_restricted_to_Omega);

        // loop through the block FE matrices to assemble
        Block_Assemble_Matrix_Body_Force_Matrix->Add_Entries_To_Global_Matrix_Omega(Base_Matrix_Body_Force_Matrix);
        Block_Assemble_Matrix_L2_Norm_Sq_Error->Add_Entries_To_Global_Matrix_Omega(Base_Matrix_L2_Norm_Sq_Error);
        ...
        Block_Assemble_Matrix_Vector_Mass_Matrix->Add_Entries_To_Global_Matrix_Omega(Base_Matrix_Vector_Mass_Matrix);
        Block_Assemble_Matrix_Weighted_Mass_Matrix->Add_Entries_To_Global_Matrix_Omega(Base_Matrix_Weighted_Mass_Matrix);
        }
...
void GFA::Output_Matrices (mxArray* plhs[])
{
    ...
    Sparse_ptr = Block_Assemble_Matrix_L2_Norm_Sq_Error->MAT->export_matrix();
    Output_Matrix(1, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_L2_Norm_Sq_Error->Name), plhs[0]);
    delete(Block_Assemble_Matrix_L2_Norm_Sq_Error);
    ...
    Output_Matrix(4, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_Vector_Mass_Matrix->Name), plhs[0]);
    delete(Block_Assemble_Matrix_Vector_Mass_Matrix);

    Sparse_ptr = Block_Assemble_Matrix_Weighted_Mass_Matrix->MAT->export_matrix();
    Output_Matrix(5, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_Weighted_Mass_Matrix->Name), plhs[0]);
