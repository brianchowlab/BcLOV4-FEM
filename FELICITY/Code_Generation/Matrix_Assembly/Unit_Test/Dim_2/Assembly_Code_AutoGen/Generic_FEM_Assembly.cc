...
void GFA::Setup_Data(const mxArray *prhs[]) // input from MATLAB
{
    ...
    Base_Matrix_Body_Force_Matrix = new Base_Body_Force_Matrix_Data_Type(&Scalar_P2_phi_restricted_to_Gamma, &Body_Force_Matrix_Gamma_col_constant_phi);
    Base_Matrix_Curv_Matrix = new Base_Curv_Matrix_Data_Type(&Scalar_P2_phi_restricted_to_Gamma, &Curv_Matrix_Gamma_col_constant_phi);
    Base_Matrix_Mass_Matrix = new Base_Mass_Matrix_Data_Type(&Scalar_P2_phi_restricted_to_Gamma, &Scalar_P2_phi_restricted_to_Gamma);
    Base_Matrix_Normal_Matrix = new Base_Normal_Matrix_Data_Type(&Vector_P1_phi_restricted_to_Gamma, &Normal_Matrix_Gamma_col_constant_phi);
    Base_Matrix_Small_Matrix = new Base_Small_Matrix_Data_Type(&Small_Matrix_Gamma_row_constant_phi, &Small_Matrix_Gamma_col_constant_phi);
    Base_Matrix_Stiff_Matrix = new Base_Stiff_Matrix_Data_Type(&Scalar_P2_phi_restricted_to_Gamma, &Scalar_P2_phi_restricted_to_Gamma);
    Base_Matrix_Vector_Mass_Matrix = new Base_Vector_Mass_Matrix_Data_Type(&Vector_P1_phi_restricted_to_Gamma, &Vector_P1_phi_restricted_to_Gamma);
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // pass pointers around
    Base_Matrix_Body_Force_Matrix->geom_Gamma_embedded_in_Gamma_restricted_to_Gamma = &geom_Gamma_embedded_in_Gamma_restricted_to_Gamma;
    Base_Matrix_Body_Force_Matrix->Scalar_P2_phi_restricted_to_Gamma = &Scalar_P2_phi_restricted_to_Gamma;
    Base_Matrix_Body_Force_Matrix->Vector_P1_phi_restricted_to_Gamma = &Vector_P1_phi_restricted_to_Gamma;
    Base_Matrix_Body_Force_Matrix->old_soln_restricted_to_Gamma = &old_soln_restricted_to_Gamma;
    Base_Matrix_Curv_Matrix->geom_Gamma_embedded_in_Gamma_restricted_to_Gamma = &geom_Gamma_embedded_in_Gamma_restricted_to_Gamma;
    Base_Matrix_Curv_Matrix->Scalar_P2_phi_restricted_to_Gamma = &Scalar_P2_phi_restricted_to_Gamma;
    Base_Matrix_Curv_Matrix->Vector_P1_phi_restricted_to_Gamma = &Vector_P1_phi_restricted_to_Gamma;
    Base_Matrix_Curv_Matrix->old_soln_restricted_to_Gamma = &old_soln_restricted_to_Gamma;
    ...
    Base_Matrix_Mass_Matrix->Scalar_P2_phi_restricted_to_Gamma = &Scalar_P2_phi_restricted_to_Gamma;
    Base_Matrix_Mass_Matrix->Vector_P1_phi_restricted_to_Gamma = &Vector_P1_phi_restricted_to_Gamma;
    Base_Matrix_Mass_Matrix->old_soln_restricted_to_Gamma = &old_soln_restricted_to_Gamma;
    Base_Matrix_Normal_Matrix->geom_Gamma_embedded_in_Gamma_restricted_to_Gamma = &geom_Gamma_embedded_in_Gamma_restricted_to_Gamma;
    Base_Matrix_Normal_Matrix->Scalar_P2_phi_restricted_to_Gamma = &Scalar_P2_phi_restricted_to_Gamma;
    Base_Matrix_Normal_Matrix->Vector_P1_phi_restricted_to_Gamma = &Vector_P1_phi_restricted_to_Gamma;
    Base_Matrix_Normal_Matrix->old_soln_restricted_to_Gamma = &old_soln_restricted_to_Gamma;
    Base_Matrix_Small_Matrix->geom_Gamma_embedded_in_Gamma_restricted_to_Gamma = &geom_Gamma_embedded_in_Gamma_restricted_to_Gamma;
    Base_Matrix_Small_Matrix->Scalar_P2_phi_restricted_to_Gamma = &Scalar_P2_phi_restricted_to_Gamma;
    Base_Matrix_Small_Matrix->Vector_P1_phi_restricted_to_Gamma = &Vector_P1_phi_restricted_to_Gamma;
    Base_Matrix_Small_Matrix->old_soln_restricted_to_Gamma = &old_soln_restricted_to_Gamma;
    ...
    Base_Matrix_Stiff_Matrix->Scalar_P2_phi_restricted_to_Gamma = &Scalar_P2_phi_restricted_to_Gamma;
    Base_Matrix_Stiff_Matrix->Vector_P1_phi_restricted_to_Gamma = &Vector_P1_phi_restricted_to_Gamma;
    Base_Matrix_Stiff_Matrix->old_soln_restricted_to_Gamma = &old_soln_restricted_to_Gamma;
    Base_Matrix_Vector_Mass_Matrix->geom_Gamma_embedded_in_Gamma_restricted_to_Gamma = &geom_Gamma_embedded_in_Gamma_restricted_to_Gamma;
    Base_Matrix_Vector_Mass_Matrix->Scalar_P2_phi_restricted_to_Gamma = &Scalar_P2_phi_restricted_to_Gamma;
    Base_Matrix_Vector_Mass_Matrix->Vector_P1_phi_restricted_to_Gamma = &Vector_P1_phi_restricted_to_Gamma;
    Base_Matrix_Vector_Mass_Matrix->old_soln_restricted_to_Gamma = &old_soln_restricted_to_Gamma;
    /*------------   END: Auto Generate ------------*/
    ...
    Block_Assemble_Matrix_Normal_Matrix = new Block_Assemble_Normal_Matrix_Data_Type(&Sparse_Data_Normal_Matrix, Base_Matrix_Normal_Matrix);
...
void GFA::Assemble_Matrices ()
{
    ...
    for (std::vector<unsigned int>::iterator DoI_Ind = Domain_Gamma_embedded_in_Gamma_restricted_to_Gamma.Sub_Assem_List.begin();
        ...
        Base_Matrix_Body_Force_Matrix->Tabulate_Tensor(geom_Gamma_embedded_in_Gamma_restricted_to_Gamma);
        Base_Matrix_Curv_Matrix->Tabulate_Tensor(geom_Gamma_embedded_in_Gamma_restricted_to_Gamma);
        Base_Matrix_Mass_Matrix->Tabulate_Tensor(geom_Gamma_embedded_in_Gamma_restricted_to_Gamma);
        Base_Matrix_Normal_Matrix->Tabulate_Tensor(geom_Gamma_embedded_in_Gamma_restricted_to_Gamma);
        Base_Matrix_Small_Matrix->Tabulate_Tensor(geom_Gamma_embedded_in_Gamma_restricted_to_Gamma);
        Base_Matrix_Stiff_Matrix->Tabulate_Tensor(geom_Gamma_embedded_in_Gamma_restricted_to_Gamma);
        Base_Matrix_Vector_Mass_Matrix->Tabulate_Tensor(geom_Gamma_embedded_in_Gamma_restricted_to_Gamma);

        // loop through the block FE matrices to assemble
        Block_Assemble_Matrix_Body_Force_Matrix->Add_Entries_To_Global_Matrix_Gamma(Base_Matrix_Body_Force_Matrix);
        Block_Assemble_Matrix_Curv_Matrix->Add_Entries_To_Global_Matrix_Gamma(Base_Matrix_Curv_Matrix);
        Block_Assemble_Matrix_Mass_Matrix->Add_Entries_To_Global_Matrix_Gamma(Base_Matrix_Mass_Matrix);
        Block_Assemble_Matrix_Normal_Matrix->Add_Entries_To_Global_Matrix_Gamma(Base_Matrix_Normal_Matrix);
        Block_Assemble_Matrix_Small_Matrix->Add_Entries_To_Global_Matrix_Gamma(Base_Matrix_Small_Matrix);
        Block_Assemble_Matrix_Stiff_Matrix->Add_Entries_To_Global_Matrix_Gamma(Base_Matrix_Stiff_Matrix);
        Block_Assemble_Matrix_Vector_Mass_Matrix->Add_Entries_To_Global_Matrix_Gamma(Base_Matrix_Vector_Mass_Matrix);
        }
...
void GFA::Output_Matrices (mxArray* plhs[])
{
    ...
    Sparse_ptr = Block_Assemble_Matrix_Normal_Matrix->MAT->export_matrix();
    Output_Matrix(3, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_Normal_Matrix->Name), plhs[0]);
    delete(Block_Assemble_Matrix_Normal_Matrix);
    ...
    Output_Matrix(5, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_Stiff_Matrix->Name), plhs[0]);
