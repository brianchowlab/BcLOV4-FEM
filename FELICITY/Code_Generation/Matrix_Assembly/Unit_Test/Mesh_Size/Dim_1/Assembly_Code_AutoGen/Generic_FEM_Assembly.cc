...
void GFA::Setup_Data(const mxArray *prhs[]) // input from MATLAB
{
    ...
    Base_Matrix_Mass_Matrix = new Base_Mass_Matrix_Data_Type(&Scalar_P0_phi_restricted_to_Sigma, &Scalar_P0_phi_restricted_to_Sigma);
    Base_Matrix_RHS = new Base_RHS_Data_Type(&Scalar_P0_phi_restricted_to_Sigma, &RHS_Sigma_col_constant_phi);
    ...
    Base_Matrix_Mass_Matrix->Scalar_P0_phi_restricted_to_Sigma = &Scalar_P0_phi_restricted_to_Sigma;
    Base_Matrix_RHS->geom_Sigma_embedded_in_Sigma_restricted_to_Sigma = &geom_Sigma_embedded_in_Sigma_restricted_to_Sigma;
    Base_Matrix_RHS->Scalar_P0_phi_restricted_to_Sigma = &Scalar_P0_phi_restricted_to_Sigma;
    ...
    Base_Matrix_Small_Matrix->Scalar_P0_phi_restricted_to_Sigma = &Scalar_P0_phi_restricted_to_Sigma;
    /*------------   END: Auto Generate ------------*/
...
void GFA::Assemble_Matrices ()
{
    ...
    for (std::vector<unsigned int>::iterator DoI_Ind = Domain_Sigma_embedded_in_Sigma_restricted_to_Sigma.Sub_Assem_List.begin();
        ...
        Base_Matrix_RHS->Tabulate_Tensor(geom_Sigma_embedded_in_Sigma_restricted_to_Sigma);
        ...
        Block_Assemble_Matrix_RHS->Add_Entries_To_Global_Matrix_Sigma(Base_Matrix_RHS);
...
void GFA::Output_Matrices (mxArray* plhs[])
{
    ...
    Output_Matrix(2, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_Small_Matrix->Name), plhs[0]);
