...
#define ELEM_Name        "raviart_thomas_deg1_dim2"
// set allocator class name
#define EDA               raviart_thomas_deg1_dim2_DoF_Allocator
// set nodal topology data type name
#define NODAL_TOPOLOGY    raviart_thomas_deg1_dim2_nodal_top
// set permutation map data type names
#define SINGLE_EDGE_PERM_MAP    raviart_thomas_deg1_dim2_single_edge_perm_map
#define EDGE_DOF_PERMUTATION    raviart_thomas_deg1_dim2_edge_dof_perm
#define SINGLE_FACE_PERM_MAP    raviart_thomas_deg1_dim2_single_face_perm_map
#define FACE_DOF_PERMUTATION    raviart_thomas_deg1_dim2_face_dof_perm
...
/*------------ BEGIN: Auto Generate ------------*/
    ...
    Node.F[1][1][1] = 7; // Set1, F1

    Node.F[2][1][1] = 8; // Set2, F1
                         ...
                         const int              DoF_Offset)
{
    ...
    if (Num_DoF_Per_Face > 0)
        ...
        for (int ti=0; ti < Tri_Edge_Search->Num_Tri; ti++)
            ...
            // Set 2: add more DoFs
            Face_DoF_Counter++;
            cell_dof[ Node.F[2][face_ind][1] ][ti] = Face_DoF_Counter;
            /*------------   END: Auto Generate ------------*/
            }
        }
