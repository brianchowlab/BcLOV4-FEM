...
#define SpecificFUNC        Data_Type_P_Space_phi_restricted_to_d_Gamma
#define SpecificFUNC_str   "Data_Type_P_Space_phi_restricted_to_d_Gamma"

// set the type of function space
#define SPACE_type  "DG - lagrange_deg1_dim2"
// set the name of function space
#define SPACE_name  "P_Space"
...
/*------------ BEGIN: Auto Generate ------------*/
// Local Element defined on Subdomain: DG, lagrange_deg1_dim2
...
// Number of Quadrature Points = 5
    ...
    phi_Val[0][1].Set_Equal_To(9.53089922969331926E-01);
    phi_Val[0][2].Set_Equal_To(4.69100770306680737E-02);
    phi_Val[1][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[1][1].Set_Equal_To(7.69234655052841609E-01);
    phi_Val[1][2].Set_Equal_To(2.30765344947158446E-01);
    phi_Val[2][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[2][1].Set_Equal_To(5.00000000000000000E-01);
    phi_Val[2][2].Set_Equal_To(5.00000000000000000E-01);
    phi_Val[3][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[3][1].Set_Equal_To(2.30765344947158502E-01);
    phi_Val[3][2].Set_Equal_To(7.69234655052841498E-01);
    phi_Val[4][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[4][1].Set_Equal_To(4.69100770306680737E-02);
    phi_Val[4][2].Set_Equal_To(9.53089922969331926E-01);
...
// Number of Quadrature Points = 5
    ...
    phi_Val[0][2].Set_Equal_To(9.53089922969331926E-01);
    phi_Val[1][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[1][1].Set_Equal_To(2.30765344947158446E-01);
    phi_Val[1][2].Set_Equal_To(7.69234655052841609E-01);
    phi_Val[2][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[2][1].Set_Equal_To(5.00000000000000000E-01);
    phi_Val[2][2].Set_Equal_To(5.00000000000000000E-01);
    phi_Val[3][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[3][1].Set_Equal_To(7.69234655052841498E-01);
    phi_Val[3][2].Set_Equal_To(2.30765344947158502E-01);
    phi_Val[4][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[4][1].Set_Equal_To(9.53089922969331926E-01);
    phi_Val[4][2].Set_Equal_To(4.69100770306680737E-02);
...
// Number of Quadrature Points = 5
    ...
    phi_Val[0][0].Set_Equal_To(4.69100770306680737E-02);
    phi_Val[0][1].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[0][2].Set_Equal_To(9.53089922969331926E-01);
    phi_Val[1][0].Set_Equal_To(2.30765344947158446E-01);
    ...
    phi_Val[2][2].Set_Equal_To(5.00000000000000000E-01);
    phi_Val[3][0].Set_Equal_To(7.69234655052841498E-01);
    phi_Val[3][1].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[3][2].Set_Equal_To(2.30765344947158502E-01);
    phi_Val[4][0].Set_Equal_To(9.53089922969331926E-01);
