...
#define ELEM_Name        "brezzi_douglas_marini_deg1_dim2"
// set allocator class name
#define EDA               brezzi_douglas_marini_deg1_dim2_DoF_Allocator
// set nodal topology data type name
#define NODAL_TOPOLOGY    brezzi_douglas_marini_deg1_dim2_nodal_top
// set permutation map data type names
#define SINGLE_EDGE_PERM_MAP    brezzi_douglas_marini_deg1_dim2_single_edge_perm_map
#define EDGE_DOF_PERMUTATION    brezzi_douglas_marini_deg1_dim2_edge_dof_perm
#define SINGLE_FACE_PERM_MAP    brezzi_douglas_marini_deg1_dim2_single_face_perm_map
#define FACE_DOF_PERMUTATION    brezzi_douglas_marini_deg1_dim2_face_dof_perm
