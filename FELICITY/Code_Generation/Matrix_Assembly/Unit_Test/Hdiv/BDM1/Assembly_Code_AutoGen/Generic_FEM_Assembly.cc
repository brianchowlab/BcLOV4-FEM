...
void GFA::Setup_Data(const mxArray *prhs[]) // input from MATLAB
{
    ...
    old_vel_restricted_to_Omega.Setup_Function_Space(prhs[PRHS_old_vel_Values], &BDM1_phi_restricted_to_Omega);
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // setup the base matrices to compute
    Base_Matrix_Div_Matrix = new Base_Div_Matrix_Data_Type(&BDM1_phi_restricted_to_Omega, &P0_phi_restricted_to_Omega);
    ...
    Base_Matrix_Mass_Matrix = new Base_Mass_Matrix_Data_Type(&BDM1_phi_restricted_to_Omega, &BDM1_phi_restricted_to_Omega);
    ...
    Base_Matrix_Div_Matrix->BDM1_phi_restricted_to_Omega = &BDM1_phi_restricted_to_Omega;
    ...
    Base_Matrix_L2_Error_Sq->BDM1_phi_restricted_to_Omega = &BDM1_phi_restricted_to_Omega;
    ...
    Base_Matrix_Mass_Matrix->BDM1_phi_restricted_to_Omega = &BDM1_phi_restricted_to_Omega;
    ...
    Base_Matrix_RHS_Div->BDM1_phi_restricted_to_Omega = &BDM1_phi_restricted_to_Omega;
    ...
    Base_Matrix_Small_Matrix->BDM1_phi_restricted_to_Omega = &BDM1_phi_restricted_to_Omega;
