...
#define SpecificFUNC        Data_Type_BDM1_phi_restricted_to_Omega
#define SpecificFUNC_str   "Data_Type_BDM1_phi_restricted_to_Omega"
...
// Number of Quadrature Points = 6
    ...
    phi_Val[0][0].Set_Equal_To(3.26739029192183583E+00, -1.83152427019542013E-01);
    phi_Val[0][1].Set_Equal_To(-1.63369514596091792E+00, 3.66304854039084027E-01);
    phi_Val[0][2].Set_Equal_To(-1.83152427019543956E-01, 3.66304854039084027E-01);
    phi_Val[0][3].Set_Equal_To(-1.83152427019538128E-01, -1.83152427019542013E-01);
    phi_Val[0][4].Set_Equal_To(-1.63369514596091792E+00, 1.26739029192183783E+00);
    phi_Val[0][5].Set_Equal_To(3.26739029192183583E+00, -3.08423786490229590E+00);
    phi_Val[1][0].Set_Equal_To(3.66304854039084027E-01, -1.63369514596091792E+00);
    phi_Val[1][1].Set_Equal_To(-1.83152427019542013E-01, 3.26739029192183583E+00);
    phi_Val[1][2].Set_Equal_To(-3.08423786490229590E+00, 3.26739029192183583E+00);
    phi_Val[1][3].Set_Equal_To(1.26739029192183783E+00, -1.63369514596091792E+00);
    phi_Val[1][4].Set_Equal_To(-1.83152427019542013E-01, -1.83152427019538128E-01);
    phi_Val[1][5].Set_Equal_To(3.66304854039084027E-01, -1.83152427019543956E-01);
    phi_Val[2][0].Set_Equal_To(3.66304854039084027E-01, -1.83152427019542013E-01);
    phi_Val[2][1].Set_Equal_To(-1.83152427019542013E-01, 3.66304854039084027E-01);
    phi_Val[2][2].Set_Equal_To(1.26739029192183184E+00, 3.66304854039084027E-01);
    phi_Val[2][3].Set_Equal_To(-3.08423786490229013E+00, -1.83152427019542013E-01);
    phi_Val[2][4].Set_Equal_To(-1.83152427019542013E-01, -3.08423786490229013E+00);
    phi_Val[2][5].Set_Equal_To(3.66304854039084027E-01, 1.26739029192183184E+00);
    phi_Val[3][0].Set_Equal_To(4.32412072672279990E-01, -8.91896981831930002E-01);
    phi_Val[3][1].Set_Equal_To(-2.16206036336139995E-01, 1.78379396366386000E+00);
    phi_Val[3][2].Set_Equal_To(-8.91896981831930002E-01, 1.78379396366386000E+00);
    phi_Val[3][3].Set_Equal_To(-8.91896981831930002E-01, -8.91896981831930002E-01);
    phi_Val[3][4].Set_Equal_To(-2.16206036336139995E-01, -1.56758792732772001E+00);
    phi_Val[3][5].Set_Equal_To(4.32412072672279990E-01, 4.59484909159650012E-01);
    phi_Val[4][0].Set_Equal_To(1.78379396366386000E+00, -2.16206036336139995E-01);
    phi_Val[4][1].Set_Equal_To(-8.91896981831930002E-01, 4.32412072672279990E-01);
    phi_Val[4][2].Set_Equal_To(4.59484909159650012E-01, 4.32412072672279990E-01);
    phi_Val[4][3].Set_Equal_To(-1.56758792732772001E+00, -2.16206036336139995E-01);
    phi_Val[4][4].Set_Equal_To(-8.91896981831930002E-01, -8.91896981831930002E-01);
    phi_Val[4][5].Set_Equal_To(1.78379396366386000E+00, -8.91896981831930002E-01);
    phi_Val[5][0].Set_Equal_To(1.78379396366386000E+00, -8.91896981831930002E-01);
    phi_Val[5][1].Set_Equal_To(-8.91896981831930002E-01, 1.78379396366386000E+00);
    phi_Val[5][2].Set_Equal_To(-1.56758792732772001E+00, 1.78379396366386000E+00);
    phi_Val[5][3].Set_Equal_To(4.59484909159650012E-01, -8.91896981831930002E-01);
    phi_Val[5][4].Set_Equal_To(-8.91896981831930002E-01, 4.59484909159650012E-01);
    phi_Val[5][5].Set_Equal_To(1.78379396366386000E+00, -1.56758792732772001E+00);
    ...
    phi_Div[0][3].Set_Equal_To(2.00000000000000000E+00);
    phi_Div[0][4].Set_Equal_To(2.00000000000000000E+00);
    phi_Div[0][5].Set_Equal_To(2.00000000000000000E+00);
    ...
    phi_Div[1][3].Set_Equal_To(2.00000000000000000E+00);
    phi_Div[1][4].Set_Equal_To(2.00000000000000000E+00);
    phi_Div[1][5].Set_Equal_To(2.00000000000000000E+00);
    ...
    phi_Div[2][3].Set_Equal_To(2.00000000000000000E+00);
    phi_Div[2][4].Set_Equal_To(2.00000000000000000E+00);
    phi_Div[2][5].Set_Equal_To(2.00000000000000000E+00);
    ...
    phi_Div[3][3].Set_Equal_To(2.00000000000000000E+00);
    phi_Div[3][4].Set_Equal_To(2.00000000000000000E+00);
    phi_Div[3][5].Set_Equal_To(2.00000000000000000E+00);
    ...
    phi_Div[4][3].Set_Equal_To(2.00000000000000000E+00);
    phi_Div[4][4].Set_Equal_To(2.00000000000000000E+00);
    phi_Div[4][5].Set_Equal_To(2.00000000000000000E+00);
    ...
    phi_Div[5][3].Set_Equal_To(2.00000000000000000E+00);
    phi_Div[5][4].Set_Equal_To(2.00000000000000000E+00);
    phi_Div[5][5].Set_Equal_To(2.00000000000000000E+00);
