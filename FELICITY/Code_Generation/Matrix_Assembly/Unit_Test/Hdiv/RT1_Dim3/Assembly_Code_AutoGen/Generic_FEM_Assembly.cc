...
GFA::~GFA ()
{
    ...
    mxFree(Sparse_Data_RT1_Proj_Mat_1.name);
    mxFree(Sparse_Data_RT1_Proj_Mat_2.name);
    mxFree(Sparse_Data_RT1_Proj_Mat_3.name);
...
void GFA::Setup_Data(const mxArray *prhs[]) // input from MATLAB
{
    ...
    Access_Previous_FEM_Matrix(prhs[PRHS_OLD_FEM], "RT1_Proj_Mat_1", 4, Sparse_Data_RT1_Proj_Mat_1);
    Access_Previous_FEM_Matrix(prhs[PRHS_OLD_FEM], "RT1_Proj_Mat_2", 5, Sparse_Data_RT1_Proj_Mat_2);
    Access_Previous_FEM_Matrix(prhs[PRHS_OLD_FEM], "RT1_Proj_Mat_3", 6, Sparse_Data_RT1_Proj_Mat_3);
    ...
    RT1_phi_restricted_to_Omega.Setup_Function_Space(prhs[PRHS_RT1_DoFmap]);
    RT1_phi_restricted_to_Omega.Mesh = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    /*------------   END: Auto Generate ------------*/
    ...
    old_p_restricted_to_Omega.Setup_Function_Space(prhs[PRHS_old_p_Values], &P1_phi_restricted_to_Omega);
    old_vel_restricted_to_Omega.Setup_Function_Space(prhs[PRHS_old_vel_Values], &RT1_phi_restricted_to_Omega);
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // setup the base matrices to compute
    Base_Matrix_Div_Matrix = new Base_Div_Matrix_Data_Type(&RT1_phi_restricted_to_Omega, &P1_phi_restricted_to_Omega);
    ...
    Base_Matrix_Mass_Matrix = new Base_Mass_Matrix_Data_Type(&RT1_phi_restricted_to_Omega, &RT1_phi_restricted_to_Omega);
    Base_Matrix_RHS_Div = new Base_RHS_Div_Data_Type(&P1_phi_restricted_to_Omega, &RHS_Div_Omega_col_constant_phi);
    Base_Matrix_RT1_Proj_Mat_1 = new Base_RT1_Proj_Mat_1_Data_Type(&RT1_phi_restricted_to_Omega, &P1_phi_restricted_to_Omega);
    Base_Matrix_RT1_Proj_Mat_2 = new Base_RT1_Proj_Mat_2_Data_Type(&RT1_phi_restricted_to_Omega, &P1_phi_restricted_to_Omega);
    Base_Matrix_RT1_Proj_Mat_3 = new Base_RT1_Proj_Mat_3_Data_Type(&RT1_phi_restricted_to_Omega, &P1_phi_restricted_to_Omega);
    ...
    Base_Matrix_Div_Matrix->P1_phi_restricted_to_Omega = &P1_phi_restricted_to_Omega;
    Base_Matrix_Div_Matrix->RT1_phi_restricted_to_Omega = &RT1_phi_restricted_to_Omega;
    ...
    Base_Matrix_L2_Error_Sq->RT1_phi_restricted_to_Omega = &RT1_phi_restricted_to_Omega;
    ...
    Base_Matrix_Mass_Matrix->RT1_phi_restricted_to_Omega = &RT1_phi_restricted_to_Omega;
    ...
    Base_Matrix_RHS_Div->P1_phi_restricted_to_Omega = &P1_phi_restricted_to_Omega;
    Base_Matrix_RHS_Div->RT1_phi_restricted_to_Omega = &RT1_phi_restricted_to_Omega;
    ...
    Base_Matrix_RT1_Proj_Mat_1->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Base_Matrix_RT1_Proj_Mat_1->P1_phi_restricted_to_Omega = &P1_phi_restricted_to_Omega;
    Base_Matrix_RT1_Proj_Mat_1->RT1_phi_restricted_to_Omega = &RT1_phi_restricted_to_Omega;
    Base_Matrix_RT1_Proj_Mat_1->old_p_restricted_to_Omega = &old_p_restricted_to_Omega;
    Base_Matrix_RT1_Proj_Mat_1->old_vel_restricted_to_Omega = &old_vel_restricted_to_Omega;
    Base_Matrix_RT1_Proj_Mat_2->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Base_Matrix_RT1_Proj_Mat_2->P1_phi_restricted_to_Omega = &P1_phi_restricted_to_Omega;
    Base_Matrix_RT1_Proj_Mat_2->RT1_phi_restricted_to_Omega = &RT1_phi_restricted_to_Omega;
    Base_Matrix_RT1_Proj_Mat_2->old_p_restricted_to_Omega = &old_p_restricted_to_Omega;
    Base_Matrix_RT1_Proj_Mat_2->old_vel_restricted_to_Omega = &old_vel_restricted_to_Omega;
    Base_Matrix_RT1_Proj_Mat_3->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Base_Matrix_RT1_Proj_Mat_3->P1_phi_restricted_to_Omega = &P1_phi_restricted_to_Omega;
    Base_Matrix_RT1_Proj_Mat_3->RT1_phi_restricted_to_Omega = &RT1_phi_restricted_to_Omega;
    Base_Matrix_RT1_Proj_Mat_3->old_p_restricted_to_Omega = &old_p_restricted_to_Omega;
    Base_Matrix_RT1_Proj_Mat_3->old_vel_restricted_to_Omega = &old_vel_restricted_to_Omega;
    ...
    Base_Matrix_Small_Matrix->RT1_phi_restricted_to_Omega = &RT1_phi_restricted_to_Omega;
    ...
    Block_Assemble_Matrix_RT1_Proj_Mat_1 = new Block_Assemble_RT1_Proj_Mat_1_Data_Type(&Sparse_Data_RT1_Proj_Mat_1, Base_Matrix_RT1_Proj_Mat_1);
    Block_Assemble_Matrix_RT1_Proj_Mat_2 = new Block_Assemble_RT1_Proj_Mat_2_Data_Type(&Sparse_Data_RT1_Proj_Mat_2, Base_Matrix_RT1_Proj_Mat_2);
    Block_Assemble_Matrix_RT1_Proj_Mat_3 = new Block_Assemble_RT1_Proj_Mat_3_Data_Type(&Sparse_Data_RT1_Proj_Mat_3, Base_Matrix_RT1_Proj_Mat_3);
...
void GFA::Assemble_Matrices ()
{
    ...
    for (std::vector<unsigned int>::iterator DoI_Ind = Domain_Omega_embedded_in_Omega_restricted_to_Omega.Sub_Assem_List.begin();
        ...
        RT1_phi_restricted_to_Omega.Transform_Basis_Functions();
        ...
        Base_Matrix_RT1_Proj_Mat_1->Tabulate_Tensor(geom_Omega_embedded_in_Omega_restricted_to_Omega);
        Base_Matrix_RT1_Proj_Mat_2->Tabulate_Tensor(geom_Omega_embedded_in_Omega_restricted_to_Omega);
        Base_Matrix_RT1_Proj_Mat_3->Tabulate_Tensor(geom_Omega_embedded_in_Omega_restricted_to_Omega);
        ...
        Block_Assemble_Matrix_RT1_Proj_Mat_1->Add_Entries_To_Global_Matrix_Omega(Base_Matrix_RT1_Proj_Mat_1);
        Block_Assemble_Matrix_RT1_Proj_Mat_2->Add_Entries_To_Global_Matrix_Omega(Base_Matrix_RT1_Proj_Mat_2);
        Block_Assemble_Matrix_RT1_Proj_Mat_3->Add_Entries_To_Global_Matrix_Omega(Base_Matrix_RT1_Proj_Mat_3);
...
void GFA::Output_Matrices (mxArray* plhs[])
{
    ...
    Sparse_ptr = Block_Assemble_Matrix_RT1_Proj_Mat_1->MAT->export_matrix();
    Output_Matrix(4, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_RT1_Proj_Mat_1->Name), plhs[0]);
    delete(Block_Assemble_Matrix_RT1_Proj_Mat_1);

    Sparse_ptr = Block_Assemble_Matrix_RT1_Proj_Mat_2->MAT->export_matrix();
    Output_Matrix(5, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_RT1_Proj_Mat_2->Name), plhs[0]);
    delete(Block_Assemble_Matrix_RT1_Proj_Mat_2);

    Sparse_ptr = Block_Assemble_Matrix_RT1_Proj_Mat_3->MAT->export_matrix();
    Output_Matrix(6, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_RT1_Proj_Mat_3->Name), plhs[0]);
    delete(Block_Assemble_Matrix_RT1_Proj_Mat_3);
