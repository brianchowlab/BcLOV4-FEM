...
public:
    ...
    const Data_Type_P1_phi_restricted_to_Omega*     basis_func;
    ...
    void Setup_Function_Space(const mxArray*, const Data_Type_P1_phi_restricted_to_Omega*);
    void Compute_Func();
private:
};
/*------------   END: Auto Generate ------------*/
...
void SpecificFUNC::Setup_Function_Space(const mxArray* Values,        // inputs
                                        const Data_Type_P1_phi_restricted_to_Omega*   basis_func_input)          // inputs
{
