...
#define PRHS_P1_DoFmap                                                         5
#define PRHS_RT1_DoFmap                                                        6
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if ( (nrhs < 9) || (nrhs > 10) )
        ...
        mexPrintf("      EMPTY_2                                                           4 \n");
        mexPrintf("      P1_DoFmap                                                         5 \n");
        mexPrintf("      RT1_DoFmap                                                        6 \n");
        ...
        mexPrintf("      RHS_Div \n");
        mexPrintf("      RT1_Proj_Mat_1 \n");
        mexPrintf("      RT1_Proj_Mat_2 \n");
        mexPrintf("      RT1_Proj_Mat_3 \n");
