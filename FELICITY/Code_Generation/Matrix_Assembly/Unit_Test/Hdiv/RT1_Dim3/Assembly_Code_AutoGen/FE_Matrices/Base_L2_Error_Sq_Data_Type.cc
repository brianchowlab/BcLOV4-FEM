...
// FE matrix is:
//
// \int_{Omega}  (old_p_v1_t1 - sin(geomOmega_X1*pi)*sin(geomOmega_X2*pi)*sin(geomOmega_X3*pi))^2,  ... etc... (see individual submatrices, i.e. Tab_Tensor routines.)
//
/*------------   END: Auto Generate ------------*/
