...
private:
    ...
    Base_RHS_Div_Data_Type*    Base_Matrix_RHS_Div;
    Base_RT1_Proj_Mat_1_Data_Type*    Base_Matrix_RT1_Proj_Mat_1;
    Base_RT1_Proj_Mat_2_Data_Type*    Base_Matrix_RT1_Proj_Mat_2;
    Base_RT1_Proj_Mat_3_Data_Type*    Base_Matrix_RT1_Proj_Mat_3;
    ...
    Block_Assemble_RHS_Div_Data_Type*    Block_Assemble_Matrix_RHS_Div;
    PTR_TO_SPARSE    Sparse_Data_RHS_Div;
    Block_Assemble_RT1_Proj_Mat_1_Data_Type*    Block_Assemble_Matrix_RT1_Proj_Mat_1;
    PTR_TO_SPARSE    Sparse_Data_RT1_Proj_Mat_1;
    Block_Assemble_RT1_Proj_Mat_2_Data_Type*    Block_Assemble_Matrix_RT1_Proj_Mat_2;
    PTR_TO_SPARSE    Sparse_Data_RT1_Proj_Mat_2;
    Block_Assemble_RT1_Proj_Mat_3_Data_Type*    Block_Assemble_Matrix_RT1_Proj_Mat_3;
    PTR_TO_SPARSE    Sparse_Data_RT1_Proj_Mat_3;
    ...
    Data_Type_RT1_phi_restricted_to_Omega      RT1_phi_restricted_to_Omega;
    /*------------   END: Auto Generate ------------*/
