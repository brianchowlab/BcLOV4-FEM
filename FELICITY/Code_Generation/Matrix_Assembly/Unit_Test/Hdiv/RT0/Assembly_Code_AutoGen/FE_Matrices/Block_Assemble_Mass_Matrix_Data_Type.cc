...
void SpecificFEM::Add_Entries_To_Global_Matrix_Omega(const Base_Mass_Matrix_Data_Type* Block_00)
{
    ...
    const int col_elem_index = Block_00->RT0_phi_restricted_to_Omega->Mesh->Domain->Sub_Cell_Index;
    Block_00->RT0_phi_restricted_to_Omega->Get_Local_to_Global_DoFmap(col_elem_index, Col_Indices_0);
