...
void SpecificFEM::Add_Entries_To_Global_Matrix_Omega(const Base_RHS_Div_Data_Type* Block_00)
{
    ...
    const int row_elem_index = Block_00->P0_phi_restricted_to_Omega->Mesh->Domain->Sub_Cell_Index;
    Block_00->P0_phi_restricted_to_Omega->Get_Local_to_Global_DoFmap(row_elem_index, Row_Indices_0);
