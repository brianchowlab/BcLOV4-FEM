...
#define PLHS_brezzi_douglas_marini_deg1_dim2_DoF_Map                          0
/*------------   END: Auto Generate ------------*/

/* include classes and other sub-routines */
#include "Misc_Files.h"
#include "Triangle_Edge_Search.cc"
#include "brezzi_douglas_marini_deg1_dim2_DoF_Allocator.cc"
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (nrhs!=1)
        ...
        printf("      -------------------                                            ----- \n");
        printf("      brezzi_douglas_marini_deg1_dim2_DoF_Map                          0 \n");
        printf("\n");
    ...
    brezzi_douglas_marini_deg1_dim2_DoF_Allocator      brezzi_douglas_marini_deg1_dim2_DoF_Obj;
    // do some initial allocation
    plhs[PLHS_brezzi_douglas_marini_deg1_dim2_DoF_Map] = brezzi_douglas_marini_deg1_dim2_DoF_Obj.Init_DoF_Map(Tri_Edge_Search.Num_Tri);
    // create the DoFmap
    brezzi_douglas_marini_deg1_dim2_DoF_Obj.Fill_DoF_Map(&Tri_Edge_Search);
