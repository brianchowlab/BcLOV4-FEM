...
#define PRHS_Box_Mesh_Vertices                                                 1
#define PRHS_Box_Mesh_DoFmap                                                   2
#define PRHS_Box_Mesh_Orient                                                   3
#define PRHS_Box_Mesh_Subdomains                                               4
#define PRHS_BDM1_DoFmap                                                       5
#define PRHS_Subset_Elem_Indices                                               6
/*------------   END: Auto Generate ------------*/
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if ( (nrhs < 6) || (nrhs > 7) )
        ...
        mexPrintf("      -------------------                                             ----- \n");
        mexPrintf("      OLD_FEM                                                           0 \n");
        mexPrintf("      Box_Mesh_Vertices                                                 1 \n");
        mexPrintf("      Box_Mesh_DoFmap                                                   2 \n");
        mexPrintf("      Box_Mesh_Orient                                                   3 \n");
        mexPrintf("      Box_Mesh_Subdomains                                               4 \n");
        mexPrintf("      BDM1_DoFmap                                                       5 \n");
        mexPrintf("      (optional) subset of element indices (array of structs):          6\n");
