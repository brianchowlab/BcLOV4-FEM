...
#define MDC        CLASS_Domain_Omega_embedded_in_Box_restricted_to_Gamma
// set the name of the Global mesh (TopDim = 2)
#define GLOBAL_MESH_Name  "Box"
...
void MDC::Setup_Data(const mxArray* Subdomain_Array, const mxArray* Global_Mesh_DoFmap, const mxArray* Sublist_Elem_Indices)  // inputs
{
    ...
    const unsigned int DOM_INDEX = Find_Subdomain_Array_Index(Subdomain_Array,"Box","Omega","Gamma");
