...
#define SpecificFEM        Base_NV_Matrix_Data_Type
...
public:
    ...
    /*------------ BEGIN: Auto Generate ------------*/
    void Tabulate_Tensor(const CLASS_geom_Boundary_embedded_in_Omega_restricted_to_Boundary&);
    /*------------   END: Auto Generate ------------*/
private:
};
...
void SpecificFEM::Tabulate_Tensor(const CLASS_geom_Boundary_embedded_in_Omega_restricted_to_Boundary& Mesh)
{
    ...
    for (unsigned int j = 0; j < COL_NB; j++)
        ...
        for (unsigned int i = 0; i < ROW_NB; i++)
            ...
            for (unsigned int qp = 0; qp < NQ; qp++)
                {
                const double  integrand_0 = (geom_Boundary_embedded_in_Omega_restricted_to_Boundary->Map_Normal_Vector[0].v[0]*RT0_phi_restricted_to_Boundary->Func_vv_Value[j][qp].v[0]+geom_Boundary_embedded_in_Omega_restricted_to_Boundary->Map_Normal_Vector[0].v[1]*RT0_phi_restricted_to_Boundary->Func_vv_Value[j][qp].v[1])*(geom_Boundary_embedded_in_Omega_restricted_to_Boundary->Map_Normal_Vector[0].v[0]*RT0_phi_restricted_to_Boundary->Func_vv_Value[i][qp].v[0]+geom_Boundary_embedded_in_Omega_restricted_to_Boundary->Map_Normal_Vector[0].v[1]*RT0_phi_restricted_to_Boundary->Func_vv_Value[i][qp].v[1]);
