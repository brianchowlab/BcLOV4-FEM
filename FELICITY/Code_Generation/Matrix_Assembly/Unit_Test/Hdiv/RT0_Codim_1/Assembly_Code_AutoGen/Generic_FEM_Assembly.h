...
private:
    ...
    Base_NV_Constraint_Data_Type*    Base_Matrix_NV_Constraint;
    Base_NV_Matrix_Data_Type*    Base_Matrix_NV_Matrix;

    Block_Assemble_NV_Constraint_Data_Type*    Block_Assemble_Matrix_NV_Constraint;
    PTR_TO_SPARSE    Sparse_Data_NV_Constraint;
    Block_Assemble_NV_Matrix_Data_Type*    Block_Assemble_Matrix_NV_Matrix;
