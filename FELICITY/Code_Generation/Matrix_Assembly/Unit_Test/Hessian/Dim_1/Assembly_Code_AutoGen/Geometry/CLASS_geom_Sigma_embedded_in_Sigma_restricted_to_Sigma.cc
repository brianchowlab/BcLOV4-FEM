...
public:
    ...
    MAT_1x1 Map_PHI_Inv_Grad[NQ];
    // hessian of the transformation
    MAT_1x1x1 Map_PHI_Hess[NQ];
    // hessian of the inverse transformation
    MAT_1x1x1 Map_PHI_Hess_Inv_Map[NQ];
...
/*------------ BEGIN: Auto Generate ------------*/
    ...
    for (int qp_i = 0; (qp_i < Num_QP); qp_i++)
        ...
        MAT_1x1& Map_PHI_Grad_qp_i = Map_PHI_Grad[qp_i];
    ...
    for (int qp_i = 0; (qp_i < Num_QP); qp_i++)
        {
        //
        MAT_1x1& Map_PHI_Inv_Grad_qp_i = Map_PHI_Inv_Grad[qp_i];
    ...
    for (int qp_i = 0; (qp_i < Num_QP); qp_i++)
        {
        // sum over basis functions
        MAT_1x1x1& Map_PHI_Hess_qp_i = Map_PHI_Hess[qp_i];
    ...
    for (int qp_i = 0; (qp_i < Num_QP); qp_i++)
        ...
        MAT_1x1x1& Map_PHI_Hess_Inv_Map_qp_i = Map_PHI_Hess_Inv_Map[qp_i];
        // compute: -(d/dx PHI)^{-3} d^2/dx^2 PHI
        Map_PHI_Hess_Inv_Map_qp_i.m[0][0][0] = - Map_PHI_Inv_Grad[qp_i].m[0][0] * Map_PHI_Inv_Grad[qp_i].m[0][0] * Map_PHI_Inv_Grad[qp_i].m[0][0] * Map_PHI_Hess[qp_i].m[0][0][0];
        }
/*------------   END: Auto Generate ------------*/
}
/***************************************************************************************/
