...
void GFA::Setup_Data(const mxArray *prhs[]) // input from MATLAB
{
    ...
    Vector_P2_phi_restricted_to_Gamma.Setup_Function_Space(prhs[PRHS_Vector_P2_DoFmap]);
    Vector_P2_phi_restricted_to_Gamma.Mesh = &geom_Gamma_embedded_in_Gamma_restricted_to_Gamma;
    /*------------   END: Auto Generate ------------*/
    ...
    Vec_restricted_to_Gamma.Setup_Function_Space(prhs[PRHS_Vec_Values], &Vector_P2_phi_restricted_to_Gamma);
    /*------------   END: Auto Generate ------------*/
    ...
    Base_Matrix_Vector_Hess_Matrix = new Base_Vector_Hess_Matrix_Data_Type(&Vector_P2_phi_restricted_to_Gamma, &Vector_P2_phi_restricted_to_Gamma);
    /*------------   END: Auto Generate ------------*/
    ...
    Base_Matrix_Small_Matrix->Vector_P2_phi_restricted_to_Gamma = &Vector_P2_phi_restricted_to_Gamma;
    Base_Matrix_Small_Matrix->Vec_restricted_to_Gamma = &Vec_restricted_to_Gamma;
    Base_Matrix_Vector_Hess_Matrix->geom_Gamma_embedded_in_Gamma_restricted_to_Gamma = &geom_Gamma_embedded_in_Gamma_restricted_to_Gamma;
    Base_Matrix_Vector_Hess_Matrix->Vector_P2_phi_restricted_to_Gamma = &Vector_P2_phi_restricted_to_Gamma;
    Base_Matrix_Vector_Hess_Matrix->Vec_restricted_to_Gamma = &Vec_restricted_to_Gamma;
    /*------------   END: Auto Generate ------------*/
...
void GFA::Assemble_Matrices ()
{
    ...
    for (std::vector<unsigned int>::iterator DoI_Ind = Domain_Gamma_embedded_in_Gamma_restricted_to_Gamma.Sub_Assem_List.begin();
        ...
        Vector_P2_phi_restricted_to_Gamma.Transform_Basis_Functions();

        // perform pre-computations with external FE coefficient functions
        Vec_restricted_to_Gamma.Compute_Func();
        ...
        Base_Matrix_Vector_Hess_Matrix->Tabulate_Tensor(geom_Gamma_embedded_in_Gamma_restricted_to_Gamma);
        ...
        Block_Assemble_Matrix_Vector_Hess_Matrix->Add_Entries_To_Global_Matrix_Gamma(Base_Matrix_Vector_Hess_Matrix);
        }
