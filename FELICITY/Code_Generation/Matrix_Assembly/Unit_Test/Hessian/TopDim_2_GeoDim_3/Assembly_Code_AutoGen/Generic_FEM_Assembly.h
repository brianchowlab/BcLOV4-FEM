...
public:
    ...
    const Data_Type_Vec_restricted_to_Gamma* Get_Vec_restricted_to_Gamma_ptr() const { return &(Vec_restricted_to_Gamma); }
...
private:
    ...
    Data_Type_Vector_P2_phi_restricted_to_Gamma      Vector_P2_phi_restricted_to_Gamma;
    /*------------   END: Auto Generate ------------*/
    ...
    Data_Type_Vec_restricted_to_Gamma      Vec_restricted_to_Gamma;
    /*------------   END: Auto Generate ------------*/
