...
public:
    ...
    const Data_Type_Vector_P2_phi_restricted_to_Gamma*  Vector_P2_phi_restricted_to_Gamma;
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // pointers for accessing coefficient functions
    const Data_Type_Vec_restricted_to_Gamma*  Vec_restricted_to_Gamma;
    /*------------   END: Auto Generate ------------*/
    ...
    for (unsigned int j = 0; j < COL_NB; j++)
        ...
        for (unsigned int i = j; i < ROW_NB; i++)
            ...
            for (unsigned int qp = 0; qp < NQ; qp++)
                {
                const double  integrand_0 = Vector_P2_phi_restricted_to_Gamma->Func_f_Hess[j][qp].m[0][0]*Vector_P2_phi_restricted_to_Gamma->Func_f_Hess[i][qp].m[0][0]+Vector_P2_phi_restricted_to_Gamma->Func_f_Hess[j][qp].m[0][1]*Vector_P2_phi_restricted_to_Gamma->Func_f_Hess[i][qp].m[0][1]+Vector_P2_phi_restricted_to_Gamma->Func_f_Hess[j][qp].m[0][2]*Vector_P2_phi_restricted_to_Gamma->Func_f_Hess[i][qp].m[0][2]+Vector_P2_phi_restricted_to_Gamma->Func_f_Hess[j][qp].m[1][0]*Vector_P2_phi_restricted_to_Gamma->Func_f_Hess[i][qp].m[1][0]+Vector_P2_phi_restricted_to_Gamma->Func_f_Hess[j][qp].m[1][1]*Vector_P2_phi_restricted_to_Gamma->Func_f_Hess[i][qp].m[1][1]+Vector_P2_phi_restricted_to_Gamma->Func_f_Hess[j][qp].m[1][2]*Vector_P2_phi_restricted_to_Gamma->Func_f_Hess[i][qp].m[1][2]+Vector_P2_phi_restricted_to_Gamma->Func_f_Hess[j][qp].m[2][0]*Vector_P2_phi_restricted_to_Gamma->Func_f_Hess[i][qp].m[2][0]+Vector_P2_phi_restricted_to_Gamma->Func_f_Hess[j][qp].m[2][1]*Vector_P2_phi_restricted_to_Gamma->Func_f_Hess[i][qp].m[2][1]+Vector_P2_phi_restricted_to_Gamma->Func_f_Hess[j][qp].m[2][2]*Vector_P2_phi_restricted_to_Gamma->Func_f_Hess[i][qp].m[2][2];
