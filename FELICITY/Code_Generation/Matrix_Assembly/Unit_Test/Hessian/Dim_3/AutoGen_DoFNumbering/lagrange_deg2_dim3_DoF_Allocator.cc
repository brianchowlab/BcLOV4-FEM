...
#define ELEM_Name        "lagrange_deg2_dim3"
// set allocator class name
#define EDA               lagrange_deg2_dim3_DoF_Allocator
// set nodal topology data type name
#define NODAL_TOPOLOGY    lagrange_deg2_dim3_nodal_top
// set permutation map data type names
#define SINGLE_EDGE_PERM_MAP    lagrange_deg2_dim3_single_edge_perm_map
#define EDGE_DOF_PERMUTATION    lagrange_deg2_dim3_edge_dof_perm
#define SINGLE_FACE_PERM_MAP    lagrange_deg2_dim3_single_face_perm_map
#define FACE_DOF_PERMUTATION    lagrange_deg2_dim3_face_dof_perm
...
struct EDGE_DOF_PERMUTATION
{
    ...
    void Setup_Maps ()
        ...
        // DoF set #1, (current) -6 ---> (init) 1
        perm[0][5][0][0][1].map[1] = 1;

        // DoF set #1, (current) -6 ---> (init) 2
        perm[0][5][0][1][1].map[1] = 1;

        // DoF set #1, (current) -6 ---> (init) 3
        perm[0][5][0][2][1].map[1] = 1;

        // DoF set #1, (current) -6 ---> (init) 4
        perm[0][5][0][3][1].map[1] = 1;

        // DoF set #1, (current) -6 ---> (init) 5
        perm[0][5][0][4][1].map[1] = 1;

        // DoF set #1, (current) -6 ---> (init) 6
        perm[0][5][0][5][1].map[1] = 1;
        ...
        // DoF set #1, (current) -5 ---> (init) 1
        perm[0][4][0][0][1].map[1] = 1;

        // DoF set #1, (current) -5 ---> (init) 2
        perm[0][4][0][1][1].map[1] = 1;

        // DoF set #1, (current) -5 ---> (init) 3
        perm[0][4][0][2][1].map[1] = 1;

        // DoF set #1, (current) -5 ---> (init) 4
        perm[0][4][0][3][1].map[1] = 1;

        // DoF set #1, (current) -5 ---> (init) 5
        perm[0][4][0][4][1].map[1] = 1;

        // DoF set #1, (current) -5 ---> (init) 6
        perm[0][4][0][5][1].map[1] = 1;
        ...
        // DoF set #1, (current) -4 ---> (init) 5
        perm[0][3][0][4][1].map[1] = 1;

        // DoF set #1, (current) -4 ---> (init) 6
        perm[0][3][0][5][1].map[1] = 1;
        ...
        // DoF set #1, (current) -3 ---> (init) 5
        perm[0][2][0][4][1].map[1] = 1;

        // DoF set #1, (current) -3 ---> (init) 6
        perm[0][2][0][5][1].map[1] = 1;
        ...
        // DoF set #1, (current) -2 ---> (init) 5
        perm[0][1][0][4][1].map[1] = 1;

        // DoF set #1, (current) -2 ---> (init) 6
        perm[0][1][0][5][1].map[1] = 1;
        ...
        // DoF set #1, (current) -1 ---> (init) 5
        perm[0][0][0][4][1].map[1] = 1;

        // DoF set #1, (current) -1 ---> (init) 6
        perm[0][0][0][5][1].map[1] = 1;

        // DoF set #1, (current) 1 ---> (init) -6
        perm[0][0][1][5][0].map[1] = 1;

        // DoF set #1, (current) 1 ---> (init) -5
        perm[0][0][1][4][0].map[1] = 1;
        ...
        // DoF set #1, (current) 2 ---> (init) -6
        perm[0][1][1][5][0].map[1] = 1;

        // DoF set #1, (current) 2 ---> (init) -5
        perm[0][1][1][4][0].map[1] = 1;
        ...
        // DoF set #1, (current) 3 ---> (init) -6
        perm[0][2][1][5][0].map[1] = 1;

        // DoF set #1, (current) 3 ---> (init) -5
        perm[0][2][1][4][0].map[1] = 1;
        ...
        // DoF set #1, (current) 4 ---> (init) -6
        perm[0][3][1][5][0].map[1] = 1;

        // DoF set #1, (current) 4 ---> (init) -5
        perm[0][3][1][4][0].map[1] = 1;
        ...
        // DoF set #1, (current) 5 ---> (init) -6
        perm[0][4][1][5][0].map[1] = 1;

        // DoF set #1, (current) 5 ---> (init) -5
        perm[0][4][1][4][0].map[1] = 1;

        // DoF set #1, (current) 5 ---> (init) -4
        perm[0][4][1][3][0].map[1] = 1;

        // DoF set #1, (current) 5 ---> (init) -3
        perm[0][4][1][2][0].map[1] = 1;

        // DoF set #1, (current) 5 ---> (init) -2
        perm[0][4][1][1][0].map[1] = 1;

        // DoF set #1, (current) 5 ---> (init) -1
        perm[0][4][1][0][0].map[1] = 1;
        ...
        // DoF set #1, (current) 6 ---> (init) -6
        perm[0][5][1][5][0].map[1] = 1;

        // DoF set #1, (current) 6 ---> (init) -5
        perm[0][5][1][4][0].map[1] = 1;

        // DoF set #1, (current) 6 ---> (init) -4
        perm[0][5][1][3][0].map[1] = 1;

        // DoF set #1, (current) 6 ---> (init) -3
        perm[0][5][1][2][0].map[1] = 1;

        // DoF set #1, (current) 6 ---> (init) -2
        perm[0][5][1][1][0].map[1] = 1;

        // DoF set #1, (current) 6 ---> (init) -1
        perm[0][5][1][0][0].map[1] = 1;
...
/*------------ BEGIN: Auto Generate ------------*/
    ...
    Node.E[1][1][1] = 5; // Set1, E1
    Node.E[1][2][1] = 6; // Set1, E2
    Node.E[1][3][1] = 7; // Set1, E3
    Node.E[1][4][1] = 8; // Set1, E4
    Node.E[1][5][1] = 9; // Set1, E5
    Node.E[1][6][1] = 10; // Set1, E6
