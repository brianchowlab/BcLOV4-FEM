...
public:
    ...
    MAT_3x3x3 Map_PHI_Hess[1];
    // hessian of the inverse transformation
    MAT_3x3x3 Map_PHI_Hess_Inv_Map[1];
...
MGC::MGC () : Abstract_MESH_GEOMETRY_Class ()
{
    ...
    for (int qp_i = 0; (qp_i < 1); qp_i++)
        Map_PHI_Hess_Inv_Map[qp_i].Set_To_Zero();
}
/***************************************************************************************/
/*------------   END: Auto Generate ------------*/
...
// Number of Quadrature Points = 10
    ...
    {1.43856471934385166E-01, 5.68430584196844446E-01, 1.43856471934385194E-01, 1.43856471934385194E-01}, \
    {5.68430584196844446E-01, 1.43856471934385194E-01, 1.43856471934385194E-01, 1.43856471934385194E-01}, \
    {1.43856471934385166E-01, 1.43856471934385194E-01, 1.43856471934385194E-01, 5.68430584196844446E-01}, \
    {1.43856471934385166E-01, 1.43856471934385194E-01, 5.68430584196844446E-01, 1.43856471934385194E-01}, \
    ...
    // Value of basis function, derivatives = [0  0  2], at quadrature points
    static const double Geo_Basis_Val_0_0_2[NQ][NB] = { \
    ...
    // Value of basis function, derivatives = [0  1  1], at quadrature points
    static const double Geo_Basis_Val_0_1_1[NQ][NB] = { \
    {0.00000000000000000E+00, 0.00000000000000000E+00, 0.00000000000000000E+00, 0.00000000000000000E+00}, \
    {0.00000000000000000E+00, 0.00000000000000000E+00, 0.00000000000000000E+00, 0.00000000000000000E+00}, \
    {0.00000000000000000E+00, 0.00000000000000000E+00, 0.00000000000000000E+00, 0.00000000000000000E+00}, \
    {0.00000000000000000E+00, 0.00000000000000000E+00, 0.00000000000000000E+00, 0.00000000000000000E+00}, \
    ...
    // Value of basis function, derivatives = [1  0  1], at quadrature points
    static const double Geo_Basis_Val_1_0_1[NQ][NB] = { \
    {0.00000000000000000E+00, 0.00000000000000000E+00, 0.00000000000000000E+00, 0.00000000000000000E+00}, \
    {0.00000000000000000E+00, 0.00000000000000000E+00, 0.00000000000000000E+00, 0.00000000000000000E+00}, \
    {0.00000000000000000E+00, 0.00000000000000000E+00, 0.00000000000000000E+00, 0.00000000000000000E+00}, \
    {0.00000000000000000E+00, 0.00000000000000000E+00, 0.00000000000000000E+00, 0.00000000000000000E+00}, \
...
/*------------ BEGIN: Auto Generate ------------*/
    ...
    for (int qp_i = 0; (qp_i < 1); qp_i++)
        {
        // sum over basis functions
        MAT_3x3x3& Map_PHI_Hess_qp_i = Map_PHI_Hess[qp_i];
        Map_PHI_Hess_qp_i.Set_To_Zero(); // map is linear, so hessian is ZERO!
        }
    // compute the hessian of the inverse local map
    // note: indexing is in the C style
    // evaluate at one point
    for (int qp_i = 0; (qp_i < 1); qp_i++)
        {
        // (Grad(PHI)^-1)^t * {-weighted sum of hessian(PHI_k)} * (Grad(PHI)^-1)
        MAT_3x3x3& Map_PHI_Hess_Inv_Map_qp_i = Map_PHI_Hess_Inv_Map[qp_i];
        // the map is linear, so the Hessian of the inverse is ZERO!
        Map_PHI_Hess_Inv_Map_qp_i.Set_To_Zero();
        }
/*------------   END: Auto Generate ------------*/
}
/***************************************************************************************/
