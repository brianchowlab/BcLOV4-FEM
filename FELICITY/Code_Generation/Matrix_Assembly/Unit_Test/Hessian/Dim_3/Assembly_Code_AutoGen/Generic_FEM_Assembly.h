...
public:
    ...
    const Data_Type_Vec_restricted_to_Omega* Get_Vec_restricted_to_Omega_ptr() const { return &(Vec_restricted_to_Omega); }
...
private:
    ...
    Data_Type_Vec_restricted_to_Omega      Vec_restricted_to_Omega;
    /*------------   END: Auto Generate ------------*/
