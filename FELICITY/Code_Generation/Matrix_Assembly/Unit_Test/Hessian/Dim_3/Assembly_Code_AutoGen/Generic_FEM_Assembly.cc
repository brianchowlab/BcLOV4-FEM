...
void GFA::Setup_Data(const mxArray *prhs[]) // input from MATLAB
{
    ...
    Vec_restricted_to_Omega.Setup_Function_Space(prhs[PRHS_Vec_Values], &Vector_P2_phi_restricted_to_Omega);
    /*------------   END: Auto Generate ------------*/
    ...
    Base_Matrix_Vector_Hess_Matrix = new Base_Vector_Hess_Matrix_Data_Type(&Vector_P2_phi_restricted_to_Omega, &Vector_P2_phi_restricted_to_Omega);
    /*------------   END: Auto Generate ------------*/
    ...
    Base_Matrix_Small_Matrix->Vector_P2_phi_restricted_to_Omega = &Vector_P2_phi_restricted_to_Omega;
    Base_Matrix_Small_Matrix->Vec_restricted_to_Omega = &Vec_restricted_to_Omega;
    Base_Matrix_Vector_Hess_Matrix->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Base_Matrix_Vector_Hess_Matrix->Vector_P2_phi_restricted_to_Omega = &Vector_P2_phi_restricted_to_Omega;
    Base_Matrix_Vector_Hess_Matrix->Vec_restricted_to_Omega = &Vec_restricted_to_Omega;
    /*------------   END: Auto Generate ------------*/
...
void GFA::Assemble_Matrices ()
{
    ...
    for (std::vector<unsigned int>::iterator DoI_Ind = Domain_Omega_embedded_in_Omega_restricted_to_Omega.Sub_Assem_List.begin();
        ...
        Vec_restricted_to_Omega.Compute_Func();
        ...
        Base_Matrix_Vector_Hess_Matrix->Tabulate_Tensor(geom_Omega_embedded_in_Omega_restricted_to_Omega);
        ...
        Block_Assemble_Matrix_Vector_Hess_Matrix->Add_Entries_To_Global_Matrix_Omega(Base_Matrix_Vector_Hess_Matrix);
        }
