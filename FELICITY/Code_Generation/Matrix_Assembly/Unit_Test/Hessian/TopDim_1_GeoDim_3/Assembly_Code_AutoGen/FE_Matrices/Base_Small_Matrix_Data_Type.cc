...
// FE matrix is:
//
// \int_{Sigma}  Sca_v1_t1_hess11 + Sca_v1_t1_hess22 + Sca_v1_t1_hess33,  ... etc... (see individual submatrices, i.e. Tab_Tensor routines.)
//
/*------------   END: Auto Generate ------------*/
...
void SpecificFEM::Tabulate_Tensor(const CLASS_geom_Sigma_embedded_in_Sigma_restricted_to_Sigma& Mesh)
{
    ...
    for (unsigned int qp = 0; qp < NQ; qp++)
        {
        const double  integrand_0 = Sca_restricted_to_Sigma->Func_f_Hess[0][qp].m[0][0]+Sca_restricted_to_Sigma->Func_f_Hess[0][qp].m[1][1]+Sca_restricted_to_Sigma->Func_f_Hess[0][qp].m[2][2];
