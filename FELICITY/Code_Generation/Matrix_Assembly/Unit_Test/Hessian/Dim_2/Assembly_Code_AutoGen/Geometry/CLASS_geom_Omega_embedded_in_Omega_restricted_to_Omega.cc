...
public:
    ...
    MAT_2x2x2 Map_PHI_Hess[1];
    // hessian of the inverse transformation
    MAT_2x2x2 Map_PHI_Hess_Inv_Map[1];
...
// Number of Quadrature Points = 9
    ...
    {4.37525248383383969E-01, 1.24949503233232007E-01, 4.37525248383384024E-01}, \
    {4.37525248383383969E-01, 4.37525248383384024E-01, 1.24949503233232007E-01}, \
    {1.24949503233231951E-01, 4.37525248383384024E-01, 4.37525248383384024E-01}, \
    {3.74774207500880308E-02, 7.97112651860070964E-01, 1.65409927389841005E-01}, \
    {1.65409927389841033E-01, 7.97112651860070964E-01, 3.74774207500880030E-02}, \
    {3.74774207500880308E-02, 1.65409927389841005E-01, 7.97112651860070964E-01}, \
    {7.97112651860070964E-01, 1.65409927389841005E-01, 3.74774207500880030E-02}, \
    {1.65409927389841033E-01, 3.74774207500880030E-02, 7.97112651860070964E-01}, \
    {7.97112651860070964E-01, 3.74774207500880030E-02, 1.65409927389841005E-01}  \
    };
...
/*------------ BEGIN: Auto Generate ------------*/
    ...
    for (int qp_i = 0; (qp_i < 1); qp_i++)
        {
        // sum over basis functions
        MAT_2x2x2& Map_PHI_Hess_qp_i = Map_PHI_Hess[qp_i];
    ...
    for (int qp_i = 0; (qp_i < 1); qp_i++)
        ...
        MAT_2x2x2& Map_PHI_Hess_Inv_Map_qp_i = Map_PHI_Hess_Inv_Map[qp_i];
