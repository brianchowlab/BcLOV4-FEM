...
private:
    ...
    Base_Bdy_Mass_Data_Type*    Base_Matrix_Bdy_Mass;
    Base_Bdy_Vec_Data_Type*    Base_Matrix_Bdy_Vec;
    Base_Mass_Matrix_Data_Type*    Base_Matrix_Mass_Matrix;
    Base_Small_Matrix_Data_Type*    Base_Matrix_Small_Matrix;
    Base_Vec_Stiffness_Matrix_Data_Type*    Base_Matrix_Vec_Stiffness_Matrix;

    Block_Assemble_Bdy_Mass_Data_Type*    Block_Assemble_Matrix_Bdy_Mass;
    PTR_TO_SPARSE    Sparse_Data_Bdy_Mass;
    Block_Assemble_Bdy_Vec_Data_Type*    Block_Assemble_Matrix_Bdy_Vec;
    ...
    Block_Assemble_Vec_Stiffness_Matrix_Data_Type*    Block_Assemble_Matrix_Vec_Stiffness_Matrix;
