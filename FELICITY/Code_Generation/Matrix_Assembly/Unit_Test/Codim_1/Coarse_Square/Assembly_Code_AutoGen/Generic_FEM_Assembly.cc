...
void GFA::Setup_Data(const mxArray *prhs[]) // input from MATLAB
{
    ...
    Base_Matrix_Bdy_Mass = new Base_Bdy_Mass_Data_Type(&U_Space_phi_restricted_to_Gamma, &M_Space_phi_restricted_to_Gamma);
    Base_Matrix_Bdy_Vec = new Base_Bdy_Vec_Data_Type(&M_Space_phi_restricted_to_Gamma, &Bdy_Vec_Gamma_col_constant_phi);
    ...
    Base_Matrix_Vec_Stiffness_Matrix = new Base_Vec_Stiffness_Matrix_Data_Type(&Vector_P1_phi_restricted_to_Gamma, &Vector_P1_phi_restricted_to_Gamma);
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // pass pointers around
    Base_Matrix_Bdy_Mass->geom_Gamma_embedded_in_Omega_restricted_to_Gamma = &geom_Gamma_embedded_in_Omega_restricted_to_Gamma;
    Base_Matrix_Bdy_Mass->geom_Omega_embedded_in_Omega_restricted_to_Gamma = &geom_Omega_embedded_in_Omega_restricted_to_Gamma;
    Base_Matrix_Bdy_Mass->M_Space_phi_restricted_to_Gamma = &M_Space_phi_restricted_to_Gamma;
    Base_Matrix_Bdy_Mass->U_Space_phi_restricted_to_Gamma = &U_Space_phi_restricted_to_Gamma;
    Base_Matrix_Bdy_Mass->Vector_P1_phi_restricted_to_Gamma = &Vector_P1_phi_restricted_to_Gamma;
    Base_Matrix_Bdy_Mass->old_soln_restricted_to_Gamma = &old_soln_restricted_to_Gamma;
    Base_Matrix_Bdy_Vec->geom_Gamma_embedded_in_Omega_restricted_to_Gamma = &geom_Gamma_embedded_in_Omega_restricted_to_Gamma;
    Base_Matrix_Bdy_Vec->geom_Omega_embedded_in_Omega_restricted_to_Gamma = &geom_Omega_embedded_in_Omega_restricted_to_Gamma;
    Base_Matrix_Bdy_Vec->M_Space_phi_restricted_to_Gamma = &M_Space_phi_restricted_to_Gamma;
    Base_Matrix_Bdy_Vec->U_Space_phi_restricted_to_Gamma = &U_Space_phi_restricted_to_Gamma;
    Base_Matrix_Bdy_Vec->Vector_P1_phi_restricted_to_Gamma = &Vector_P1_phi_restricted_to_Gamma;
    Base_Matrix_Bdy_Vec->old_soln_restricted_to_Gamma = &old_soln_restricted_to_Gamma;
    Base_Matrix_Mass_Matrix->geom_Gamma_embedded_in_Omega_restricted_to_Gamma = &geom_Gamma_embedded_in_Omega_restricted_to_Gamma;
    Base_Matrix_Mass_Matrix->geom_Omega_embedded_in_Omega_restricted_to_Gamma = &geom_Omega_embedded_in_Omega_restricted_to_Gamma;
    ...
    Base_Matrix_Small_Matrix->geom_Gamma_embedded_in_Omega_restricted_to_Gamma = &geom_Gamma_embedded_in_Omega_restricted_to_Gamma;
    Base_Matrix_Small_Matrix->geom_Omega_embedded_in_Omega_restricted_to_Gamma = &geom_Omega_embedded_in_Omega_restricted_to_Gamma;
    Base_Matrix_Small_Matrix->M_Space_phi_restricted_to_Gamma = &M_Space_phi_restricted_to_Gamma;
    Base_Matrix_Small_Matrix->U_Space_phi_restricted_to_Gamma = &U_Space_phi_restricted_to_Gamma;
    ...
    Base_Matrix_Vec_Stiffness_Matrix->geom_Gamma_embedded_in_Omega_restricted_to_Gamma = &geom_Gamma_embedded_in_Omega_restricted_to_Gamma;
    Base_Matrix_Vec_Stiffness_Matrix->geom_Omega_embedded_in_Omega_restricted_to_Gamma = &geom_Omega_embedded_in_Omega_restricted_to_Gamma;
    Base_Matrix_Vec_Stiffness_Matrix->M_Space_phi_restricted_to_Gamma = &M_Space_phi_restricted_to_Gamma;
    Base_Matrix_Vec_Stiffness_Matrix->U_Space_phi_restricted_to_Gamma = &U_Space_phi_restricted_to_Gamma;
    Base_Matrix_Vec_Stiffness_Matrix->Vector_P1_phi_restricted_to_Gamma = &Vector_P1_phi_restricted_to_Gamma;
    Base_Matrix_Vec_Stiffness_Matrix->old_soln_restricted_to_Gamma = &old_soln_restricted_to_Gamma;
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // setup the block matrices to assemble
    Block_Assemble_Matrix_Bdy_Mass = new Block_Assemble_Bdy_Mass_Data_Type(&Sparse_Data_Bdy_Mass, Base_Matrix_Bdy_Mass);
    Block_Assemble_Matrix_Bdy_Vec = new Block_Assemble_Bdy_Vec_Data_Type(&Sparse_Data_Bdy_Vec, Base_Matrix_Bdy_Vec);
    ...
    Block_Assemble_Matrix_Vec_Stiffness_Matrix = new Block_Assemble_Vec_Stiffness_Matrix_Data_Type(&Sparse_Data_Vec_Stiffness_Matrix, Base_Matrix_Vec_Stiffness_Matrix);
    /*------------   END: Auto Generate ------------*/
}
/***************************************************************************************/
...
void GFA::Assemble_Matrices ()
{
    ...
    for (std::vector<unsigned int>::iterator DoI_Ind = Domain_Gamma_embedded_in_Omega_restricted_to_Gamma.Sub_Assem_List.begin();
        ...
        Base_Matrix_Bdy_Mass->Tabulate_Tensor(geom_Gamma_embedded_in_Omega_restricted_to_Gamma);
        Base_Matrix_Bdy_Vec->Tabulate_Tensor(geom_Gamma_embedded_in_Omega_restricted_to_Gamma);
        Base_Matrix_Mass_Matrix->Tabulate_Tensor(geom_Gamma_embedded_in_Omega_restricted_to_Gamma);
        Base_Matrix_Small_Matrix->Tabulate_Tensor(geom_Gamma_embedded_in_Omega_restricted_to_Gamma);
        Base_Matrix_Vec_Stiffness_Matrix->Tabulate_Tensor(geom_Gamma_embedded_in_Omega_restricted_to_Gamma);

        // loop through the block FE matrices to assemble
        Block_Assemble_Matrix_Bdy_Mass->Add_Entries_To_Global_Matrix_Gamma(Base_Matrix_Bdy_Mass);
        Block_Assemble_Matrix_Bdy_Vec->Add_Entries_To_Global_Matrix_Gamma(Base_Matrix_Bdy_Vec);
        ...
        Block_Assemble_Matrix_Vec_Stiffness_Matrix->Add_Entries_To_Global_Matrix_Gamma(Base_Matrix_Vec_Stiffness_Matrix);
        }
...
void GFA::Output_Matrices (mxArray* plhs[])
{
    ...
    Sparse_ptr = Block_Assemble_Matrix_Bdy_Mass->MAT->export_matrix();
    Output_Matrix(0, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_Bdy_Mass->Name), plhs[0]);
    delete(Block_Assemble_Matrix_Bdy_Mass);

    Sparse_ptr = Block_Assemble_Matrix_Bdy_Vec->MAT->export_matrix();
    Output_Matrix(1, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_Bdy_Vec->Name), plhs[0]);
    delete(Block_Assemble_Matrix_Bdy_Vec);
    ...
    Sparse_ptr = Block_Assemble_Matrix_Vec_Stiffness_Matrix->MAT->export_matrix();
    Output_Matrix(4, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_Vec_Stiffness_Matrix->Name), plhs[0]);
    delete(Block_Assemble_Matrix_Vec_Stiffness_Matrix);
