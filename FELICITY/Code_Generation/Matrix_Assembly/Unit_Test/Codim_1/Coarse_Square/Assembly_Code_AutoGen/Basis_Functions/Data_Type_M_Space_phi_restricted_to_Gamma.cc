...
// Number of Quadrature Points = 5
    ...
    phi_d_ds[0][0].Set_Equal_To(-2.81235969187732771E+00);
    phi_d_ds[0][1].Set_Equal_To(-8.12359691877327705E-01);
    phi_d_ds[0][2].Set_Equal_To(3.62471938375465541E+00);
    phi_d_ds[1][0].Set_Equal_To(-2.07693862021136599E+00);
    phi_d_ds[1][1].Set_Equal_To(-7.69386202113662154E-02);
    phi_d_ds[1][2].Set_Equal_To(2.15387724042273243E+00);
    phi_d_ds[2][0].Set_Equal_To(-1.00000000000000000E+00);
    phi_d_ds[2][1].Set_Equal_To(1.00000000000000000E+00);
    phi_d_ds[2][2].Set_Equal_To(0.00000000000000000E+00);
    phi_d_ds[3][0].Set_Equal_To(7.69386202113659934E-02);
    phi_d_ds[3][1].Set_Equal_To(2.07693862021136599E+00);
    phi_d_ds[3][2].Set_Equal_To(-2.15387724042273199E+00);
    phi_d_ds[4][0].Set_Equal_To(8.12359691877327705E-01);
    phi_d_ds[4][1].Set_Equal_To(2.81235969187732771E+00);
    phi_d_ds[4][2].Set_Equal_To(-3.62471938375465541E+00);
