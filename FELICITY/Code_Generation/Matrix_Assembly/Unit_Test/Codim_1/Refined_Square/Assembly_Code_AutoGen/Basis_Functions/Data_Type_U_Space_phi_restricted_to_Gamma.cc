...
// Number of Quadrature Points = 8
    ...
    phi_Grad[6][0].Set_Equal_To(-1.00000000000000000E+00, -1.00000000000000000E+00);
    phi_Grad[6][1].Set_Equal_To(1.00000000000000000E+00, 0.00000000000000000E+00);
    phi_Grad[6][2].Set_Equal_To(0.00000000000000000E+00, 1.00000000000000000E+00);
    phi_Grad[7][0].Set_Equal_To(-1.00000000000000000E+00, -1.00000000000000000E+00);
    phi_Grad[7][1].Set_Equal_To(1.00000000000000000E+00, 0.00000000000000000E+00);
    phi_Grad[7][2].Set_Equal_To(0.00000000000000000E+00, 1.00000000000000000E+00);
...
//     5.06142681451881432E-02, \
//     1.11190517226687172E-01, \
//     1.56853322938943662E-01, \
//     1.81341891689180967E-01, \
//     1.81341891689181106E-01, \
//     1.56853322938943662E-01, \
//     1.11190517226687172E-01, \
...
// Number of Quadrature Points = 8
    ...
    phi_Val[0][1].Set_Equal_To(9.80144928248768088E-01);
    phi_Val[0][2].Set_Equal_To(1.98550717512319119E-02);
    phi_Val[1][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[1][1].Set_Equal_To(8.98333238706813364E-01);
    phi_Val[1][2].Set_Equal_To(1.01666761293186636E-01);
    phi_Val[2][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[2][1].Set_Equal_To(7.62766204958164384E-01);
    phi_Val[2][2].Set_Equal_To(2.37233795041835616E-01);
    phi_Val[3][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[3][1].Set_Equal_To(5.91717321247824946E-01);
    phi_Val[3][2].Set_Equal_To(4.08282678752175054E-01);
    phi_Val[4][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[4][1].Set_Equal_To(4.08282678752174943E-01);
    phi_Val[4][2].Set_Equal_To(5.91717321247825057E-01);
    phi_Val[5][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[5][1].Set_Equal_To(2.37233795041835616E-01);
    phi_Val[5][2].Set_Equal_To(7.62766204958164384E-01);
    phi_Val[6][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[6][1].Set_Equal_To(1.01666761293186525E-01);
    phi_Val[6][2].Set_Equal_To(8.98333238706813475E-01);
    phi_Val[7][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[7][1].Set_Equal_To(1.98550717512320229E-02);
    phi_Val[7][2].Set_Equal_To(9.80144928248767977E-01);
...
// Number of Quadrature Points = 8
    ...
    phi_Val[0][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[0][1].Set_Equal_To(1.98550717512319119E-02);
    phi_Val[0][2].Set_Equal_To(9.80144928248768088E-01);
    phi_Val[1][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[1][1].Set_Equal_To(1.01666761293186636E-01);
    phi_Val[1][2].Set_Equal_To(8.98333238706813364E-01);
    phi_Val[2][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[2][1].Set_Equal_To(2.37233795041835616E-01);
    phi_Val[2][2].Set_Equal_To(7.62766204958164384E-01);
    phi_Val[3][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[3][1].Set_Equal_To(4.08282678752175054E-01);
    phi_Val[3][2].Set_Equal_To(5.91717321247824946E-01);
    phi_Val[4][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[4][1].Set_Equal_To(5.91717321247825057E-01);
    phi_Val[4][2].Set_Equal_To(4.08282678752174943E-01);
    phi_Val[5][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[5][1].Set_Equal_To(7.62766204958164384E-01);
    phi_Val[5][2].Set_Equal_To(2.37233795041835616E-01);
    phi_Val[6][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[6][1].Set_Equal_To(8.98333238706813475E-01);
    phi_Val[6][2].Set_Equal_To(1.01666761293186525E-01);
    phi_Val[7][0].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[7][1].Set_Equal_To(9.80144928248767977E-01);
    phi_Val[7][2].Set_Equal_To(1.98550717512320229E-02);
...
// Number of Quadrature Points = 8
    ...
    phi_Val[0][0].Set_Equal_To(1.98550717512319119E-02);
    phi_Val[0][1].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[0][2].Set_Equal_To(9.80144928248768088E-01);
    phi_Val[1][0].Set_Equal_To(1.01666761293186636E-01);
    phi_Val[1][1].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[1][2].Set_Equal_To(8.98333238706813364E-01);
    phi_Val[2][0].Set_Equal_To(2.37233795041835616E-01);
    phi_Val[2][1].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[2][2].Set_Equal_To(7.62766204958164384E-01);
    phi_Val[3][0].Set_Equal_To(4.08282678752175054E-01);
    phi_Val[3][1].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[3][2].Set_Equal_To(5.91717321247824946E-01);
    phi_Val[4][0].Set_Equal_To(5.91717321247825057E-01);
    phi_Val[4][1].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[4][2].Set_Equal_To(4.08282678752174943E-01);
    phi_Val[5][0].Set_Equal_To(7.62766204958164384E-01);
    phi_Val[5][1].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[5][2].Set_Equal_To(2.37233795041835616E-01);
    phi_Val[6][0].Set_Equal_To(8.98333238706813475E-01);
    phi_Val[6][1].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[6][2].Set_Equal_To(1.01666761293186525E-01);
    phi_Val[7][0].Set_Equal_To(9.80144928248767977E-01);
...
// Number of Quadrature Points = 8
    ...
    phi_Val[0][0].Set_Equal_To(9.80144928248768088E-01);
    phi_Val[0][1].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[0][2].Set_Equal_To(1.98550717512319119E-02);
    phi_Val[1][0].Set_Equal_To(8.98333238706813364E-01);
    phi_Val[1][1].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[1][2].Set_Equal_To(1.01666761293186636E-01);
    phi_Val[2][0].Set_Equal_To(7.62766204958164384E-01);
    phi_Val[2][1].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[2][2].Set_Equal_To(2.37233795041835616E-01);
    phi_Val[3][0].Set_Equal_To(5.91717321247824946E-01);
    phi_Val[3][1].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[3][2].Set_Equal_To(4.08282678752175054E-01);
    phi_Val[4][0].Set_Equal_To(4.08282678752174943E-01);
    phi_Val[4][1].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[4][2].Set_Equal_To(5.91717321247825057E-01);
    phi_Val[5][0].Set_Equal_To(2.37233795041835616E-01);
    phi_Val[5][1].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[5][2].Set_Equal_To(7.62766204958164384E-01);
    phi_Val[6][0].Set_Equal_To(1.01666761293186525E-01);
    phi_Val[6][1].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[6][2].Set_Equal_To(8.98333238706813475E-01);
    phi_Val[7][0].Set_Equal_To(1.98550717512320229E-02);
    phi_Val[7][1].Set_Equal_To(0.00000000000000000E+00);
    phi_Val[7][2].Set_Equal_To(9.80144928248767977E-01);
