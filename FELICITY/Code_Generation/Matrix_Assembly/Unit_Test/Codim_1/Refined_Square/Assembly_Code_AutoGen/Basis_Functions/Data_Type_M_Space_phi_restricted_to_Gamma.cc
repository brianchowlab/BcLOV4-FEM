...
// Number of Quadrature Points = 8
    ...
    phi_d_ds[0][0].Set_Equal_To(-2.92057971299507235E+00);
    phi_d_ds[0][1].Set_Equal_To(-9.20579712995072352E-01);
    phi_d_ds[0][2].Set_Equal_To(3.84115942599014470E+00);
    phi_d_ds[1][0].Set_Equal_To(-2.59333295482725346E+00);
    phi_d_ds[1][1].Set_Equal_To(-5.93332954827253456E-01);
    phi_d_ds[1][2].Set_Equal_To(3.18666590965450691E+00);
    phi_d_ds[2][0].Set_Equal_To(-2.05106481983265754E+00);
    phi_d_ds[2][1].Set_Equal_To(-5.10648198326575375E-02);
    phi_d_ds[2][2].Set_Equal_To(2.10212963966531508E+00);
    phi_d_ds[3][0].Set_Equal_To(-1.36686928499129978E+00);
    phi_d_ds[3][1].Set_Equal_To(6.33130715008700218E-01);
    phi_d_ds[3][2].Set_Equal_To(7.33738569982599564E-01);
    phi_d_ds[4][0].Set_Equal_To(-6.33130715008699774E-01);
    phi_d_ds[4][1].Set_Equal_To(1.36686928499130023E+00);
    phi_d_ds[4][2].Set_Equal_To(-7.33738569982600453E-01);
    phi_d_ds[5][0].Set_Equal_To(5.10648198326575375E-02);
    phi_d_ds[5][1].Set_Equal_To(2.05106481983265754E+00);
    phi_d_ds[5][2].Set_Equal_To(-2.10212963966531508E+00);
    phi_d_ds[6][0].Set_Equal_To(5.93332954827253900E-01);
    phi_d_ds[6][1].Set_Equal_To(2.59333295482725390E+00);
    phi_d_ds[6][2].Set_Equal_To(-3.18666590965450780E+00);
    phi_d_ds[7][0].Set_Equal_To(9.20579712995071908E-01);
    phi_d_ds[7][1].Set_Equal_To(2.92057971299507191E+00);
    phi_d_ds[7][2].Set_Equal_To(-3.84115942599014382E+00);
...
/*------------ BEGIN: Auto Generate ------------*/
    ...
    for (int qp_i = 0; (qp_i < Num_QP); qp_i++)
        ...
        for (int basis_i = 0; (basis_i < Num_Basis); basis_i++)
            {
            Func_f_d_ds[basis_i][qp_i].a = phi_d_ds[qp_i][basis_i].a * Mesh->Map_Inv_Det_Jac[0].a;
            }
        }
/*------------   END: Auto Generate ------------*/
}
...
// Number of Quadrature Points = 8
    ...
    phi_Val[0][0].Set_Equal_To(9.41223232494797446E-01);
    phi_Val[0][1].Set_Equal_To(-1.90666240027387787E-02);
    phi_Val[0][2].Set_Equal_To(7.78433915079413813E-02);
    phi_Val[1][0].Set_Equal_To(7.15671976824131639E-01);
    phi_Val[1][1].Set_Equal_To(-8.09945005894950470E-02);
    phi_Val[1][2].Set_Equal_To(3.65322523765363394E-01);
    phi_Val[2][0].Set_Equal_To(4.00858361894396498E-01);
    phi_Val[2][1].Set_Equal_To(-1.24674048021932285E-01);
    phi_Val[2][2].Set_Equal_To(7.23815686127535773E-01);
    phi_Val[3][0].Set_Equal_To(1.08541455281578395E-01);
    phi_Val[3][1].Set_Equal_To(-7.48931872140714966E-02);
    phi_Val[3][2].Set_Equal_To(9.66351731932493130E-01);
    phi_Val[4][0].Set_Equal_To(-7.48931872140715799E-02);
    phi_Val[4][1].Set_Equal_To(1.08541455281578533E-01);
    phi_Val[4][2].Set_Equal_To(9.66351731932493019E-01);
    phi_Val[5][0].Set_Equal_To(-1.24674048021932285E-01);
    phi_Val[5][1].Set_Equal_To(4.00858361894396498E-01);
    phi_Val[5][2].Set_Equal_To(7.23815686127535773E-01);
    phi_Val[6][0].Set_Equal_To(-8.09945005894949915E-02);
    phi_Val[6][1].Set_Equal_To(7.15671976824131972E-01);
    phi_Val[6][2].Set_Equal_To(3.65322523765363005E-01);
    phi_Val[7][0].Set_Equal_To(-1.90666240027388793E-02);
    phi_Val[7][1].Set_Equal_To(9.41223232494797113E-01);
    phi_Val[7][2].Set_Equal_To(7.78433915079417976E-02);
