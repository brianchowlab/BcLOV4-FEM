...
void GFA::Setup_Data(const mxArray *prhs[]) // input from MATLAB
{
    ...
    Base_Matrix_Bdy_Mass = new Base_Bdy_Mass_Data_Type(&E_Space_phi_restricted_to_Gamma, &M_Space_phi_restricted_to_Gamma);
    Base_Matrix_Bdy_Vec = new Base_Bdy_Vec_Data_Type(&M_Space_phi_restricted_to_Gamma, &Bdy_Vec_Gamma_col_constant_phi);
    Base_Matrix_Mass_Matrix = new Base_Mass_Matrix_Data_Type(&U_Space_phi_restricted_to_Gamma, &M_Space_phi_restricted_to_Gamma);
    /*------------   END: Auto Generate ------------*/
    ...
    Base_Matrix_Bdy_Mass->E_Space_phi_restricted_to_Gamma = &E_Space_phi_restricted_to_Gamma;
    ...
    Base_Matrix_Bdy_Vec->E_Space_phi_restricted_to_Gamma = &E_Space_phi_restricted_to_Gamma;
    ...
    Base_Matrix_Mass_Matrix->E_Space_phi_restricted_to_Gamma = &E_Space_phi_restricted_to_Gamma;
