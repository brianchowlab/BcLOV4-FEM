...
GFA::~GFA ()
{
    ...
    mxFree(Sparse_Data_L2_Grad_Error_Sq.name);
...
void GFA::Setup_Data(const mxArray *prhs[]) // input from MATLAB
{
    ...
    /*------------ BEGIN: Auto Generate ------------*/
    Access_Previous_FEM_Matrix(prhs[PRHS_OLD_FEM], "L2_Error_Sq", 0, Sparse_Data_L2_Error_Sq);
    Access_Previous_FEM_Matrix(prhs[PRHS_OLD_FEM], "L2_Grad_Error_Sq", 1, Sparse_Data_L2_Grad_Error_Sq);
    Access_Previous_FEM_Matrix(prhs[PRHS_OLD_FEM], "Mass_Matrix", 2, Sparse_Data_Mass_Matrix);
    Access_Previous_FEM_Matrix(prhs[PRHS_OLD_FEM], "RHS", 3, Sparse_Data_RHS);
    ...
    L2_Grad_Error_Sq_Omega_col_constant_phi.Num_Comp = 1;
    L2_Grad_Error_Sq_Omega_row_constant_phi.Num_Comp = 1;
    RHS_Omega_col_constant_phi.Num_Comp = 1;
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // setup access to external FE functions
    discrete_soln_restricted_to_Omega.Setup_Function_Space(prhs[PRHS_discrete_soln_Values], &V_h_phi_restricted_to_Omega);
    /*------------   END: Auto Generate ------------*/
    ...
    Base_Matrix_L2_Grad_Error_Sq = new Base_L2_Grad_Error_Sq_Data_Type(&L2_Grad_Error_Sq_Omega_row_constant_phi, &L2_Grad_Error_Sq_Omega_col_constant_phi);
    Base_Matrix_Mass_Matrix = new Base_Mass_Matrix_Data_Type(&V_h_phi_restricted_to_Omega, &V_h_phi_restricted_to_Omega);
    Base_Matrix_RHS = new Base_RHS_Data_Type(&V_h_phi_restricted_to_Omega, &RHS_Omega_col_constant_phi);
    Base_Matrix_Stiff_Matrix = new Base_Stiff_Matrix_Data_Type(&V_h_phi_restricted_to_Omega, &V_h_phi_restricted_to_Omega);
    /*------------   END: Auto Generate ------------*/
    ...
    Base_Matrix_L2_Error_Sq->V_h_phi_restricted_to_Omega = &V_h_phi_restricted_to_Omega;
    Base_Matrix_L2_Error_Sq->discrete_soln_restricted_to_Omega = &discrete_soln_restricted_to_Omega;
    Base_Matrix_L2_Grad_Error_Sq->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Base_Matrix_L2_Grad_Error_Sq->V_h_phi_restricted_to_Omega = &V_h_phi_restricted_to_Omega;
    Base_Matrix_L2_Grad_Error_Sq->discrete_soln_restricted_to_Omega = &discrete_soln_restricted_to_Omega;
    ...
    Base_Matrix_Mass_Matrix->V_h_phi_restricted_to_Omega = &V_h_phi_restricted_to_Omega;
    Base_Matrix_Mass_Matrix->discrete_soln_restricted_to_Omega = &discrete_soln_restricted_to_Omega;
    Base_Matrix_RHS->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Base_Matrix_RHS->V_h_phi_restricted_to_Omega = &V_h_phi_restricted_to_Omega;
    Base_Matrix_RHS->discrete_soln_restricted_to_Omega = &discrete_soln_restricted_to_Omega;
    ...
    Base_Matrix_Stiff_Matrix->V_h_phi_restricted_to_Omega = &V_h_phi_restricted_to_Omega;
    Base_Matrix_Stiff_Matrix->discrete_soln_restricted_to_Omega = &discrete_soln_restricted_to_Omega;
    /*------------   END: Auto Generate ------------*/
    ...
    Block_Assemble_Matrix_L2_Grad_Error_Sq = new Block_Assemble_L2_Grad_Error_Sq_Data_Type(&Sparse_Data_L2_Grad_Error_Sq, Base_Matrix_L2_Grad_Error_Sq);
...
void GFA::Assemble_Matrices ()
{
    ...
    for (std::vector<unsigned int>::iterator DoI_Ind = Domain_Omega_embedded_in_Omega_restricted_to_Omega.Sub_Assem_List.begin();
        ...
        discrete_soln_restricted_to_Omega.Compute_Func();
        ...
        Base_Matrix_L2_Grad_Error_Sq->Tabulate_Tensor(geom_Omega_embedded_in_Omega_restricted_to_Omega);
        Base_Matrix_Mass_Matrix->Tabulate_Tensor(geom_Omega_embedded_in_Omega_restricted_to_Omega);
        Base_Matrix_RHS->Tabulate_Tensor(geom_Omega_embedded_in_Omega_restricted_to_Omega);
        ...
        Block_Assemble_Matrix_L2_Grad_Error_Sq->Add_Entries_To_Global_Matrix_Omega(Base_Matrix_L2_Grad_Error_Sq);
...
void GFA::Output_Matrices (mxArray* plhs[])
{
    ...
    Output_Matrix(0, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_L2_Error_Sq->Name), plhs[0]);
    delete(Block_Assemble_Matrix_L2_Error_Sq);

    Sparse_ptr = Block_Assemble_Matrix_L2_Grad_Error_Sq->MAT->export_matrix();
    Output_Matrix(1, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_L2_Grad_Error_Sq->Name), plhs[0]);
    delete(Block_Assemble_Matrix_L2_Grad_Error_Sq);
    ...
    Output_Matrix(3, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_RHS->Name), plhs[0]);
