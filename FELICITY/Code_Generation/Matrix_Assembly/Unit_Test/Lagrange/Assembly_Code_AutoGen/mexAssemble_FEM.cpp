...
#define PRHS_V_h_DoFmap                                                        5
#define PRHS_discrete_soln_Values                                              6
#define PRHS_Subset_Elem_Indices                                               7
/*------------   END: Auto Generate ------------*/
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if ( (nrhs < 7) || (nrhs > 8) )
        ...
        mexPrintf("      EMPTY_1                                                           3 \n");
        mexPrintf("      EMPTY_2                                                           4 \n");
        mexPrintf("      V_h_DoFmap                                                        5 \n");
        mexPrintf("      discrete_soln_Values                                              6 \n");
        mexPrintf("      (optional) subset of element indices (array of structs):          7\n");
