...
public:
    ...
    const Data_Type_discrete_soln_restricted_to_Omega* Get_discrete_soln_restricted_to_Omega_ptr() const { return &(discrete_soln_restricted_to_Omega); }
...
private:
    ...
    Base_L2_Grad_Error_Sq_Data_Type*    Base_Matrix_L2_Grad_Error_Sq;
    ...
    Block_Assemble_L2_Grad_Error_Sq_Data_Type*    Block_Assemble_Matrix_L2_Grad_Error_Sq;
    PTR_TO_SPARSE    Sparse_Data_L2_Grad_Error_Sq;
    ...
    Data_Type_CONST_ONE_phi      L2_Grad_Error_Sq_Omega_col_constant_phi;
    Data_Type_CONST_ONE_phi      L2_Grad_Error_Sq_Omega_row_constant_phi;
    Data_Type_CONST_ONE_phi      RHS_Omega_col_constant_phi;
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // create variables for accessing external functions
    Data_Type_discrete_soln_restricted_to_Omega      discrete_soln_restricted_to_Omega;
    /*------------   END: Auto Generate ------------*/
