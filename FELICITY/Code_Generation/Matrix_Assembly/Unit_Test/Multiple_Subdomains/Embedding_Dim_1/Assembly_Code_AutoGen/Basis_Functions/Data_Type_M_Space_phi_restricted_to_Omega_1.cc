...
#define SpecificFUNC        Data_Type_M_Space_phi_restricted_to_Omega_1
#define SpecificFUNC_str   "Data_Type_M_Space_phi_restricted_to_Omega_1"
...
public:
    ...
    const CLASS_geom_Omega_1_embedded_in_Global_restricted_to_Omega_1*  Mesh;
