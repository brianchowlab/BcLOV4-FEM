...
public:
    ...
    void Add_Entries_To_Global_Matrix_Omega_1 (const Base_Stiff_Matrix_Data_Type*);
    void Add_Entries_To_Global_Matrix_Omega_2 (const Base_Stiff_Matrix_Data_Type*);
    /*------------   END: Auto Generate ------------*/
private:
};
...
void SpecificFEM::Add_Entries_To_Global_Matrix_Omega_1(const Base_Stiff_Matrix_Data_Type* Block_00)
{
    ...
    COO_J_IV_Range[2] = 4; // end of range
...
void SpecificFEM::Add_Entries_To_Global_Matrix_Omega_2(const Base_Stiff_Matrix_Data_Type* Block_00)
{
    // get local to global index map for the current ROW element
    int  Row_Indices_0[ROW_NB];
