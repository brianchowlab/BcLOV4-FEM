...
#define SpecificFEM        Block_Assemble_Mixed_Data_Type
...
public:
    ...
    /*------------ BEGIN: Auto Generate ------------*/
    // constructor
    SpecificFEM (const PTR_TO_SPARSE*, const Base_Mixed_Data_Type*);
    ~SpecificFEM (); // destructor
    void Init_Matrix_Assembler_Object(bool);
    void Add_Entries_To_Global_Matrix_Omega_1 (const Base_Mixed_Data_Type*);
    /*------------   END: Auto Generate ------------*/
private:
};
...
SpecificFEM::SpecificFEM (const PTR_TO_SPARSE* Prev_Sparse_Data,
                          const Base_Mixed_Data_Type* Block_00
                          ) :
/*------------   END: Auto Generate ------------*/
...
void SpecificFEM::Add_Entries_To_Global_Matrix_Omega_1(const Base_Mixed_Data_Type* Block_00)
{
    ...
    const int col_elem_index = Block_00->M_Space_phi_restricted_to_Omega_1->Mesh->Domain->Sub_Cell_Index;
    Block_00->M_Space_phi_restricted_to_Omega_1->Get_Local_to_Global_DoFmap(col_elem_index, Col_Indices_0);
