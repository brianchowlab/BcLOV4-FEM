...
#define SpecificFUNC        Data_Type_U_Space_phi_restricted_to_Omega
#define SpecificFUNC_str   "Data_Type_U_Space_phi_restricted_to_Omega"
...
public:
    ...
    const CLASS_geom_Omega_embedded_in_Global_restricted_to_Omega*  Mesh;
