...
#define SpecificFUNC        Data_Type_M_Space_phi_restricted_to_Sigma
#define SpecificFUNC_str   "Data_Type_M_Space_phi_restricted_to_Sigma"
...
public:
    ...
    const CLASS_geom_Gamma_embedded_in_Global_restricted_to_Sigma*  Mesh;
...
/*------------ BEGIN: Auto Generate ------------*/
    ...
    for (int qp_i = 0; (qp_i < Num_QP); qp_i++)
        ...
        for (int basis_i = 0; (basis_i < Num_Basis); basis_i++)
            ...
            Mat_Transpose_Vec(Mesh->Map_PHI_Inv_Metric[0], phi_Grad[qp_i][basis_i], VL);
