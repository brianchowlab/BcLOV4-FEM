...
#define MGC        CLASS_geom_Omega_embedded_in_Global_restricted_to_Sigma
// set the type of map
...
public:
    ...
    const CLASS_Domain_Omega_embedded_in_Global_restricted_to_Sigma*   Domain;
...
void MGC::Compute_Local_Transformation()
{
    ...
    if (DoI_Entity_Index > 0)
        ...
        else if (DoI_Entity_Index==5) Compute_Map_p5(Global_Cell_Index);
        else if (DoI_Entity_Index==6) Compute_Map_p6(Global_Cell_Index);
        ...
        else if (DoI_Entity_Index==-5) Compute_Map_n5(Global_Cell_Index);
        else if (DoI_Entity_Index==-6) Compute_Map_n6(Global_Cell_Index);
        else mexErrMsgTxt("ERROR: DoI_Entity_Index outside valid range or is zero!");
        }
}
/***************************************************************************************/
