...
#define MGC        CLASS_geom_Sigma_embedded_in_Global_restricted_to_Sigma
// set the type of map
...
public:
    ...
    const CLASS_Domain_Sigma_embedded_in_Global_restricted_to_Sigma*   Domain;
...
private:
    ...
    void Compute_Map_p5(const int&);
    void Compute_Map_n5(const int&);
    void Compute_Map_p6(const int&);
    void Compute_Map_n6(const int&);
};
/*------------   END: Auto Generate ------------*/
...
void MGC::Compute_Local_Transformation()
{
    ...
    if (Sub_Entity_Index > 0)
        ...
        else if (Sub_Entity_Index==5) Compute_Map_p5(Global_Cell_Index);
        else if (Sub_Entity_Index==6) Compute_Map_p6(Global_Cell_Index);
        ...
        else if (Sub_Entity_Index==-5) Compute_Map_n5(Global_Cell_Index);
        else if (Sub_Entity_Index==-6) Compute_Map_n6(Global_Cell_Index);
        else mexErrMsgTxt("ERROR: Sub_Entity_Index outside valid range or is zero!");
        }
}
/***************************************************************************************/
...
/* compute the local transformation from the standard reference element
          to an element in the Mesh    */
void MGC::Compute_Map_p5(const int& elem_index)           // current mesh element index
{
Get_Local_to_Global_DoFmap(elem_index, kc);
...
/* compute the local transformation from the standard reference element
          to an element in the Mesh    */
void MGC::Compute_Map_n5(const int& elem_index)           // current mesh element index
{
Get_Local_to_Global_DoFmap(elem_index, kc);
...
/* compute the local transformation from the standard reference element
          to an element in the Mesh    */
void MGC::Compute_Map_p6(const int& elem_index)           // current mesh element index
{
Get_Local_to_Global_DoFmap(elem_index, kc);
...
/* compute the local transformation from the standard reference element
          to an element in the Mesh    */
void MGC::Compute_Map_n6(const int& elem_index)           // current mesh element index
{
Get_Local_to_Global_DoFmap(elem_index, kc);
