...
#define MDC        CLASS_Domain_Omega_embedded_in_Global_restricted_to_Omega_1
...
#define DOMAIN_INTEGRATION_Name  "Omega_1"
...
void MDC::Setup_Data(const mxArray* Subdomain_Array, const mxArray* Global_Mesh_DoFmap, const mxArray* Sublist_Elem_Indices)  // inputs
{
    ...
    const unsigned int DOM_INDEX = Find_Subdomain_Array_Index(Subdomain_Array,"Global","Omega","Omega_1");
...
void MDC::Read_Embed_Data(const unsigned int& doi_elem_index)  // inputs
{
    ...
    Sub_Cell_Index = Data.Sub_Cell_Index[doi_elem_index] - 1; // put into C-style
}
/***************************************************************************************/
/*------------   END: Auto Generate ------------*/
