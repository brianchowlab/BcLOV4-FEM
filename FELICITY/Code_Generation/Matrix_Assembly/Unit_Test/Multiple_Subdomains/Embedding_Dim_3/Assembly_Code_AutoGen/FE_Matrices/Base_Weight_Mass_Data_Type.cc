...
// FE matrix is:
//
// \int_{Omega_1}  u_v1_t1*v_v1_t1 + 
// \int_{Omega_2}  2*u_v1_t1*v_v1_t1
//
/*------------   END: Auto Generate ------------*/

/*------------ BEGIN: Auto Generate ------------*/
// define the name of the FEM matrix (should be the same as the filename of this file)
#define SpecificFEM        Base_Weight_Mass_Data_Type
...
public:
    ...
    /*------------ BEGIN: Auto Generate ------------*/
    void Tabulate_Tensor(const CLASS_geom_Omega_1_embedded_in_Global_restricted_to_Omega_1&);
    void Tabulate_Tensor(const CLASS_geom_Omega_2_embedded_in_Global_restricted_to_Omega_2&);
    /*------------   END: Auto Generate ------------*/
private:
};
...
void SpecificFEM::Tabulate_Tensor(const CLASS_geom_Omega_1_embedded_in_Global_restricted_to_Omega_1& Mesh)
{
    ...
    for (unsigned int j = 0; j < COL_NB; j++)
        ...
        for (unsigned int i = j; i < ROW_NB; i++)
            ...
            for (unsigned int qp = 0; qp < NQ; qp++)
                {
                const double  integrand_0 = (*U_Space_phi_restricted_to_Omega_1->Func_f_Value)[j][qp].a*(*U_Space_phi_restricted_to_Omega_1->Func_f_Value)[i][qp].a;
