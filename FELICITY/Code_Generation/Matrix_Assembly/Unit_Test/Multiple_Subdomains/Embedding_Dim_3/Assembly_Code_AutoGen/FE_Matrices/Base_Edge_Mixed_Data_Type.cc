...
// FE matrix is:
//
// \int_{Sigma}  lambda_v1_t1_grad1*q_v1_t1_grad1 + lambda_v1_t1_grad2*q_v1_t1_grad2 + lambda_v1_t1_grad3*q_v1_t1_grad3
//
/*------------   END: Auto Generate ------------*/

/*------------ BEGIN: Auto Generate ------------*/
// define the name of the FEM matrix (should be the same as the filename of this file)
#define SpecificFEM        Base_Edge_Mixed_Data_Type
#define SpecificFEM_str   "Edge_Mixed"
...
public:
    ...
    /*------------ BEGIN: Auto Generate ------------*/
    void Tabulate_Tensor(const CLASS_geom_Sigma_embedded_in_Global_restricted_to_Sigma&);
    /*------------   END: Auto Generate ------------*/
private:
};
