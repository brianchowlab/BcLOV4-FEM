...
// FE matrix is:
//
// \int_{Gamma}  p_v1_t1_grad1*v_v1_t1_grad1 + p_v1_t1_grad2*v_v1_t1_grad2 + p_v1_t1_grad3*v_v1_t1_grad3
//
/*------------   END: Auto Generate ------------*/

/*------------ BEGIN: Auto Generate ------------*/
// define the name of the FEM matrix (should be the same as the filename of this file)
#define SpecificFEM        Base_Bdy_Mixed_Data_Type
#define SpecificFEM_str   "Bdy_Mixed"
...
public:
    ...
    const CLASS_geom_Gamma_embedded_in_Global_restricted_to_Gamma*  geom_Gamma_embedded_in_Global_restricted_to_Gamma;
    const CLASS_geom_Gamma_embedded_in_Global_restricted_to_Sigma*  geom_Gamma_embedded_in_Global_restricted_to_Sigma;
    const CLASS_geom_Omega_1_embedded_in_Global_restricted_to_Omega_1*  geom_Omega_1_embedded_in_Global_restricted_to_Omega_1;
    const CLASS_geom_Omega_2_embedded_in_Global_restricted_to_Omega_2*  geom_Omega_2_embedded_in_Global_restricted_to_Omega_2;
    const CLASS_geom_Omega_embedded_in_Global_restricted_to_Gamma*  geom_Omega_embedded_in_Global_restricted_to_Gamma;
    const CLASS_geom_Omega_embedded_in_Global_restricted_to_Omega*  geom_Omega_embedded_in_Global_restricted_to_Omega;
    const CLASS_geom_Omega_embedded_in_Global_restricted_to_Omega_1*  geom_Omega_embedded_in_Global_restricted_to_Omega_1;
    const CLASS_geom_Omega_embedded_in_Global_restricted_to_Omega_2*  geom_Omega_embedded_in_Global_restricted_to_Omega_2;
    const CLASS_geom_Omega_embedded_in_Global_restricted_to_Sigma*  geom_Omega_embedded_in_Global_restricted_to_Sigma;
    const CLASS_geom_Sigma_embedded_in_Global_restricted_to_Sigma*  geom_Sigma_embedded_in_Global_restricted_to_Sigma;
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // pointers for accessing FE basis functions
    const Data_Type_E_Space_phi_restricted_to_Sigma*  E_Space_phi_restricted_to_Sigma;
    const Data_Type_M_Space_phi_restricted_to_Gamma*  M_Space_phi_restricted_to_Gamma;
    const Data_Type_M_Space_phi_restricted_to_Sigma*  M_Space_phi_restricted_to_Sigma;
    const Data_Type_U_Space_phi_restricted_to_Gamma*  U_Space_phi_restricted_to_Gamma;
    const Data_Type_U_Space_phi_restricted_to_Omega*  U_Space_phi_restricted_to_Omega;
    const Data_Type_U_Space_phi_restricted_to_Omega_1*  U_Space_phi_restricted_to_Omega_1;
    const Data_Type_U_Space_phi_restricted_to_Omega_2*  U_Space_phi_restricted_to_Omega_2;
    const Data_Type_U_Space_phi_restricted_to_Sigma*  U_Space_phi_restricted_to_Sigma;
    /*------------   END: Auto Generate ------------*/
    ...
    /*------------ BEGIN: Auto Generate ------------*/
    void Tabulate_Tensor(const CLASS_geom_Gamma_embedded_in_Global_restricted_to_Gamma&);
    /*------------   END: Auto Generate ------------*/
private:
};
    ...
    for (unsigned int j = 0; j < COL_NB; j++)
        ...
        for (unsigned int i = 0; i < ROW_NB; i++)
            ...
            for (unsigned int qp = 0; qp < NQ; qp++)
                {
                const double  integrand_0 = M_Space_phi_restricted_to_Gamma->Func_f_Grad[j][qp].v[0]*U_Space_phi_restricted_to_Gamma->Func_f_Grad[i][qp].v[0]+M_Space_phi_restricted_to_Gamma->Func_f_Grad[j][qp].v[1]*U_Space_phi_restricted_to_Gamma->Func_f_Grad[i][qp].v[1]+M_Space_phi_restricted_to_Gamma->Func_f_Grad[j][qp].v[2]*U_Space_phi_restricted_to_Gamma->Func_f_Grad[i][qp].v[2];
