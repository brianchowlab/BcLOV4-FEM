...
public:
    ...
    /*------------ BEGIN: Auto Generate ------------*/
    void Tabulate_Tensor(const CLASS_geom_Omega_embedded_in_Global_restricted_to_Omega&);
    /*------------   END: Auto Generate ------------*/
private:
};
...
void SpecificFEM::Tabulate_Tensor(const CLASS_geom_Omega_embedded_in_Global_restricted_to_Omega& Mesh)
{
    ...
    for (unsigned int j = 0; j < COL_NB; j++)
        ...
        for (unsigned int i = j; i < ROW_NB; i++)
            ...
            for (unsigned int qp = 0; qp < NQ; qp++)
                {
                const double  integrand_0 = U_Space_phi_restricted_to_Omega->Func_f_Grad[j][qp].v[0]*U_Space_phi_restricted_to_Omega->Func_f_Grad[i][qp].v[0]+U_Space_phi_restricted_to_Omega->Func_f_Grad[j][qp].v[1]*U_Space_phi_restricted_to_Omega->Func_f_Grad[i][qp].v[1]+U_Space_phi_restricted_to_Omega->Func_f_Grad[j][qp].v[2]*U_Space_phi_restricted_to_Omega->Func_f_Grad[i][qp].v[2];
