...
#define SpecificFUNC        Data_Type_V_Space_phi_restricted_to_Sigma
#define SpecificFUNC_str   "Data_Type_V_Space_phi_restricted_to_Sigma"

// set the type of function space
#define SPACE_type  "CG - lagrange_deg1_dim1"
// set the name of function space
#define SPACE_name  "V_Space"
...
public:
    ...
    const CLASS_geom_Sigma_embedded_in_Gamma_restricted_to_Sigma*  Mesh;
