...
#define SpecificFUNC        Data_Type_V1_Space_phi_restricted_to_Gamma
#define SpecificFUNC_str   "Data_Type_V1_Space_phi_restricted_to_Gamma"

// set the type of function space
#define SPACE_type  "CG - lagrange_deg1_dim2"
// set the name of function space
#define SPACE_name  "V1_Space"
...
public:
    ...
    const CLASS_geom_Omega_1_embedded_in_Global_restricted_to_Gamma*  Mesh;
