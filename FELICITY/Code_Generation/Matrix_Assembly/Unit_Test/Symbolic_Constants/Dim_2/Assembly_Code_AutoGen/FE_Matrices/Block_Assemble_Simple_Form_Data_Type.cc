...
public:
    ...
    void Add_Entries_To_Global_Matrix_Omega (const Base_Simple_Form_Data_Type*);
    /*------------   END: Auto Generate ------------*/
private:
};
...
void SpecificFEM::Add_Entries_To_Global_Matrix_Omega(const Base_Simple_Form_Data_Type* Block_00)
{
    ...
    COO_J_IV_Range[2] = 2; // end of range
