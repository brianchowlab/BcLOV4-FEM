...
#define SpecificFEM        Block_Assemble_Mixed_Form_B_Data_Type
#define SpecificFEM_str   "Mixed_Form_B"
...
public:
    ...
    /*------------ BEGIN: Auto Generate ------------*/
    // constructor
    SpecificFEM (const PTR_TO_SPARSE*, const Base_Mixed_Form_B_Data_Type*);
    ~SpecificFEM (); // destructor
    void Init_Matrix_Assembler_Object(bool);
    void Add_Entries_To_Global_Matrix_Omega (const Base_Mixed_Form_B_Data_Type*);
    /*------------   END: Auto Generate ------------*/
private:
};
...
SpecificFEM::SpecificFEM (const PTR_TO_SPARSE* Prev_Sparse_Data,
                          const Base_Mixed_Form_B_Data_Type* Block_00
                          ) :
/*------------   END: Auto Generate ------------*/
...
void SpecificFEM::Add_Entries_To_Global_Matrix_Omega(const Base_Mixed_Form_B_Data_Type* Block_00)
{
    ...
    COO_J_IV_Range[3] = 3;
    COO_V[3] = Block_00->FE_Tensor_0[Local_Col_Ind[0]*ROW_NB + Local_Row_Ind[0]];
    ...
    // actually:  copy Block_00->FE_Tensor_0 to Block_00->FE_Tensor_1
    // write the data directly
    COO_I[5] = Row_Indices_0[Local_Row_Ind[0]] + Block_00->Row_Shift[1];
    COO_J[5] = Col_Indices_0[Local_Col_Ind[2]] + Block_00->Col_Shift[1];
    COO_J_IV_Range[5] = 5;
    COO_V[5] = Block_00->FE_Tensor_0[Local_Col_Ind[2]*ROW_NB + Local_Row_Ind[0]];
