...
// FE matrix is:
//
// \int_{Omega}  c0_v1_t2*(u_v1_t1_grad1*v_v1_t1_grad1 + u_v1_t1_grad2*v_v1_t1_grad2 + u_v1_t2_grad1*v_v1_t2_grad1 + u_v1_t2_grad2*v_v1_t2_grad2) + c0_v1_t1*u0_v1_t1*u_v1_t1*v_v1_t1 + c0_v1_t1*u0_v1_t1*u_v1_t2*v_v1_t2
//
/*------------   END: Auto Generate ------------*/

/*------------ BEGIN: Auto Generate ------------*/
// define the name of the FEM matrix (should be the same as the filename of this file)
#define SpecificFEM        Base_Elliptic_Form_Data_Type
