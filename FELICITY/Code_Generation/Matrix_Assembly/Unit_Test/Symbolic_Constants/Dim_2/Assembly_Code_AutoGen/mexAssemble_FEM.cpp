...
#define PRHS_Vector_P1_DoFmap                                                  5
#define PRHS_c0_Values                                                         6
#define PRHS_u0_Values                                                         7
#define PRHS_Subset_Elem_Indices                                               8
/*------------   END: Auto Generate ------------*/
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if ( (nrhs < 8) || (nrhs > 9) )
        ...
        mexPrintf("      EMPTY_1                                                           3 \n");
        mexPrintf("      EMPTY_2                                                           4 \n");
        mexPrintf("      Vector_P1_DoFmap                                                  5 \n");
        mexPrintf("      c0_Values                                                         6 \n");
        mexPrintf("      u0_Values                                                         7 \n");
        mexPrintf("      (optional) subset of element indices (array of structs):          8\n");
        ...
        mexPrintf("      ---------------------------------------- \n");
        mexPrintf("      Elliptic_Form \n");
        mexPrintf("      Lin_A \n");
        mexPrintf("      Lin_B \n");
        mexPrintf("      Mixed_Form_A \n");
        mexPrintf("      Mixed_Form_B \n");
        mexPrintf("      Simple_Form \n");
        mexPrintf("\n");
