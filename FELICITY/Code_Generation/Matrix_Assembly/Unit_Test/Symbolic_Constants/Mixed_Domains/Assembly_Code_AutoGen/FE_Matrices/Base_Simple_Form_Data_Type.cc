...
// FE matrix is:
//
// \int_{Gamma}  c0_v1_t1*(a_v1_t1*b_v1_t1 + a_v1_t2*b_v1_t2 + a_v1_t3*b_v1_t3)
//
/*------------   END: Auto Generate ------------*/
...
public:
    ...
    const Data_Type_Const_Space_Omega_TupleSize_3_1_phi_restricted_to_Gamma*  Const_Space_Omega_TupleSize_3_1_phi_restricted_to_Gamma;
    const Data_Type_Const_Space_phi_restricted_to_Gamma*  Const_Space_phi_restricted_to_Gamma;
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // pointers for accessing coefficient functions
    const Data_Type_c0_restricted_to_Gamma*  c0_restricted_to_Gamma;
    /*------------   END: Auto Generate ------------*/
...
void SpecificFEM::Tabulate_Tensor(const CLASS_geom_Gamma_embedded_in_Omega_restricted_to_Gamma& Mesh)
{
    ...
    for (unsigned int qp = 0; qp < NQ; qp++)
        {
        const double  integrand_0 = Const_Space_phi_restricted_to_Gamma->Constant_C_Value.a*Const_Space_phi_restricted_to_Gamma->Constant_C_Value.a*c0_restricted_to_Gamma->Constant_C_Value[0].a;
