...
void GFA::Setup_Data(const mxArray *prhs[]) // input from MATLAB
{
    ...
    Vh_phi_restricted_to_Omega.Setup_Function_Space(prhs[PRHS_Vh_DoFmap]);
    Vh_phi_restricted_to_Omega.Mesh = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    /*------------   END: Auto Generate ------------*/
    ...
    Base_Matrix_Mass_Matrix = new Base_Mass_Matrix_Data_Type(&Vh_phi_restricted_to_Omega, &Vh_phi_restricted_to_Omega);
    Base_Matrix_RHS = new Base_RHS_Data_Type(&Vh_phi_restricted_to_Omega, &RHS_Omega_col_constant_phi);
    Base_Matrix_Stiff_Matrix = new Base_Stiff_Matrix_Data_Type(&Vh_phi_restricted_to_Omega, &Vh_phi_restricted_to_Omega);
    /*------------   END: Auto Generate ------------*/
    ...
    Base_Matrix_Mass_Matrix->Vh_phi_restricted_to_Omega = &Vh_phi_restricted_to_Omega;
    Base_Matrix_RHS->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Base_Matrix_RHS->Vh_phi_restricted_to_Omega = &Vh_phi_restricted_to_Omega;
    ...
    Base_Matrix_Stiff_Matrix->Vh_phi_restricted_to_Omega = &Vh_phi_restricted_to_Omega;
    /*------------   END: Auto Generate ------------*/
...
void GFA::Assemble_Matrices ()
{
    ...
    for (std::vector<unsigned int>::iterator DoI_Ind = Domain_Omega_embedded_in_Omega_restricted_to_Omega.Sub_Assem_List.begin();
        ...
        Vh_phi_restricted_to_Omega.Transform_Basis_Functions();
