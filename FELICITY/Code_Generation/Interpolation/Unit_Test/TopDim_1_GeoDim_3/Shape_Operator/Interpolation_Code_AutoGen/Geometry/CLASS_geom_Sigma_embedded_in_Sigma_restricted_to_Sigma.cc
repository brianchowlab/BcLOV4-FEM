...
/*------------ BEGIN: Auto Generate ------------*/
    ...
    for (int qp_i = 0; (qp_i < Num_QP); qp_i++)
        ...
        // compute kappa * [vt x vt],
        //     where kappa is the scalar curvature, and vt is the tangent vector.
        Outer_Product_Vec(Map_Tangent_Vector[qp_i], Map_Tangent_Vector[qp_i], Map_Shape_Op_qp_i);
        Scalar_Mult_Matrix(Map_Shape_Op_qp_i, Map_Total_Curvature[qp_i], Map_Shape_Op_qp_i);
        }
/*------------   END: Auto Generate ------------*/
}
/***************************************************************************************/
