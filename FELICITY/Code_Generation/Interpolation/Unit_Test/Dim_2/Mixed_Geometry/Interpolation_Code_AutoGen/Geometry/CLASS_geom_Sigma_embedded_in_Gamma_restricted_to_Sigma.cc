...
#define MGC        CLASS_geom_Sigma_embedded_in_Gamma_restricted_to_Sigma
// set the type of map
...
public:
    ...
    const CLASS_Domain_Sigma_embedded_in_Gamma_restricted_to_Sigma*   Domain;
...
// Map has geometric dimension = 3
    ...
    double Geo_Basis_Val_0_0_0[1][NB];
      Geo_Basis_Val_0_0_0[0][0] = 0.0;
      Geo_Basis_Val_0_0_0[0][1] = -x_hat+1.0;
      Geo_Basis_Val_0_0_0[0][2] = x_hat;

    // Value of basis function, derivatives = [1  0  0], at local coordinates
    double Geo_Basis_Val_1_0_0[1][NB];
      Geo_Basis_Val_1_0_0[0][0] = 0.0;
      Geo_Basis_Val_1_0_0[0][1] = -1.0;
      Geo_Basis_Val_1_0_0[0][2] = 1.0;
...
// Map has geometric dimension = 3
    ...
    double Geo_Basis_Val_0_0_0[1][NB];
      ...
      Geo_Basis_Val_0_0_0[0][2] = -x_hat+1.0;
...
// Map has geometric dimension = 3
    ...
    // Value of basis function, derivatives = [0  0  0], at local coordinates
    double Geo_Basis_Val_0_0_0[1][NB];
      Geo_Basis_Val_0_0_0[0][0] = x_hat;
      Geo_Basis_Val_0_0_0[0][1] = 0.0;
      Geo_Basis_Val_0_0_0[0][2] = -x_hat+1.0;

    // Value of basis function, derivatives = [1  0  0], at local coordinates
    double Geo_Basis_Val_1_0_0[1][NB];
      Geo_Basis_Val_1_0_0[0][0] = 1.0;
      Geo_Basis_Val_1_0_0[0][1] = 0.0;
      Geo_Basis_Val_1_0_0[0][2] = -1.0;
...
// Map has geometric dimension = 3
    ...
    // Value of basis function, derivatives = [0  0  0], at local coordinates
    double Geo_Basis_Val_0_0_0[1][NB];
      Geo_Basis_Val_0_0_0[0][0] = -x_hat+1.0;
      Geo_Basis_Val_0_0_0[0][1] = 0.0;
      Geo_Basis_Val_0_0_0[0][2] = x_hat;
