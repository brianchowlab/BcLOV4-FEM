...
#define MGC        CLASS_geom_Gamma_embedded_in_Gamma_restricted_to_Sigma
// set the type of map
...
public:
    ...
    const CLASS_Domain_Gamma_embedded_in_Gamma_restricted_to_Sigma*   Domain;
