...
#define PRHS_Gamma_Mesh_Vertices                                               0
#define PRHS_Gamma_Mesh_DoFmap                                                 1
#define PRHS_EMPTY_1                                                           2
#define PRHS_Gamma_Mesh_Subdomains                                             3
#define PRHS_Sigma_Interp_Data                                                 4
#define PRHS_V_Space_DoFmap                                                    5
#define PRHS_NN_Values                                                         6
/*------------   END: Auto Generate ------------*/
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (nrhs!=7)
        ...
        mexPrintf("      -------------------                                             ----- \n");
        mexPrintf("      Gamma_Mesh_Vertices                                               0 \n");
        mexPrintf("      Gamma_Mesh_DoFmap                                                 1 \n");
        mexPrintf("      EMPTY_1                                                           2 \n");
        mexPrintf("      Gamma_Mesh_Subdomains                                             3 \n");
        mexPrintf("      Sigma_Interp_Data                                                 4 \n");
        mexPrintf("      V_Space_DoFmap                                                    5 \n");
        mexPrintf("      NN_Values                                                         6 \n");
        mexPrintf("\n");
        mexPrintf("      OUTPUTS (in consecutive order) \n");
        mexPrintf("      ---------------------------------------- \n");
        mexPrintf("      I_N \n");
        mexPrintf("      I_N_dot_NN \n");
        mexPrintf("      I_N_dot_T \n");
        mexPrintf("\n");
