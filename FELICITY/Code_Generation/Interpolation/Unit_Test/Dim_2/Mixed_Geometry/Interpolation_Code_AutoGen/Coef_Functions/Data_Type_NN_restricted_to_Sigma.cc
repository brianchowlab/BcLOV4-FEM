...
#define SpecificNAME       "NN"
#define SpecificFUNC        Data_Type_NN_restricted_to_Sigma
#define SpecificFUNC_str   "Data_Type_NN_restricted_to_Sigma"
...
public:
    ...
    const Data_Type_V_Space_phi_restricted_to_Sigma*     basis_func;
    ...
    void Setup_Function_Space(const mxArray*, const Data_Type_V_Space_phi_restricted_to_Sigma*);
    void Compute_Func();
private:
};
/*------------   END: Auto Generate ------------*/
...
void SpecificFUNC::Setup_Function_Space(const mxArray* Values,        // inputs
                                        const Data_Type_V_Space_phi_restricted_to_Sigma*   basis_func_input)          // inputs
{
