...
public:
    ...
    const Data_Type_v_restricted_to_Gamma* Get_v_restricted_to_Gamma_ptr() const { return &(v_restricted_to_Gamma); }
...
private:
    ...
    Data_Type_BDM1_phi_restricted_to_Omega      BDM1_phi_restricted_to_Omega;
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // create variables for accessing external functions
    Data_Type_v_restricted_to_Gamma      v_restricted_to_Gamma;
