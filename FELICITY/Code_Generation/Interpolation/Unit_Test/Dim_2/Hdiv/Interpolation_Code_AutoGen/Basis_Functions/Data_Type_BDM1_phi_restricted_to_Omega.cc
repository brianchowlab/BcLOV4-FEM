...
// geometric dimension = 2
    ...
    phi_Val[0].Set_Equal_To(x_hat*4.0, y_hat*-2.0);
    phi_Val[1].Set_Equal_To(x_hat*-2.0, y_hat*4.0);
    phi_Val[2].Set_Equal_To(x_hat*-2.0-y_hat*6.0+2.0, y_hat*4.0);
    phi_Val[3].Set_Equal_To(x_hat*4.0+y_hat*6.0-4.0, y_hat*-2.0);
    phi_Val[4].Set_Equal_To(x_hat*-2.0, x_hat*6.0+y_hat*4.0-4.0);
    phi_Val[5].Set_Equal_To(x_hat*4.0, x_hat*-6.0-y_hat*2.0+2.0);
