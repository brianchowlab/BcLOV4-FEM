...
// geometric dimension = 2
    ...
    phi_Val[0].Set_Equal_To(x_hat*-4.0+4.0, x_hat*-2.0);
    phi_Val[1].Set_Equal_To(x_hat*2.0-2.0, x_hat*4.0);
    phi_Val[2].Set_Equal_To(x_hat*-4.0, x_hat*4.0);
    phi_Val[3].Set_Equal_To(x_hat*2.0, x_hat*-2.0);
    phi_Val[4].Set_Equal_To(x_hat*2.0-2.0, x_hat*-2.0+2.0);
    phi_Val[5].Set_Equal_To(x_hat*-4.0+4.0, x_hat*4.0-4.0);
...
/*------------ BEGIN: Auto Generate ------------*/
    ...
    for (int qp_i = 0; (qp_i < Num_QP); qp_i++)
        ...
        for (int basis_i = 0; (basis_i < Num_Basis); basis_i++)
            ...
            Scalar_Mult_Vector(phi_Val[basis_i], INV_DET_SIGN_FLIP, vv_temp);
...
// geometric dimension = 2
    ...
    phi_Val[0].Set_Equal_To(x_hat*4.0, x_hat*2.0-2.0);
    phi_Val[1].Set_Equal_To(x_hat*-2.0, x_hat*-4.0+4.0);
    phi_Val[2].Set_Equal_To(x_hat*4.0-4.0, x_hat*-4.0+4.0);
    phi_Val[3].Set_Equal_To(x_hat*-2.0+2.0, x_hat*2.0-2.0);
    phi_Val[4].Set_Equal_To(x_hat*-2.0, x_hat*2.0);
    phi_Val[5].Set_Equal_To(x_hat*4.0, x_hat*-4.0);
...
// geometric dimension = 2
    ...
    phi_Val[0].Set_Equal_To(0.0, x_hat*2.0-2.0);
    phi_Val[1].Set_Equal_To(0.0, x_hat*-4.0+4.0);
    phi_Val[2].Set_Equal_To(x_hat*6.0-4.0, x_hat*-4.0+4.0);
    phi_Val[3].Set_Equal_To(x_hat*-6.0+2.0, x_hat*2.0-2.0);
    phi_Val[4].Set_Equal_To(0.0, x_hat*-4.0);
    phi_Val[5].Set_Equal_To(0.0, x_hat*2.0);
...
// geometric dimension = 2
    ...
    phi_Val[0].Set_Equal_To(0.0, x_hat*-2.0);
    phi_Val[1].Set_Equal_To(0.0, x_hat*4.0);
    phi_Val[2].Set_Equal_To(x_hat*-6.0+2.0, x_hat*4.0);
    phi_Val[3].Set_Equal_To(x_hat*6.0-4.0, x_hat*-2.0);
    phi_Val[4].Set_Equal_To(0.0, x_hat*4.0-4.0);
    phi_Val[5].Set_Equal_To(0.0, x_hat*-2.0+2.0);
...
// geometric dimension = 2
    ...
    phi_Val[0].Set_Equal_To(x_hat*4.0, 0.0);
    phi_Val[1].Set_Equal_To(x_hat*-2.0, 0.0);
    phi_Val[2].Set_Equal_To(x_hat*-2.0+2.0, 0.0);
    phi_Val[3].Set_Equal_To(x_hat*4.0-4.0, 0.0);
    phi_Val[4].Set_Equal_To(x_hat*-2.0, x_hat*6.0-4.0);
    phi_Val[5].Set_Equal_To(x_hat*4.0, x_hat*-6.0+2.0);
...
// geometric dimension = 2
    ...
    phi_Val[0].Set_Equal_To(x_hat*-4.0+4.0, 0.0);
    phi_Val[1].Set_Equal_To(x_hat*2.0-2.0, 0.0);
    phi_Val[2].Set_Equal_To(x_hat*2.0, 0.0);
    phi_Val[3].Set_Equal_To(x_hat*-4.0, 0.0);
    phi_Val[4].Set_Equal_To(x_hat*2.0-2.0, x_hat*-6.0+2.0);
    phi_Val[5].Set_Equal_To(x_hat*-4.0+4.0, x_hat*6.0-4.0);
