...
#define PRHS_Omega_Mesh_Orient                                                 2
#define PRHS_Omega_Mesh_Subdomains                                             3
#define PRHS_Gamma_Interp_Data                                                 4
#define PRHS_Omega_Interp_Data                                                 5
#define PRHS_BDM1_DoFmap                                                       6
#define PRHS_v_Values                                                          7
/*------------   END: Auto Generate ------------*/
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (nrhs!=8)
        ...
        mexPrintf("      Omega_Mesh_Orient                                                 2 \n");
        mexPrintf("      Omega_Mesh_Subdomains                                             3 \n");
        mexPrintf("      Gamma_Interp_Data                                                 4 \n");
        mexPrintf("      Omega_Interp_Data                                                 5 \n");
        mexPrintf("      BDM1_DoFmap                                                       6 \n");
        mexPrintf("      v_Values                                                          7 \n");
        mexPrintf("\n");
        mexPrintf("      OUTPUTS (in consecutive order) \n");
        mexPrintf("      ---------------------------------------- \n");
        mexPrintf("      I_on_Gamma \n");
        mexPrintf("      I_v \n");
        mexPrintf("\n");
