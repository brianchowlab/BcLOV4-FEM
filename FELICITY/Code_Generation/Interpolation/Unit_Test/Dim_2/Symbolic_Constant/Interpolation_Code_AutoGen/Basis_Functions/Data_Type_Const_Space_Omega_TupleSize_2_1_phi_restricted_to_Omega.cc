...
#define SpecificFUNC        Data_Type_Const_Space_Omega_TupleSize_2_1_phi_restricted_to_Omega
#define SpecificFUNC_str   "Data_Type_Const_Space_Omega_TupleSize_2_1_phi_restricted_to_Omega"

// set the type of function space
#define SPACE_type  "constant_one - constant_one"
// set the name of function space
#define SPACE_name  "Const_Space_Omega_TupleSize_2_1"
