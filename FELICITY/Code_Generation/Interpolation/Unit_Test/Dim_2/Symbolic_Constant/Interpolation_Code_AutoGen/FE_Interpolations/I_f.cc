...
//
//    c0_v1_t1*f_v1_t1_grad1 + c0_v1_t2*f_v1_t1_grad2, on Omega.
//
/*------------   END: Auto Generate ------------*/

/*------------ BEGIN: Auto Generate ------------*/
// define the name of the FEM interpolation (should be the same as the filename of this file)
#define SpecificFEM        I_f
#define SpecificFEM_str   "I_f"
...
public:
    ...
    const Data_Type_f_restricted_to_Omega*  f_restricted_to_Omega;
    /*------------   END: Auto Generate ------------*/
