...
#define PT_DATA_TOPDIM_GEODIM_TYPE  PT_DATA_Top3_Geo3
...
public:
    ...
    void Find_Points();
    bool Find_Single_Point(PT_DATA_Top3_Geo3&);
    int  One_Iteration(PT_DATA_Top3_Geo3&);
    /*------------   END: Auto Generate ------------*/
private:
};
