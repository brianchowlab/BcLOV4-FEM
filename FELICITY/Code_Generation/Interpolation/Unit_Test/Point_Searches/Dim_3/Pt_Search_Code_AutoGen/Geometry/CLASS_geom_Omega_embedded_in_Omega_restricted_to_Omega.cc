...
// Map has geometric dimension = 3
    ...
    double Geo_Basis_Val_0_0_0[1][NB];
      Geo_Basis_Val_0_0_0[0][0] = -x_hat-y_hat-z_hat+1.0;
      Geo_Basis_Val_0_0_0[0][1] = x_hat;
      Geo_Basis_Val_0_0_0[0][2] = y_hat;
      Geo_Basis_Val_0_0_0[0][3] = z_hat;

    // Value of basis function, derivatives = [0  0  1], at local coordinates
    double Geo_Basis_Val_0_0_1[1][NB];
      Geo_Basis_Val_0_0_1[0][0] = -1.0;
      Geo_Basis_Val_0_0_1[0][1] = 0.0;
      Geo_Basis_Val_0_0_1[0][2] = 0.0;
      Geo_Basis_Val_0_0_1[0][3] = 1.0;
