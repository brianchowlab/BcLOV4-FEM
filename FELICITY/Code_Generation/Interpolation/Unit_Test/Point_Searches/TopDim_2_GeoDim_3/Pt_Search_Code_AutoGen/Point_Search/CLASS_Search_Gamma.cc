...
#define SpecificSEARCH        CLASS_Search_Gamma
#define SpecificSEARCH_str   "CLASS_Search_Gamma"
...
public:
    ...
    CLASS_Domain_Gamma_embedded_in_Gamma_restricted_to_Gamma*  Domain;
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // access and compute local mesh geometry info
    CLASS_geom_Gamma_embedded_in_Gamma_restricted_to_Gamma*  GeomFunc;
    /*------------   END: Auto Generate ------------*/
