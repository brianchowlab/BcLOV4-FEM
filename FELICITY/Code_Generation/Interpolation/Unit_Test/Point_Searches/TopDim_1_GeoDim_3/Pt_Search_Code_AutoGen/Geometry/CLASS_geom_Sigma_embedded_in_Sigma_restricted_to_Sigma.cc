...
/*------------ BEGIN: Auto Generate ------------*/
    ...
    for (int qp_i = 0; (qp_i < Num_QP); qp_i++)
        ...
        Map_PHI_qp_i.v[0] = Geo_Basis_Val_0_0_0[qp_i][0]*Node_Value[0][kc[0]]+Geo_Basis_Val_0_0_0[qp_i][1]*Node_Value[0][kc[1]];
        Map_PHI_qp_i.v[1] = Geo_Basis_Val_0_0_0[qp_i][0]*Node_Value[1][kc[0]]+Geo_Basis_Val_0_0_0[qp_i][1]*Node_Value[1][kc[1]];
        Map_PHI_qp_i.v[2] = Geo_Basis_Val_0_0_0[qp_i][0]*Node_Value[2][kc[0]]+Geo_Basis_Val_0_0_0[qp_i][1]*Node_Value[2][kc[1]];
        }
    ...
    for (int qp_i = 0; (qp_i < 1); qp_i++)
        ...
        Map_PHI_Grad_qp_i.m[2][0] = Geo_Basis_Val_1_0_0[qp_i][0]*Node_Value[2][kc[0]]+Geo_Basis_Val_1_0_0[qp_i][1]*Node_Value[2][kc[1]];
        }
/*------------   END: Auto Generate ------------*/
}
/***************************************************************************************/
