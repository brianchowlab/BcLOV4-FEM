...
#define SpecificSEARCH        CLASS_Search_Sigma
#define SpecificSEARCH_str   "CLASS_Search_Sigma"
...
#define PT_DATA_TOPDIM_GEODIM_TYPE  PT_DATA_Top1_Geo3
#define VEC_DIM_TYPE  VEC_3x1
#define MAT_DIM_TYPE  MAT_3x1
#define LINEAR_CELL
/*------------   END: Auto Generate ------------*/
...
public:
    ...
    CLASS_Domain_Sigma_embedded_in_Sigma_restricted_to_Sigma*  Domain;
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // access and compute local mesh geometry info
    CLASS_geom_Sigma_embedded_in_Sigma_restricted_to_Sigma*  GeomFunc;
    /*------------   END: Auto Generate ------------*/
    ...
    void Find_Points();
    bool Get_Valid_Neighbor(unsigned int&, const int&,
                            const unsigned int*, const unsigned int&);
    bool Find_Single_Point(PT_DATA_Top1_Geo3&);
    bool Find_Single_Point_Sub_Iter(const VEC_3x1&, unsigned int&,
                                    unsigned int*,  unsigned int&,
                                    Min_On_Cell_Top1&, int&);
    void Compute_Min_On_Interval(const VEC_3x1&, const unsigned int&,
                                 unsigned int*, unsigned int&,
                                 Min_On_Cell_Top1&, int&);
    double Eval_Cost(const VEC_3x1&, const VEC_1x1&);
    void Eval_Cost_And_Gradient(const VEC_3x1&, const VEC_1x1&, SCALAR&, VEC_1x1&);
    void Bisection_And_Cubic_Line_Search(const VEC_3x1&, const unsigned int&,
                                         const double&, Min_On_Cell_Top1&, Min_On_Cell_Top1&);
    /*------------   END: Auto Generate ------------*/
private:
};
