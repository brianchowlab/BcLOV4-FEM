...
#define PT_DATA_TOPDIM_GEODIM_TYPE  PT_DATA_Top1_Geo2
#define VEC_DIM_TYPE  VEC_2x1
#define MAT_DIM_TYPE  MAT_2x1
#define LINEAR_CELL
/*------------   END: Auto Generate ------------*/
...
public:
    ...
    bool Find_Single_Point(PT_DATA_Top1_Geo2&);
    bool Find_Single_Point_Sub_Iter(const VEC_2x1&, unsigned int&,
                                    unsigned int*,  unsigned int&,
                                    Min_On_Cell_Top1&, int&);
    void Compute_Min_On_Interval(const VEC_2x1&, const unsigned int&,
                                 unsigned int*, unsigned int&,
                                 Min_On_Cell_Top1&, int&);
    double Eval_Cost(const VEC_2x1&, const VEC_1x1&);
    void Eval_Cost_And_Gradient(const VEC_2x1&, const VEC_1x1&, SCALAR&, VEC_1x1&);
    void Bisection_And_Cubic_Line_Search(const VEC_2x1&, const unsigned int&,
