...
public:
    ...
    const Data_Type_Displace_restricted_to_Sigma* Get_Displace_restricted_to_Sigma_ptr() const { return &(Displace_restricted_to_Sigma); }
...
private:
    ...
    CLASS_Domain_Omega_embedded_in_Omega_restricted_to_Sigma    Domain_Omega_embedded_in_Omega_restricted_to_Sigma;
    CLASS_Domain_Sigma_embedded_in_Omega_restricted_to_Sigma    Domain_Sigma_embedded_in_Omega_restricted_to_Sigma;
    ...
    CLASS_geom_Omega_embedded_in_Omega_restricted_to_Sigma   geom_Omega_embedded_in_Omega_restricted_to_Sigma;
    CLASS_geom_Sigma_embedded_in_Omega_restricted_to_Sigma   geom_Sigma_embedded_in_Omega_restricted_to_Sigma;
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // pointers to each specific FEM matrix
    Base_Eval_Matrix_Data_Type*    Base_Matrix_Eval_Matrix;
    Base_Mass_Matrix_Data_Type*    Base_Matrix_Mass_Matrix;
    Base_Stiff_Matrix_Data_Type*    Base_Matrix_Stiff_Matrix;

    Block_Assemble_Eval_Matrix_Data_Type*    Block_Assemble_Matrix_Eval_Matrix;
    PTR_TO_SPARSE    Sparse_Data_Eval_Matrix;
    ...
    Data_Type_CONST_ONE_phi      Eval_Matrix_Sigma_col_constant_phi;
    Data_Type_CONST_ONE_phi      Eval_Matrix_Sigma_row_constant_phi;
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // create variables for accessing external functions
    Data_Type_Displace_restricted_to_Sigma      Displace_restricted_to_Sigma;
    /*------------   END: Auto Generate ------------*/
