...
// FE matrix is:
//
// \int_{Sigma}  Displace_v1_t1*geomSigma_T1 + Displace_v1_t2*geomSigma_T2 + Displace_v1_t3*geomSigma_T3,  ... etc... (see individual submatrices, i.e. Tab_Tensor routines.)
//
/*------------   END: Auto Generate ------------*/

/*------------ BEGIN: Auto Generate ------------*/
// define the name of the FEM matrix (should be the same as the filename of this file)
#define SpecificFEM        Base_Eval_Matrix_Data_Type
...
public:
    ...
    /*------------ BEGIN: Auto Generate ------------*/
    void Tabulate_Tensor(const CLASS_geom_Sigma_embedded_in_Omega_restricted_to_Sigma&);
    /*------------   END: Auto Generate ------------*/
private:
};
