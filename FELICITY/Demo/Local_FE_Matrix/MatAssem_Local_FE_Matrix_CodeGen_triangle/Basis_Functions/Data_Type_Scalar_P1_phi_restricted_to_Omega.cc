...
// Number of Quadrature Points = 3
    ...
    phi_Val[0][0].Set_Equal_To(1.66666666666666657E-01);
    phi_Val[0][1].Set_Equal_To(6.66666666666666630E-01);
    phi_Val[0][2].Set_Equal_To(1.66666666666666657E-01);
    phi_Val[1][0].Set_Equal_To(1.66666666666666657E-01);
    phi_Val[1][1].Set_Equal_To(1.66666666666666657E-01);
    phi_Val[1][2].Set_Equal_To(6.66666666666666630E-01);
    phi_Val[2][0].Set_Equal_To(6.66666666666666630E-01);
    phi_Val[2][1].Set_Equal_To(1.66666666666666657E-01);
    phi_Val[2][2].Set_Equal_To(1.66666666666666657E-01);
