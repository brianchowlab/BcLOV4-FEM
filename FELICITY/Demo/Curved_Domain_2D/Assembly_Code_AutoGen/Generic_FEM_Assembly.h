...
private:
    ...
    Base_B_neu_Data_Type*    Base_Matrix_B_neu;
    Base_M_Data_Type*    Base_Matrix_M;
    Base_M_Gamma_Data_Type*    Base_Matrix_M_Gamma;

    Block_Assemble_B_neu_Data_Type*    Block_Assemble_Matrix_B_neu;
    PTR_TO_SPARSE    Sparse_Data_B_neu;
    Block_Assemble_M_Data_Type*    Block_Assemble_Matrix_M;
    PTR_TO_SPARSE    Sparse_Data_M;
    Block_Assemble_M_Gamma_Data_Type*    Block_Assemble_Matrix_M_Gamma;
    PTR_TO_SPARSE    Sparse_Data_M_Gamma;
    /*------------   END: Auto Generate ------------*/
    ...
    Data_Type_CONST_ONE_phi      B_neu_Gamma_col_constant_phi;
    /*------------   END: Auto Generate ------------*/
