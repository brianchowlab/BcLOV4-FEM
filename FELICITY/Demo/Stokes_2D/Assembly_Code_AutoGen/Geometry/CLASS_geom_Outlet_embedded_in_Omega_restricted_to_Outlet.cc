...
#define MGC        CLASS_geom_Outlet_embedded_in_Omega_restricted_to_Outlet
// set the type of map
...
public:
    ...
    const CLASS_Domain_Outlet_embedded_in_Omega_restricted_to_Outlet*   Domain;
...
// Number of Quadrature Points = 2
    ...
    {0.00000000000000000E+00, 7.88675134594812866E-01, 2.11324865405187079E-01}, \
    {0.00000000000000000E+00, 2.11324865405187134E-01, 7.88675134594812866E-01}  \
    };
...
// Number of Quadrature Points = 2
    ...
    // Value of basis function, derivatives = [0  0  0], at quadrature points
    static const double Geo_Basis_Val_0_0_0[NQ][NB] = { \
    {0.00000000000000000E+00, 2.11324865405187079E-01, 7.88675134594812866E-01}, \
    {0.00000000000000000E+00, 7.88675134594812866E-01, 2.11324865405187134E-01}  \
    };
...
// Number of Quadrature Points = 2
    ...
    // Value of basis function, derivatives = [0  0  0], at quadrature points
    static const double Geo_Basis_Val_0_0_0[NQ][NB] = { \
    {2.11324865405187079E-01, 0.00000000000000000E+00, 7.88675134594812866E-01}, \
    {7.88675134594812866E-01, 0.00000000000000000E+00, 2.11324865405187134E-01}  \
    };
...
// Number of Quadrature Points = 2
    ...
    // Value of basis function, derivatives = [0  0  0], at quadrature points
    static const double Geo_Basis_Val_0_0_0[NQ][NB] = { \
    {7.88675134594812866E-01, 0.00000000000000000E+00, 2.11324865405187079E-01}, \
    {2.11324865405187134E-01, 0.00000000000000000E+00, 7.88675134594812866E-01}  \
    };
...
// Number of Quadrature Points = 2
    ...
    // Value of basis function, derivatives = [0  0  0], at quadrature points
    static const double Geo_Basis_Val_0_0_0[NQ][NB] = { \
    {7.88675134594812866E-01, 2.11324865405187079E-01, 0.00000000000000000E+00}, \
    {2.11324865405187134E-01, 7.88675134594812866E-01, 0.00000000000000000E+00}  \
    };
...
// Number of Quadrature Points = 2
    ...
    // Value of basis function, derivatives = [0  0  0], at quadrature points
    static const double Geo_Basis_Val_0_0_0[NQ][NB] = { \
    {2.11324865405187079E-01, 7.88675134594812866E-01, 0.00000000000000000E+00}, \
    {7.88675134594812866E-01, 2.11324865405187134E-01, 0.00000000000000000E+00}  \
    };
