...
#define PRHS_Vector_P2_DoFmap                                                  6
#define PRHS_BC_Out_Values                                                     7
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if ( (nrhs < 8) || (nrhs > 9) )
        ...
        mexPrintf("      Vector_P2_DoFmap                                                  6 \n");
        mexPrintf("      BC_Out_Values                                                     7 \n");
        ...
        mexPrintf("      ---------------------------------------- \n");
        mexPrintf("      BC_Matrix \n");
        mexPrintf("      Div_Pressure \n");
        mexPrintf("      Stress_Matrix \n");
        mexPrintf("\n");
