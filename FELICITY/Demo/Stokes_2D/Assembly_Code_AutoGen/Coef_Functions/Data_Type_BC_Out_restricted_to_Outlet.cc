...
#define SpecificNAME       "BC_Out"
#define SpecificFUNC        Data_Type_BC_Out_restricted_to_Outlet
#define SpecificFUNC_str   "Data_Type_BC_Out_restricted_to_Outlet"
...
public:
    ...
    const Data_Type_Vector_P2_phi_restricted_to_Outlet*     basis_func;
    ...
    void Setup_Function_Space(const mxArray*, const Data_Type_Vector_P2_phi_restricted_to_Outlet*);
    void Compute_Func();
private:
};
/*------------   END: Auto Generate ------------*/
...
void SpecificFUNC::Setup_Function_Space(const mxArray* Values,        // inputs
                                        const Data_Type_Vector_P2_phi_restricted_to_Outlet*   basis_func_input)          // inputs
{
