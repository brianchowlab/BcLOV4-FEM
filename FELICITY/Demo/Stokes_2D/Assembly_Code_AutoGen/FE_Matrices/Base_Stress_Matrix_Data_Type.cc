...
// FE matrix is:
//
// \int_{Omega}  vv_v1_t1_grad2*(uu_v1_t1_grad2 + uu_v1_t2_grad1) + vv_v1_t2_grad1*(uu_v1_t1_grad2 + uu_v1_t2_grad1) + 2*uu_v1_t1_grad1*vv_v1_t1_grad1 + 2*uu_v1_t2_grad2*vv_v1_t2_grad2
//
/*------------   END: Auto Generate ------------*/

/*------------ BEGIN: Auto Generate ------------*/
// define the name of the FEM matrix (should be the same as the filename of this file)
#define SpecificFEM        Base_Stress_Matrix_Data_Type
