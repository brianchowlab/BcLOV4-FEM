...
#define SpecificFEM        Block_Assemble_Div_Pressure_Data_Type
#define SpecificFEM_str   "Div_Pressure"
...
public:
    ...
    /*------------ BEGIN: Auto Generate ------------*/
    // constructor
    SpecificFEM (const PTR_TO_SPARSE*, const Base_Div_Pressure_Data_Type*);
    ~SpecificFEM (); // destructor
    void Init_Matrix_Assembler_Object(bool);
    void Add_Entries_To_Global_Matrix_Omega (const Base_Div_Pressure_Data_Type*);
    /*------------   END: Auto Generate ------------*/
private:
};
...
SpecificFEM::SpecificFEM (const PTR_TO_SPARSE* Prev_Sparse_Data,
                          const Base_Div_Pressure_Data_Type* Block_00
                          ) :
/*------------   END: Auto Generate ------------*/
...
void SpecificFEM::Add_Entries_To_Global_Matrix_Omega(const Base_Div_Pressure_Data_Type* Block_00)
{
    // get local to global index map for the current ROW element
    int  Row_Indices_0[ROW_NB];
    const int row_elem_index = Block_00->Scalar_P1_phi_restricted_to_Omega->Mesh->Domain->Sub_Cell_Index;
    Block_00->Scalar_P1_phi_restricted_to_Omega->Get_Local_to_Global_DoFmap(row_elem_index, Row_Indices_0);
    ...
    COO_J_IV_Range[3] = 9;
    COO_V[9] = Block_00->FE_Tensor_0[Local_Col_Ind[3]*ROW_NB + Local_Row_Ind[0]];
    COO_I[10] = Row_Indices_0[Local_Row_Ind[1]];
    COO_V[10] = Block_00->FE_Tensor_0[Local_Col_Ind[3]*ROW_NB + Local_Row_Ind[1]];
    COO_I[11] = Row_Indices_0[Local_Row_Ind[2]];
    COO_V[11] = Block_00->FE_Tensor_0[Local_Col_Ind[3]*ROW_NB + Local_Row_Ind[2]];
    ...
    COO_J_IV_Range[4] = 12;
    COO_V[12] = Block_00->FE_Tensor_0[Local_Col_Ind[4]*ROW_NB + Local_Row_Ind[0]];
    COO_I[13] = Row_Indices_0[Local_Row_Ind[1]];
    COO_V[13] = Block_00->FE_Tensor_0[Local_Col_Ind[4]*ROW_NB + Local_Row_Ind[1]];
    COO_I[14] = Row_Indices_0[Local_Row_Ind[2]];
    COO_V[14] = Block_00->FE_Tensor_0[Local_Col_Ind[4]*ROW_NB + Local_Row_Ind[2]];
    ...
    COO_J_IV_Range[5] = 15;
    COO_V[15] = Block_00->FE_Tensor_0[Local_Col_Ind[5]*ROW_NB + Local_Row_Ind[0]];
    COO_I[16] = Row_Indices_0[Local_Row_Ind[1]];
    COO_V[16] = Block_00->FE_Tensor_0[Local_Col_Ind[5]*ROW_NB + Local_Row_Ind[1]];
    COO_I[17] = Row_Indices_0[Local_Row_Ind[2]];
    COO_V[17] = Block_00->FE_Tensor_0[Local_Col_Ind[5]*ROW_NB + Local_Row_Ind[2]];

    // write column #0
    // write (I,J,V) data for Block_00->FE_Tensor_1, i.e. the (0,1) block
    // write the data directly
    COO_I[18] = Row_Indices_0[Local_Row_Ind[0]];
    COO_J[6] = Col_Indices_0[Local_Col_Ind[0]] + Block_00->Col_Shift[1];
    COO_J_IV_Range[6] = 18;
    COO_V[18] = Block_00->FE_Tensor_1[Local_Col_Ind[0]*ROW_NB + Local_Row_Ind[0]];
    COO_I[19] = Row_Indices_0[Local_Row_Ind[1]];
    COO_V[19] = Block_00->FE_Tensor_1[Local_Col_Ind[0]*ROW_NB + Local_Row_Ind[1]];
    COO_I[20] = Row_Indices_0[Local_Row_Ind[2]];
    COO_V[20] = Block_00->FE_Tensor_1[Local_Col_Ind[0]*ROW_NB + Local_Row_Ind[2]];

    // write column #1
    // write (I,J,V) data for Block_00->FE_Tensor_1, i.e. the (0,1) block
    // write the data directly
    COO_I[21] = Row_Indices_0[Local_Row_Ind[0]];
    COO_J[7] = Col_Indices_0[Local_Col_Ind[1]] + Block_00->Col_Shift[1];
    COO_J_IV_Range[7] = 21;
    COO_V[21] = Block_00->FE_Tensor_1[Local_Col_Ind[1]*ROW_NB + Local_Row_Ind[0]];
    COO_I[22] = Row_Indices_0[Local_Row_Ind[1]];
    COO_V[22] = Block_00->FE_Tensor_1[Local_Col_Ind[1]*ROW_NB + Local_Row_Ind[1]];
    COO_I[23] = Row_Indices_0[Local_Row_Ind[2]];
    COO_V[23] = Block_00->FE_Tensor_1[Local_Col_Ind[1]*ROW_NB + Local_Row_Ind[2]];
    ...
    COO_J_IV_Range[8] = 24;
    COO_V[24] = Block_00->FE_Tensor_1[Local_Col_Ind[2]*ROW_NB + Local_Row_Ind[0]];
    COO_I[25] = Row_Indices_0[Local_Row_Ind[1]];
    COO_V[25] = Block_00->FE_Tensor_1[Local_Col_Ind[2]*ROW_NB + Local_Row_Ind[1]];
    COO_I[26] = Row_Indices_0[Local_Row_Ind[2]];
    COO_V[26] = Block_00->FE_Tensor_1[Local_Col_Ind[2]*ROW_NB + Local_Row_Ind[2]];
    ...
    COO_J_IV_Range[9] = 27;
    COO_V[27] = Block_00->FE_Tensor_1[Local_Col_Ind[3]*ROW_NB + Local_Row_Ind[0]];
    COO_I[28] = Row_Indices_0[Local_Row_Ind[1]];
    COO_V[28] = Block_00->FE_Tensor_1[Local_Col_Ind[3]*ROW_NB + Local_Row_Ind[1]];
    COO_I[29] = Row_Indices_0[Local_Row_Ind[2]];
    COO_V[29] = Block_00->FE_Tensor_1[Local_Col_Ind[3]*ROW_NB + Local_Row_Ind[2]];
    ...
    COO_J_IV_Range[10] = 30;
    COO_V[30] = Block_00->FE_Tensor_1[Local_Col_Ind[4]*ROW_NB + Local_Row_Ind[0]];
    COO_I[31] = Row_Indices_0[Local_Row_Ind[1]];
    COO_V[31] = Block_00->FE_Tensor_1[Local_Col_Ind[4]*ROW_NB + Local_Row_Ind[1]];
    COO_I[32] = Row_Indices_0[Local_Row_Ind[2]];
    COO_V[32] = Block_00->FE_Tensor_1[Local_Col_Ind[4]*ROW_NB + Local_Row_Ind[2]];

    // write column #5
    // write (I,J,V) data for Block_00->FE_Tensor_1, i.e. the (0,1) block
    // write the data directly
    COO_I[33] = Row_Indices_0[Local_Row_Ind[0]];
    COO_J[11] = Col_Indices_0[Local_Col_Ind[5]] + Block_00->Col_Shift[1];
    COO_J_IV_Range[11] = 33;
    COO_V[33] = Block_00->FE_Tensor_1[Local_Col_Ind[5]*ROW_NB + Local_Row_Ind[0]];
    COO_I[34] = Row_Indices_0[Local_Row_Ind[1]];
    COO_V[34] = Block_00->FE_Tensor_1[Local_Col_Ind[5]*ROW_NB + Local_Row_Ind[1]];
    COO_I[35] = Row_Indices_0[Local_Row_Ind[2]];
    COO_V[35] = Block_00->FE_Tensor_1[Local_Col_Ind[5]*ROW_NB + Local_Row_Ind[2]];

    COO_J_IV_Range[12] = 36; // end of range
