...
// Number of Quadrature Points = 4
    ...
    phi_Val[1][0].Set_Equal_To(5.99999999999999978E-01);
    phi_Val[1][1].Set_Equal_To(2.00000000000000011E-01);
    phi_Val[1][2].Set_Equal_To(2.00000000000000011E-01);
    phi_Val[2][0].Set_Equal_To(2.00000000000000011E-01);
    phi_Val[2][1].Set_Equal_To(5.99999999999999978E-01);
    phi_Val[2][2].Set_Equal_To(2.00000000000000011E-01);
    phi_Val[3][0].Set_Equal_To(2.00000000000000011E-01);
    phi_Val[3][1].Set_Equal_To(2.00000000000000011E-01);
    phi_Val[3][2].Set_Equal_To(5.99999999999999978E-01);
