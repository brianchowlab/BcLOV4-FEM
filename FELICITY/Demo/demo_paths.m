...
% addpath(fullfile(MAIN,'Local_FE_Matrix'),'-end');
...
% 
% addpath(fullfile(MAIN,'Curved_Domain_2D'),'-end');
% addpath(fullfile(MAIN,'Laplace_Beltrami_Open_Surface'),'-end');
% addpath(fullfile(MAIN,'EWOD'),'-end');
% 
