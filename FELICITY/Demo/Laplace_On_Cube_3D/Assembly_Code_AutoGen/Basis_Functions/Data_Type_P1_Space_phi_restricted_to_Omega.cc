...
#define SpecificFUNC        Data_Type_P1_Space_phi_restricted_to_Omega
#define SpecificFUNC_str   "Data_Type_P1_Space_phi_restricted_to_Omega"
...
// Number of Quadrature Points = 1
    ...
    phi_Val[0][0].Set_Equal_To(2.50000000000000000E-01);
    phi_Val[0][1].Set_Equal_To(2.50000000000000000E-01);
    phi_Val[0][2].Set_Equal_To(2.50000000000000000E-01);
    phi_Val[0][3].Set_Equal_To(2.50000000000000000E-01);
