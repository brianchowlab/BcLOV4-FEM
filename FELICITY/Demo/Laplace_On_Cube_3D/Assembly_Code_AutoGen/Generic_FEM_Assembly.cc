...
void GFA::Setup_Data(const mxArray *prhs[]) // input from MATLAB
{
    ...
    /*------------ BEGIN: Auto Generate ------------*/
    Access_Previous_FEM_Matrix(prhs[PRHS_OLD_FEM], "Stiff_Matrix", 0, Sparse_Data_Stiff_Matrix);
    /*------------   END: Auto Generate ------------*/
...
void GFA::Output_Matrices (mxArray* plhs[])
{
    ...
    Output_Matrix(0, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_Stiff_Matrix->Name), plhs[0]);
