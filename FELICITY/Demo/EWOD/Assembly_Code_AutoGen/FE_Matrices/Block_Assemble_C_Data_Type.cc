...
#define SpecificFEM        Block_Assemble_C_Data_Type
#define SpecificFEM_str   "C"
...
// the col function space is Type = CG, Name = "brezzi_douglas_marini_deg1_dim2"
...
public:
    ...
    /*------------ BEGIN: Auto Generate ------------*/
    // constructor
    SpecificFEM (const PTR_TO_SPARSE*, const Base_C_Data_Type*);
    ~SpecificFEM (); // destructor
    void Init_Matrix_Assembler_Object(bool);
    void Add_Entries_To_Global_Matrix_Gamma (const Base_C_Data_Type*);
    /*------------   END: Auto Generate ------------*/
private:
};
...
SpecificFEM::SpecificFEM (const PTR_TO_SPARSE* Prev_Sparse_Data,
                          const Base_C_Data_Type* Block_00
                          ) :
/*------------   END: Auto Generate ------------*/
...
void SpecificFEM::Add_Entries_To_Global_Matrix_Gamma(const Base_C_Data_Type* Block_00)
{
    // get local to global index map for the current ROW element
    int  Row_Indices_0[ROW_NB];
    const int row_elem_index = Block_00->M_h_phi_restricted_to_Gamma->Mesh->Domain->Sub_Cell_Index;
    Block_00->M_h_phi_restricted_to_Gamma->Get_Local_to_Global_DoFmap(row_elem_index, Row_Indices_0);
    ...
    const int col_elem_index = Block_00->V_h_phi_restricted_to_Gamma->Mesh->Domain->Sub_Cell_Index;
    Block_00->V_h_phi_restricted_to_Gamma->Get_Local_to_Global_DoFmap(col_elem_index, Col_Indices_0);
    ...
    COO_J_IV_Range[2] = 4;
    COO_V[4] = Block_00->FE_Tensor_0[Local_Col_Ind[2]*ROW_NB + Local_Row_Ind[0]];
    COO_I[5] = Row_Indices_0[Local_Row_Ind[1]];
    COO_V[5] = Block_00->FE_Tensor_0[Local_Col_Ind[2]*ROW_NB + Local_Row_Ind[1]];
    ...
    COO_J_IV_Range[3] = 6;
    COO_V[6] = Block_00->FE_Tensor_0[Local_Col_Ind[3]*ROW_NB + Local_Row_Ind[0]];
    COO_I[7] = Row_Indices_0[Local_Row_Ind[1]];
    COO_V[7] = Block_00->FE_Tensor_0[Local_Col_Ind[3]*ROW_NB + Local_Row_Ind[1]];
    ...
    COO_J_IV_Range[4] = 8;
    COO_V[8] = Block_00->FE_Tensor_0[Local_Col_Ind[4]*ROW_NB + Local_Row_Ind[0]];
    COO_I[9] = Row_Indices_0[Local_Row_Ind[1]];
    COO_V[9] = Block_00->FE_Tensor_0[Local_Col_Ind[4]*ROW_NB + Local_Row_Ind[1]];
    ...
    COO_J_IV_Range[5] = 10;
    COO_V[10] = Block_00->FE_Tensor_0[Local_Col_Ind[5]*ROW_NB + Local_Row_Ind[0]];
    COO_I[11] = Row_Indices_0[Local_Row_Ind[1]];
    COO_V[11] = Block_00->FE_Tensor_0[Local_Col_Ind[5]*ROW_NB + Local_Row_Ind[1]];
