...
#define SpecificFEM        Block_Assemble_D_Data_Type
#define SpecificFEM_str   "D"
...
public:
    ...
    /*------------ BEGIN: Auto Generate ------------*/
    // constructor
    SpecificFEM (const PTR_TO_SPARSE*, const Base_D_Data_Type*);
    ~SpecificFEM (); // destructor
    void Init_Matrix_Assembler_Object(bool);
    void Add_Entries_To_Global_Matrix_Gamma (const Base_D_Data_Type*);
    /*------------   END: Auto Generate ------------*/
private:
};
...
SpecificFEM::SpecificFEM (const PTR_TO_SPARSE* Prev_Sparse_Data,
                          const Base_D_Data_Type* Block_00
                          ) :
/*------------   END: Auto Generate ------------*/
...
void SpecificFEM::Add_Entries_To_Global_Matrix_Gamma(const Base_D_Data_Type* Block_00)
{
    ...
    const int col_elem_index = Block_00->Y_h_phi_restricted_to_Gamma->Mesh->Domain->Sub_Cell_Index;
    Block_00->Y_h_phi_restricted_to_Gamma->Get_Local_to_Global_DoFmap(col_elem_index, Col_Indices_0);
    ...
    COO_J_IV_Range[2] = 4;
    COO_V[4] = Block_00->FE_Tensor_1[Local_Col_Ind[0]*ROW_NB + Local_Row_Ind[0]];
    COO_I[5] = Row_Indices_0[Local_Row_Ind[1]];
    COO_V[5] = Block_00->FE_Tensor_1[Local_Col_Ind[0]*ROW_NB + Local_Row_Ind[1]];
    ...
    COO_J_IV_Range[3] = 6;
    COO_V[6] = Block_00->FE_Tensor_1[Local_Col_Ind[1]*ROW_NB + Local_Row_Ind[0]];
    COO_I[7] = Row_Indices_0[Local_Row_Ind[1]];
    COO_V[7] = Block_00->FE_Tensor_1[Local_Col_Ind[1]*ROW_NB + Local_Row_Ind[1]];

    COO_J_IV_Range[4] = 8; // end of range
