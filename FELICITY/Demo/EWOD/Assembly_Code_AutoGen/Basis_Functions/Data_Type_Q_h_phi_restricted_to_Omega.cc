...
#define SpecificFUNC        Data_Type_Q_h_phi_restricted_to_Omega
#define SpecificFUNC_str   "Data_Type_Q_h_phi_restricted_to_Omega"

// set the type of function space
#define SPACE_type  "DG - lagrange_deg0_dim2"
// set the name of function space
#define SPACE_name  "Q_h"
...
// Number of Quadrature Points = 6
    ...
    phi_Val[0][0].Set_Equal_To(1.00000000000000000E+00);
    phi_Val[1][0].Set_Equal_To(1.00000000000000000E+00);
    phi_Val[2][0].Set_Equal_To(1.00000000000000000E+00);
    phi_Val[3][0].Set_Equal_To(1.00000000000000000E+00);
    phi_Val[4][0].Set_Equal_To(1.00000000000000000E+00);
    phi_Val[5][0].Set_Equal_To(1.00000000000000000E+00);
