...
// FE matrix is:
//
// \int_{Omega}  u_v1_t1_grad1*v_v1_t1_grad1 + u_v1_t1_grad2*v_v1_t1_grad2
//
/*------------   END: Auto Generate ------------*/
...
public:
    ...
    const Data_Type_P1_Space_phi_restricted_to_Gamma*  P1_Space_phi_restricted_to_Gamma;
    const Data_Type_P1_Space_phi_restricted_to_Omega*  P1_Space_phi_restricted_to_Omega;
    /*------------   END: Auto Generate ------------*/
    ...
    for (unsigned int j = 0; j < COL_NB; j++)
        ...
        for (unsigned int i = j; i < ROW_NB; i++)
            ...
            for (unsigned int qp = 0; qp < NQ; qp++)
                {
                const double  integrand_0 = P1_Space_phi_restricted_to_Omega->Func_f_Grad[j][qp].v[0]*P1_Space_phi_restricted_to_Omega->Func_f_Grad[i][qp].v[0]+P1_Space_phi_restricted_to_Omega->Func_f_Grad[j][qp].v[1]*P1_Space_phi_restricted_to_Omega->Func_f_Grad[i][qp].v[1];
