...
{
    // clear it
    mxFree(Sparse_Data_Neumann_Matrix.name);
...
void GFA::Setup_Data(const mxArray *prhs[]) // input from MATLAB
{
    ...
    /*------------ BEGIN: Auto Generate ------------*/
    Access_Previous_FEM_Matrix(prhs[PRHS_OLD_FEM], "Neumann_Matrix", 0, Sparse_Data_Neumann_Matrix);
    Access_Previous_FEM_Matrix(prhs[PRHS_OLD_FEM], "Stiff_Matrix", 1, Sparse_Data_Stiff_Matrix);
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // setup access to FE basis functions
    P1_Space_phi_restricted_to_Gamma.Setup_Function_Space(prhs[PRHS_P1_Space_DoFmap]);
    P1_Space_phi_restricted_to_Gamma.Mesh = &geom_Omega_embedded_in_Omega_restricted_to_Gamma;
    P1_Space_phi_restricted_to_Omega.Setup_Function_Space(prhs[PRHS_P1_Space_DoFmap]);
    P1_Space_phi_restricted_to_Omega.Mesh = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // setup correct number of components for CONSTANT basis functions
    Neumann_Matrix_Gamma_col_constant_phi.Num_Comp = 1;
    /*------------   END: Auto Generate ------------*/
    ...
    Base_Matrix_Neumann_Matrix = new Base_Neumann_Matrix_Data_Type(&P1_Space_phi_restricted_to_Gamma, &Neumann_Matrix_Gamma_col_constant_phi);
    Base_Matrix_Stiff_Matrix = new Base_Stiff_Matrix_Data_Type(&P1_Space_phi_restricted_to_Omega, &P1_Space_phi_restricted_to_Omega);
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // pass pointers around
    Base_Matrix_Neumann_Matrix->geom_Gamma_embedded_in_Omega_restricted_to_Gamma = &geom_Gamma_embedded_in_Omega_restricted_to_Gamma;
    Base_Matrix_Neumann_Matrix->geom_Omega_embedded_in_Omega_restricted_to_Gamma = &geom_Omega_embedded_in_Omega_restricted_to_Gamma;
    Base_Matrix_Neumann_Matrix->geom_Omega_embedded_in_Omega_restricted_to_Omega = &geom_Omega_embedded_in_Omega_restricted_to_Omega;
    Base_Matrix_Neumann_Matrix->P1_Space_phi_restricted_to_Gamma = &P1_Space_phi_restricted_to_Gamma;
    Base_Matrix_Neumann_Matrix->P1_Space_phi_restricted_to_Omega = &P1_Space_phi_restricted_to_Omega;
    Base_Matrix_Stiff_Matrix->geom_Gamma_embedded_in_Omega_restricted_to_Gamma = &geom_Gamma_embedded_in_Omega_restricted_to_Gamma;
    Base_Matrix_Stiff_Matrix->geom_Omega_embedded_in_Omega_restricted_to_Gamma = &geom_Omega_embedded_in_Omega_restricted_to_Gamma;
    ...
    Base_Matrix_Stiff_Matrix->P1_Space_phi_restricted_to_Gamma = &P1_Space_phi_restricted_to_Gamma;
    Base_Matrix_Stiff_Matrix->P1_Space_phi_restricted_to_Omega = &P1_Space_phi_restricted_to_Omega;
    /*------------   END: Auto Generate ------------*/

    /*------------ BEGIN: Auto Generate ------------*/
    // setup the block matrices to assemble
    Block_Assemble_Matrix_Neumann_Matrix = new Block_Assemble_Neumann_Matrix_Data_Type(&Sparse_Data_Neumann_Matrix, Base_Matrix_Neumann_Matrix);
...
void GFA::Assemble_Matrices ()
{
    ...
    for (std::vector<unsigned int>::iterator DoI_Ind = Domain_Gamma_embedded_in_Omega_restricted_to_Gamma.Sub_Assem_List.begin();
        ...
        P1_Space_phi_restricted_to_Gamma.Transform_Basis_Functions();


        // loop through the FE matrices to compute
        Base_Matrix_Neumann_Matrix->Tabulate_Tensor(geom_Gamma_embedded_in_Omega_restricted_to_Gamma);

        // loop through the block FE matrices to assemble
        Block_Assemble_Matrix_Neumann_Matrix->Add_Entries_To_Global_Matrix_Gamma(Base_Matrix_Neumann_Matrix);
        }
    ...
    for (std::vector<unsigned int>::iterator DoI_Ind = Domain_Omega_embedded_in_Omega_restricted_to_Omega.Sub_Assem_List.begin();
        ...
        // perform pre-computations with FE basis functions
        // NOTE: this must come before the external FE coefficient functions
        P1_Space_phi_restricted_to_Omega.Transform_Basis_Functions();
...
void GFA::Output_Matrices (mxArray* plhs[])
{
    ...
    Sparse_ptr = Block_Assemble_Matrix_Neumann_Matrix->MAT->export_matrix();
    Output_Matrix(0, Sparse_ptr, mxCreateString(Block_Assemble_Matrix_Neumann_Matrix->Name), plhs[0]);
    delete(Block_Assemble_Matrix_Neumann_Matrix);
