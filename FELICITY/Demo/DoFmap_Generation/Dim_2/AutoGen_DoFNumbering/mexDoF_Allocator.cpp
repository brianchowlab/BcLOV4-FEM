...
#define PLHS_lagrange_deg1_dim2_DoF_Map                                       0
#define PLHS_lagrange_deg2_dim2_DoF_Map                                       1
/*------------   END: Auto Generate ------------*/

/* include classes and other sub-routines */
#include "Misc_Files.h"
#include "Triangle_Edge_Search.cc"
#include "lagrange_deg1_dim2_DoF_Allocator.cc"
#include "lagrange_deg2_dim2_DoF_Allocator.cc"
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (nrhs!=1)
        ...
        printf("      -------------------                                            ----- \n");
        printf("      lagrange_deg1_dim2_DoF_Map                                       0 \n");
        printf("      lagrange_deg2_dim2_DoF_Map                                       1 \n");
        printf("\n");
        mexErrMsgTxt("Check the number of input arguments!");
        }
    if ((nlhs < 1)||(nlhs > 2)) mexErrMsgTxt("1~2 outputs are needed!");
    /* END: Error Checking */
    /*------------   END: Auto Generate ------------*/
    ...
    lagrange_deg1_dim2_DoF_Allocator      lagrange_deg1_dim2_DoF_Obj;
    // do some initial allocation
    plhs[PLHS_lagrange_deg1_dim2_DoF_Map] = lagrange_deg1_dim2_DoF_Obj.Init_DoF_Map(Tri_Edge_Search.Num_Tri);
    // create the DoFmap
    lagrange_deg1_dim2_DoF_Obj.Fill_DoF_Map(&Tri_Edge_Search);

    // declare DoF allocator
    lagrange_deg2_dim2_DoF_Allocator      lagrange_deg2_dim2_DoF_Obj;
    // do some initial allocation
    plhs[PLHS_lagrange_deg2_dim2_DoF_Map] = lagrange_deg2_dim2_DoF_Obj.Init_DoF_Map(Tri_Edge_Search.Num_Tri);
    // create the DoFmap
    lagrange_deg2_dim2_DoF_Obj.Fill_DoF_Map(&Tri_Edge_Search);
