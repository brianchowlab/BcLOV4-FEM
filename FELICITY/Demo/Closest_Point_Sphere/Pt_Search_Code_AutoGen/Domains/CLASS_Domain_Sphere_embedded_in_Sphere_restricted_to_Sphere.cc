...
#define MDC        CLASS_Domain_Sphere_embedded_in_Sphere_restricted_to_Sphere
// set the name of the Global mesh (TopDim = 2)
#define GLOBAL_MESH_Name  "Sphere"
// set the name of the subdomain (TopDim = 2)
#define SUBDOMAIN_Name  "Sphere"
// set the name of the domain of integration (TopDim = 2)
#define DOMAIN_INTEGRATION_Name  "Sphere"
