...
private:
    ...
    CLASS_Domain_Sphere_embedded_in_Sphere_restricted_to_Sphere    Domain_Sphere_embedded_in_Sphere_restricted_to_Sphere;

    // mesh geometry classes (can be higher order)
    CLASS_geom_Sphere_embedded_in_Sphere_restricted_to_Sphere   geom_Sphere_embedded_in_Sphere_restricted_to_Sphere;

    // classes for search data and found points on subdomains
    Subdomain_Search_Data_Class    Sphere_Search_Data;
    Unstructured_Local_Points_Class    Sphere_Found_Points;

    // pointers to a search object for each domain to be searched
    CLASS_Search_Sphere*    Sphere_Search_Obj;
    /*------------   END: Auto Generate ------------*/
};
