...
#define PRHS_Sphere_Mesh_Vertices                                              0
#define PRHS_Sphere_Mesh_DoFmap                                                1
#define PRHS_EMPTY_1                                                           2
#define PRHS_EMPTY_2                                                           3
#define PRHS_Sphere_Search_Data                                                4
/*------------   END: Auto Generate ------------*/
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (nrhs!=5)
        ...
        mexPrintf("      -------------------                                             ----- \n");
        mexPrintf("      Sphere_Mesh_Vertices                                              0 \n");
        mexPrintf("      Sphere_Mesh_DoFmap                                                1 \n");
        mexPrintf("      EMPTY_1                                                           2 \n");
        mexPrintf("      EMPTY_2                                                           3 \n");
        ...
        mexPrintf("      Sphere_Search_Data                                                4 \n");
        mexPrintf("\n");
        mexPrintf("      -------------------------------------------------\n");
