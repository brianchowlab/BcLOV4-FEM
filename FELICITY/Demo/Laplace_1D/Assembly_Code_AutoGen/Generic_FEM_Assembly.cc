...
void GFA::Setup_Data(const mxArray *prhs[]) // input from MATLAB
{
    ...
    Base_Matrix_RHS = new Base_RHS_Data_Type(&Scalar_P1_phi_restricted_to_Omega, &RHS_Omega_col_constant_phi);
    ...
    Base_Matrix_RHS->Scalar_P1_phi_restricted_to_Omega = &Scalar_P1_phi_restricted_to_Omega;
