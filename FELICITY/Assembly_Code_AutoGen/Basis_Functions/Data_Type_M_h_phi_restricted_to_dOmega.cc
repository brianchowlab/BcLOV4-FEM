...
#define SpecificFUNC        Data_Type_M_h_phi_restricted_to_dOmega
#define SpecificFUNC_str   "Data_Type_M_h_phi_restricted_to_dOmega"
...
public:
    ...
    const CLASS_geom_dOmega_embedded_in_Omega_restricted_to_dOmega*  Mesh;
