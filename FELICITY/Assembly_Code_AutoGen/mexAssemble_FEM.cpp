...
#define PRHS_C_h_DoFmap                                                        5
#define PRHS_M_h_DoFmap                                                        6
#define PRHS_u_M_h_coef_Values                                                 7
#define PRHS_v_M_h_coef_Values                                                 8
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if ( (nrhs < 9) || (nrhs > 10) )
        ...
        mexPrintf("      C_h_DoFmap                                                        5 \n");
        mexPrintf("      M_h_DoFmap                                                        6 \n");
        mexPrintf("      u_M_h_coef_Values                                                 7 \n");
        mexPrintf("      v_M_h_coef_Values                                                 8 \n");
