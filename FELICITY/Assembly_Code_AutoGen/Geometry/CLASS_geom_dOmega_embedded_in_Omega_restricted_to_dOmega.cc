...
#define MGC        CLASS_geom_dOmega_embedded_in_Omega_restricted_to_dOmega
// set the type of map
...
public:
    ...
    const CLASS_Domain_dOmega_embedded_in_Omega_restricted_to_dOmega*   Domain;
...
private:
    ...
    void Compute_Map_p4(const int&);
    void Compute_Map_n4(const int&);
};
/*------------   END: Auto Generate ------------*/
...
void MGC::Compute_Local_Transformation()
{
    ...
    if (Sub_Entity_Index > 0)
        ...
        else if (Sub_Entity_Index==4) Compute_Map_p4(Global_Cell_Index);
        ...
        else if (Sub_Entity_Index==-4) Compute_Map_n4(Global_Cell_Index);
        else mexErrMsgTxt("ERROR: Sub_Entity_Index outside valid range or is zero!");
        }
}
/***************************************************************************************/
...
// Number of Quadrature Points = 12
    ...
    {0.00000000000000000E+00, 6.30890144915020046E-02, 8.73821971016995991E-01, 6.30890144915020046E-02}, \
    {0.00000000000000000E+00, 6.30890144915020046E-02, 6.30890144915020046E-02, 8.73821971016995991E-01}, \
    {0.00000000000000000E+00, 8.73821971016995991E-01, 6.30890144915020046E-02, 6.30890144915020046E-02}, \
    {0.00000000000000000E+00, 2.49286745170910956E-01, 5.01426509658179032E-01, 2.49286745170910012E-01}, \
    {0.00000000000000000E+00, 2.49286745170910956E-01, 2.49286745170910012E-01, 5.01426509658179032E-01}, \
    {0.00000000000000000E+00, 5.01426509658179920E-01, 2.49286745170910012E-01, 2.49286745170910012E-01}, \
    {0.00000000000000000E+00, 5.31450498448159947E-02, 6.36502499121399001E-01, 3.10352451033785004E-01}, \
    {0.00000000000000000E+00, 3.10352451033785004E-01, 6.36502499121399001E-01, 5.31450498448160016E-02}, \
    {0.00000000000000000E+00, 5.31450498448159947E-02, 3.10352451033785004E-01, 6.36502499121399001E-01}, \
    {0.00000000000000000E+00, 6.36502499121399001E-01, 3.10352451033785004E-01, 5.31450498448160016E-02}, \
    {0.00000000000000000E+00, 3.10352451033785004E-01, 5.31450498448160016E-02, 6.36502499121399001E-01}, \
    {0.00000000000000000E+00, 6.36502499121399001E-01, 5.31450498448160016E-02, 3.10352451033785004E-01}  \
    };
...
// Number of Quadrature Points = 12
    ...
    // Value of basis function, derivatives = [0  0  0], at quadrature points
    static const double Geo_Basis_Val_0_0_0[NQ][NB] = { \
    {6.30890144915020046E-02, 0.00000000000000000E+00, 6.30890144915020046E-02, 8.73821971016995991E-01}, \
    {6.30890144915020046E-02, 0.00000000000000000E+00, 8.73821971016995991E-01, 6.30890144915020046E-02}, \
    {8.73821971016995991E-01, 0.00000000000000000E+00, 6.30890144915020046E-02, 6.30890144915020046E-02}, \
    {2.49286745170910956E-01, 0.00000000000000000E+00, 2.49286745170910012E-01, 5.01426509658179032E-01}, \
    {2.49286745170910956E-01, 0.00000000000000000E+00, 5.01426509658179032E-01, 2.49286745170910012E-01}, \
    {5.01426509658179920E-01, 0.00000000000000000E+00, 2.49286745170910012E-01, 2.49286745170910012E-01}, \
    {5.31450498448159947E-02, 0.00000000000000000E+00, 3.10352451033785004E-01, 6.36502499121399001E-01}, \
    {3.10352451033785004E-01, 0.00000000000000000E+00, 5.31450498448160016E-02, 6.36502499121399001E-01}, \
    {5.31450498448159947E-02, 0.00000000000000000E+00, 6.36502499121399001E-01, 3.10352451033785004E-01}, \
    {6.36502499121399001E-01, 0.00000000000000000E+00, 5.31450498448160016E-02, 3.10352451033785004E-01}, \
    {3.10352451033785004E-01, 0.00000000000000000E+00, 6.36502499121399001E-01, 5.31450498448160016E-02}, \
    {6.36502499121399001E-01, 0.00000000000000000E+00, 3.10352451033785004E-01, 5.31450498448160016E-02}  \
    };
...
// Number of Quadrature Points = 12
    ...
    // Value of basis function, derivatives = [0  0  0], at quadrature points
    static const double Geo_Basis_Val_0_0_0[NQ][NB] = { \
    {6.30890144915020046E-02, 8.73821971016995991E-01, 0.00000000000000000E+00, 6.30890144915020046E-02}, \
    {6.30890144915020046E-02, 6.30890144915020046E-02, 0.00000000000000000E+00, 8.73821971016995991E-01}, \
    {8.73821971016995991E-01, 6.30890144915020046E-02, 0.00000000000000000E+00, 6.30890144915020046E-02}, \
    {2.49286745170910956E-01, 5.01426509658179032E-01, 0.00000000000000000E+00, 2.49286745170910012E-01}, \
    {2.49286745170910956E-01, 2.49286745170910012E-01, 0.00000000000000000E+00, 5.01426509658179032E-01}, \
    {5.01426509658179920E-01, 2.49286745170910012E-01, 0.00000000000000000E+00, 2.49286745170910012E-01}, \
    {5.31450498448159947E-02, 6.36502499121399001E-01, 0.00000000000000000E+00, 3.10352451033785004E-01}, \
    {3.10352451033785004E-01, 6.36502499121399001E-01, 0.00000000000000000E+00, 5.31450498448160016E-02}, \
    {5.31450498448159947E-02, 3.10352451033785004E-01, 0.00000000000000000E+00, 6.36502499121399001E-01}, \
    {6.36502499121399001E-01, 3.10352451033785004E-01, 0.00000000000000000E+00, 5.31450498448160016E-02}, \
    {3.10352451033785004E-01, 5.31450498448160016E-02, 0.00000000000000000E+00, 6.36502499121399001E-01}, \
    {6.36502499121399001E-01, 5.31450498448160016E-02, 0.00000000000000000E+00, 3.10352451033785004E-01}  \
    };
...
/* compute the local transformation from the standard reference element
          to an element in the Mesh    */
void MGC::Compute_Map_p4(const int& elem_index)           // current mesh element index
{
Get_Local_to_Global_DoFmap(elem_index, kc);
...
// Number of Quadrature Points = 12
    ...
    // Value of basis function, derivatives = [0  0  0], at quadrature points
    static const double Geo_Basis_Val_0_0_0[NQ][NB] = { \
    {6.30890144915020046E-02, 6.30890144915020046E-02, 8.73821971016995991E-01, 0.00000000000000000E+00}, \
    {6.30890144915020046E-02, 8.73821971016995991E-01, 6.30890144915020046E-02, 0.00000000000000000E+00}, \
    {8.73821971016995991E-01, 6.30890144915020046E-02, 6.30890144915020046E-02, 0.00000000000000000E+00}, \
    {2.49286745170910956E-01, 2.49286745170910012E-01, 5.01426509658179032E-01, 0.00000000000000000E+00}, \
    {2.49286745170910956E-01, 5.01426509658179032E-01, 2.49286745170910012E-01, 0.00000000000000000E+00}, \
    {5.01426509658179920E-01, 2.49286745170910012E-01, 2.49286745170910012E-01, 0.00000000000000000E+00}, \
    {5.31450498448159947E-02, 3.10352451033785004E-01, 6.36502499121399001E-01, 0.00000000000000000E+00}, \
    {3.10352451033785004E-01, 5.31450498448160016E-02, 6.36502499121399001E-01, 0.00000000000000000E+00}, \
    {5.31450498448159947E-02, 6.36502499121399001E-01, 3.10352451033785004E-01, 0.00000000000000000E+00}, \
    {6.36502499121399001E-01, 5.31450498448160016E-02, 3.10352451033785004E-01, 0.00000000000000000E+00}, \
    {3.10352451033785004E-01, 6.36502499121399001E-01, 5.31450498448160016E-02, 0.00000000000000000E+00}, \
    {6.36502499121399001E-01, 3.10352451033785004E-01, 5.31450498448160016E-02, 0.00000000000000000E+00}  \
    };
...
/* compute the local transformation from the standard reference element
          to an element in the Mesh    */
void MGC::Compute_Map_n4(const int& elem_index)           // current mesh element index
{
Get_Local_to_Global_DoFmap(elem_index, kc);
