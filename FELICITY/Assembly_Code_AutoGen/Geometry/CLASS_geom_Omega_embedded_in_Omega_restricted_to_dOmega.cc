...
#define MGC        CLASS_geom_Omega_embedded_in_Omega_restricted_to_dOmega
// set the type of map
...
public:
    ...
    const CLASS_Domain_Omega_embedded_in_Omega_restricted_to_dOmega*   Domain;
...
void MGC::Compute_Local_Transformation()
{
    ...
    if (DoI_Entity_Index > 0)
        ...
        else if (DoI_Entity_Index==4) Compute_Map_p4(Global_Cell_Index);
        ...
        else if (DoI_Entity_Index==-4) Compute_Map_n4(Global_Cell_Index);
        else mexErrMsgTxt("ERROR: DoI_Entity_Index outside valid range or is zero!");
        }
}
/***************************************************************************************/
