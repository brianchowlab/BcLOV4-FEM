...
#define SpecificNAME       "v_M_h_coef"
#define SpecificFUNC        Data_Type_v_M_h_coef_restricted_to_dOmega
#define SpecificFUNC_str   "Data_Type_v_M_h_coef_restricted_to_dOmega"
