...
#define SpecificNAME       "u_M_h_coef"
#define SpecificFUNC        Data_Type_u_M_h_coef_restricted_to_dOmega
#define SpecificFUNC_str   "Data_Type_u_M_h_coef_restricted_to_dOmega"
...
public:
    ...
    const Data_Type_M_h_phi_restricted_to_dOmega*     basis_func;
    ...
    void Setup_Function_Space(const mxArray*, const Data_Type_M_h_phi_restricted_to_dOmega*);
    void Compute_Func();
private:
};
/*------------   END: Auto Generate ------------*/
...
void SpecificFUNC::Setup_Function_Space(const mxArray* Values,        // inputs
                                        const Data_Type_M_h_phi_restricted_to_dOmega*   basis_func_input)          // inputs
{
